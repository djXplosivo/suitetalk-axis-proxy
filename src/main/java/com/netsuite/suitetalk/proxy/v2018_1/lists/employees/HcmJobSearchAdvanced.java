...
public class HcmJobSearchAdvanced extends SearchRecord implements Serializable {
   private HcmJobSearch criteria;
   private HcmJobSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(HcmJobSearchAdvanced.class, true);

   public HcmJobSearchAdvanced() {
      super();
   }

   public HcmJobSearchAdvanced(String savedSearchId, String savedSearchScriptId, HcmJobSearch criteria, HcmJobSearchRow columns) {
      super();
   ...
   public void setCriteria(HcmJobSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(HcmJobSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof HcmJobSearchAdvanced)) {
         return false;
      } else {
         HcmJobSearchAdvanced other = (HcmJobSearchAdvanced)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "HcmJobSearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "HcmJobSearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "HcmJobSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
