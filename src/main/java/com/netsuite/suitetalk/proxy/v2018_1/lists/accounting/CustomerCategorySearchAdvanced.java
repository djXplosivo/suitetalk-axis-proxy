...
public class CustomerCategorySearchAdvanced extends SearchRecord implements Serializable {
   private CustomerCategorySearch criteria;
   private CustomerCategorySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerCategorySearchAdvanced.class, true);

   public CustomerCategorySearchAdvanced() {
      super();
   }

   public CustomerCategorySearchAdvanced(String savedSearchId, String savedSearchScriptId, CustomerCategorySearch criteria, CustomerCategorySearchRow columns) {
      super();
   ...
   public void setCriteria(CustomerCategorySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(CustomerCategorySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerCategorySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CustomerCategorySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CustomerCategorySearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CustomerCategorySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
