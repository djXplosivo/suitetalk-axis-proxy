...
public class VendorAddressbook implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(VendorAddressbook.class, true);

   public VendorAddressbook() {
      super();
   }

   public VendorAddressbook(Boolean defaultShipping, Boolean defaultBilling, String label, String internalId, Address addressbookAddress) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof VendorAddressbook)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "VendorAddressbook"));
