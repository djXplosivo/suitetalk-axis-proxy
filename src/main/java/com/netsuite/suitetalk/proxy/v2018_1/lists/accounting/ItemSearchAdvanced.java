...
public class ItemSearchAdvanced extends SearchRecord implements Serializable {
   private ItemSearch criteria;
   private ItemSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ItemSearchAdvanced.class, true);

   public ItemSearchAdvanced() {
      super();
   }

   public ItemSearchAdvanced(String savedSearchId, String savedSearchScriptId, ItemSearch criteria, ItemSearchRow columns) {
      super();
   ...
   public void setCriteria(ItemSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ItemSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
