...
public class CustomerCurrencyList implements Serializable {
   private CustomerCurrency[] currency;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerCurrencyList.class, true);

   public CustomerCurrencyList() {
      super();
   }

   public CustomerCurrencyList(CustomerCurrency[] currency, boolean replaceAll) {
      super();
   ...
   public CustomerCurrency getCurrency(int i) {
      return this.currency[i];
   }

   public void setCurrency(int i, CustomerCurrency _value) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerCurrencyList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerCurrencyList"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerCurrency"));
