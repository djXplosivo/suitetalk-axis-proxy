...
public class TopicSolution implements Serializable {
   private RecordRef solution;
   private String message;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TopicSolution.class, true);

   public TopicSolution() {
      super();
   }

   public TopicSolution(RecordRef solution, String message) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TopicSolution)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "TopicSolution"));
