...
public class NonInventoryResaleItem extends Record implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(NonInventoryResaleItem.class, true);

   public NonInventoryResaleItem() {
      super();
   }

   public NonInventoryResaleItem(NullField nullFieldList, String internalId, String externalId, Calendar createdDate, Calendar lastModifiedDate, String purchaseDescription, Boolean copyDescription, Double cost, String costUnits, RecordRef expenseAccount, RecordRef intercoExpenseAccount, String salesDescription, Boolean includeChildren, RecordRef incomeAccount, RecordRef intercoIncomeAccount, Boolean isTaxable, ItemMatrixType matrixType, RecordRef taxSchedule, RecordRef dropshipExpenseAccount, Boolean deferRevRec, RecordRef revenueRecognitionRule, RecordRef revRecForecastRule, RecordRef revenueAllocationGroup, RecordRef createRevenuePlansOn, Boolean directRevenuePosting, Boolean isDropShipItem, Boolean isSpecialOrderItem, Double shippingCost, String shippingCostUnits, Double handlingCost, String handlingCostUnits, ItemCostEstimateType costEstimateType, Double costEstimate, Double weight, ItemWeightUnit weightUnit, String weightUnits, String costEstimateUnits, RecordRef unitsType, RecordRef purchaseUnit, RecordRef saleUnit, RecordRef issueProduct, RecordRef billingSchedule, RecordRef deferredRevenueAccount, RecordRef revRecSchedule, RecordRef deferralAccount, RecordRef amortizationTemplate, String residual, Long amortizationPeriod, String stockDescription, Boolean producer, String manufacturer, String mpn, Boolean multManufactureAddr, String manufacturerAddr1, String manufacturerCity, String manufacturerState, String manufacturerZip, Country countryOfManufacture, Double purchaseOrderQuantity, Double purchaseOrderAmount, Double purchaseOrderQuantityDiff, Double receiptQuantity, Double receiptAmount, Double receiptQuantityDiff, String manufacturerTaxId, String scheduleBNumber, Long scheduleBQuantity, ScheduleBCode scheduleBCode, String manufacturerTariff, ItemPreferenceCriterion preferenceCriterion, Long minimumQuantity, Boolean enforceMinQtyInternally, String softDescriptor, RecordRef shipPackage, Boolean shipIndividually, Boolean isFulfillable, Boolean generateAccruals, RecordRef costCategory, Boolean pricesIncludeTax, RecordRef quantityPricingSchedule, Boolean useMarginalRates, ItemOverallQuantityPricingType overallQuantityPricingType, RecordRef pricingGroup, String minimumQuantityUnits, Double vsoePrice, VsoeSopGroup vsoeSopGroup, VsoeDeferral vsoeDeferral, VsoePermitDiscount vsoePermitDiscount, Boolean vsoeDelivered, RecordRef itemRevenueCategory, String storeDisplayName, RecordRef storeDisplayThumbnail, RecordRef storeDisplayImage, String storeDescription, String storeDetailedDescription, RecordRef storeItemTemplate, String pageTitle, String metaTagHtml, Boolean excludeFromSitemap, SitemapPriority sitemapPriority, String searchKeywords, Boolean isDonationItem, Boolean showDefaultDonationAmount, Double maxDonationAmount, Boolean dontShowPrice, String noPriceMessage, String outOfStockMessage, Boolean onSpecial, ItemOutOfStockBehavior outOfStockBehavior, String relatedItemsDescription, String specialsDescription, String featuredDescription, String shoppingDotComCategory, Long shopzillaCategoryId, String nexTagCategory, ProductFeedList productFeedList, String urlComponent, RecordRef customForm, String itemId, String upcCode, String displayName, String vendorName, RecordRef parent, Boolean isOnline, Boolean isHazmatItem, String hazmatId, String hazmatShippingName, String hazmatHazardClass, HazmatPackingGroup hazmatPackingGroup, String hazmatItemUnits, Double hazmatItemUnitsQty, Boolean isGcoCompliant, Boolean offerSupport, Boolean isInactive, String matrixItemNameTemplate, Boolean availableToPartners, RecordRef department, RecordRef _class, RecordRef location, RecordRef defaultItemShipMethod, ShippingCarrier itemCarrier, RecordRefList itemShipMethodList, RecordRefList subsidiaryList, String currency, ItemOptionsList itemOptionsList, MatrixOptionList matrixOptionList, ItemVendorList itemVendorList, PricingMatrix pricingMatrix, ItemAccountingBookDetailList accountingBookDetailList, RecordRef purchaseTaxCode, Double rate, RecordRef salesTaxCode, SiteCategoryList siteCategoryList, TranslationList translationsList, RecordRef vendor, PresentationItemList presentationItemList, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof NonInventoryResaleItem)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "NonInventoryResaleItem"));
