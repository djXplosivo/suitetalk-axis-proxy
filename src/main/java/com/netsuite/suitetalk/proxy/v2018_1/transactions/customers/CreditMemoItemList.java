...
public class CreditMemoItemList implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CreditMemoItemList.class, true);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CreditMemoItemList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CreditMemoItemList"));
      ...
      elemField.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CreditMemoItem"));
