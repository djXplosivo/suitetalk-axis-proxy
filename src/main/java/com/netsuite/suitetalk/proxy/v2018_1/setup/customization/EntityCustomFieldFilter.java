...
public class EntityCustomFieldFilter implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(EntityCustomFieldFilter.class, true);

   public EntityCustomFieldFilter() {
      super();
   }

   public EntityCustomFieldFilter(RecordRef fldFilter, Boolean fldFilterChecked, CustomizationFilterCompareType fldFilterCompareType, String fldFilterVal, FldFilterSelList fldFilterSelList, Boolean fldFilterNotNull) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof EntityCustomFieldFilter)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "EntityCustomFieldFilter"));
