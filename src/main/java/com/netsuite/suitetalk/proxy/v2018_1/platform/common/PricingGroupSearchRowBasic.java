...
public class PricingGroupSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(PricingGroupSearchRowBasic.class, true);

   public PricingGroupSearchRowBasic() {
      super();
   }

   public PricingGroupSearchRowBasic(SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PricingGroupSearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PricingGroupSearchRowBasic"));
