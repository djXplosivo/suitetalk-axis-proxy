...
public class GiftCertificateSearchAdvanced extends SearchRecord implements Serializable {
   private GiftCertificateSearch criteria;
   private GiftCertificateSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GiftCertificateSearchAdvanced.class, true);

   public GiftCertificateSearchAdvanced() {
      super();
   }

   public GiftCertificateSearchAdvanced(String savedSearchId, String savedSearchScriptId, GiftCertificateSearch criteria, GiftCertificateSearchRow columns) {
      super();
   ...
   public void setCriteria(GiftCertificateSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(GiftCertificateSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GiftCertificateSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GiftCertificateSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GiftCertificateSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GiftCertificateSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
