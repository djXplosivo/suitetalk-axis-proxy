...
public class ItemAccountMappingSearchAdvanced extends SearchRecord implements Serializable {
   private ItemAccountMappingSearch criteria;
   private ItemAccountMappingSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ItemAccountMappingSearchAdvanced.class, true);

   public ItemAccountMappingSearchAdvanced() {
      super();
   }

   public ItemAccountMappingSearchAdvanced(String savedSearchId, String savedSearchScriptId, ItemAccountMappingSearch criteria, ItemAccountMappingSearchRow columns) {
      super();
   ...
   public void setCriteria(ItemAccountMappingSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ItemAccountMappingSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemAccountMappingSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemAccountMappingSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemAccountMappingSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemAccountMappingSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
