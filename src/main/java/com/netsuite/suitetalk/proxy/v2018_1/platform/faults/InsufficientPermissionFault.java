...
public class InsufficientPermissionFault extends SoapFault implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:faults_2018_1.platform.webservices.netsuite.com", "InsufficientPermissionFault"));
   }
}
