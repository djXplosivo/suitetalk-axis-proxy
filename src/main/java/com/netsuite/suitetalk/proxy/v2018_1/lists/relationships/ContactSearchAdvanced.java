...
public class ContactSearchAdvanced extends SearchRecord implements Serializable {
   private ContactSearch criteria;
   private ContactSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ContactSearchAdvanced.class, true);

   public ContactSearchAdvanced() {
      super();
   }

   public ContactSearchAdvanced(String savedSearchId, String savedSearchScriptId, ContactSearch criteria, ContactSearchRow columns) {
      super();
   ...
   public void setCriteria(ContactSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ContactSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ContactSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "ContactSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "ContactSearch"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "ContactSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
