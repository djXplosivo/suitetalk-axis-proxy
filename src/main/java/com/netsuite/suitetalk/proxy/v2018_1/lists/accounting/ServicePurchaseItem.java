...
public class ServicePurchaseItem extends Record implements Serializable {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ServicePurchaseItem)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ServicePurchaseItem"));
