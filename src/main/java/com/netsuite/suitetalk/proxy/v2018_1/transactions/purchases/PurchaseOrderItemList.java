...
public class PurchaseOrderItemList implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(PurchaseOrderItemList.class, true);

   public PurchaseOrderItemList() {
      super();
   }

   public PurchaseOrderItemList(PurchaseOrderItem[] item, boolean replaceAll) {
      super();
      this.item = item;
   ...
   public PurchaseOrderItem getItem(int i) {
      return this.item[i];
   }

   public void setItem(int i, PurchaseOrderItem _value) {
      this.item[i] = _value;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PurchaseOrderItemList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "PurchaseOrderItemList"));
      ...
      elemField.setXmlType(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "PurchaseOrderItem"));
