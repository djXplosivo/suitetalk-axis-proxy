...
public class FairValuePriceSearchAdvanced extends SearchRecord implements Serializable {
   private FairValuePriceSearch criteria;
   private FairValuePriceSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(FairValuePriceSearchAdvanced.class, true);

   public FairValuePriceSearchAdvanced() {
      super();
   }

   public FairValuePriceSearchAdvanced(String savedSearchId, String savedSearchScriptId, FairValuePriceSearch criteria, FairValuePriceSearchRow columns) {
      super();
   ...
   public void setCriteria(FairValuePriceSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(FairValuePriceSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof FairValuePriceSearchAdvanced)) {
         return false;
      } else {
         FairValuePriceSearchAdvanced other = (FairValuePriceSearchAdvanced)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "FairValuePriceSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "FairValuePriceSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "FairValuePriceSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
