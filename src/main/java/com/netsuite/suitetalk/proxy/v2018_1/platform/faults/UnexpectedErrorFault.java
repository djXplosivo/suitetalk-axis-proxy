...
public class UnexpectedErrorFault extends SoapFault implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(UnexpectedErrorFault.class, true);

   public UnexpectedErrorFault() {
      super();
   }

   public UnexpectedErrorFault(FaultCodeType code, String message1) {
      super(code, message1);
   }

   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof UnexpectedErrorFault)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:faults_2018_1.platform.webservices.netsuite.com", "UnexpectedErrorFault"));
   }
}
