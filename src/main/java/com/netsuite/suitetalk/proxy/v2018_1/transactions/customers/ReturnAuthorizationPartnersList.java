...
public class ReturnAuthorizationPartnersList implements Serializable {
   private Partners[] partners;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ReturnAuthorizationPartnersList.class, true);

   public ReturnAuthorizationPartnersList() {
      super();
   }

   public ReturnAuthorizationPartnersList(Partners[] partners, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ReturnAuthorizationPartnersList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "ReturnAuthorizationPartnersList"));
      ...
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "partners"));
