...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.NexusSearchBasic;
...
public class NexusSearch extends SearchRecord implements Serializable {
   private NexusSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(NexusSearch.class, true);

   public NexusSearch() {
      super();
   }

   public NexusSearch(NexusSearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(NexusSearchBasic basic) {
      this.basic = basic;
   }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "NexusSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "NexusSearchBasic"));
