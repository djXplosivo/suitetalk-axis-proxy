...
public class SearchColumnBooleanField extends SearchColumnField implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(SearchColumnBooleanField.class, true);

   public SearchColumnBooleanField() {
      super();
   }

   public SearchColumnBooleanField(String customLabel, Boolean searchValue) {
      super(customLabel);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SearchColumnBooleanField)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "SearchColumnBooleanField"));
