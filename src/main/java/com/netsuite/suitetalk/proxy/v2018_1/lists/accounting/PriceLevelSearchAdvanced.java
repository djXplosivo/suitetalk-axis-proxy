...
public class PriceLevelSearchAdvanced extends SearchRecord implements Serializable {
   private PriceLevelSearch criteria;
   private PriceLevelSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PriceLevelSearchAdvanced.class, true);

   public PriceLevelSearchAdvanced() {
      super();
   }

   public PriceLevelSearchAdvanced(String savedSearchId, String savedSearchScriptId, PriceLevelSearch criteria, PriceLevelSearchRow columns) {
      super();
   ...
   public void setCriteria(PriceLevelSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(PriceLevelSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PriceLevelSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PriceLevelSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PriceLevelSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PriceLevelSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
