...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.TermSearchRowBasic;
...
public class TermSearchRow extends SearchRow implements Serializable {
   private TermSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TermSearchRow.class, true);

   public TermSearchRow() {
      super();
   }

   public TermSearchRow(TermSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(TermSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TermSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TermSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "TermSearchRowBasic"));
