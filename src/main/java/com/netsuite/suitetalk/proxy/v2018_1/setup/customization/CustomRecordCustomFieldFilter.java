...
public class CustomRecordCustomFieldFilter implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomRecordCustomFieldFilter.class, true);

   public CustomRecordCustomFieldFilter() {
      super();
   }

   public CustomRecordCustomFieldFilter(RecordRef fldFilter, Boolean fldFilterChecked, CustomizationFilterCompareType fldFilterCompareType, String fldFilterVal, FldFilterSelList fldFilterSelList, Boolean fldFilterNotNull) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomRecordCustomFieldFilter)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "CustomRecordCustomFieldFilter"));
