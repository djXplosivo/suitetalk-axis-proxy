...
public class SalesRoleSearchAdvanced extends SearchRecord implements Serializable {
   private SalesRoleSearch criteria;
   private SalesRoleSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SalesRoleSearchAdvanced.class, true);

   public SalesRoleSearchAdvanced() {
      super();
   }

   public SalesRoleSearchAdvanced(String savedSearchId, String savedSearchScriptId, SalesRoleSearch criteria, SalesRoleSearchRow columns) {
      super();
   ...
   public void setCriteria(SalesRoleSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(SalesRoleSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesRoleSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SalesRoleSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SalesRoleSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SalesRoleSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
