...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.PricingGroupSearchRowBasic;
...
public class PricingGroupSearchRow extends SearchRow implements Serializable {
   private PricingGroupSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PricingGroupSearchRow.class, true);

   public PricingGroupSearchRow() {
      super();
   }

   public PricingGroupSearchRow(PricingGroupSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PricingGroupSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PricingGroupSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PricingGroupSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PricingGroupSearchRowBasic"));
