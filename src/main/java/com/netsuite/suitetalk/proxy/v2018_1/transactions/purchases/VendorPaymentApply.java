...
public class VendorPaymentApply implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(VendorPaymentApply.class, true);

   public VendorPaymentApply() {
      super();
   }

   public VendorPaymentApply(Boolean apply, Long doc, Long line, String job, Calendar applyDate, String type, String refNum, Double total, Double due, String currency, Calendar discDate, Double discAmt, Double disc, Double amount) {
      super();
      this.apply = apply;
      this.doc = doc;
      this.line = line;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof VendorPaymentApply)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "VendorPaymentApply"));
      ...
      elemField.setXmlName(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "job"));
      ...
      elemField.setXmlName(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "discDate"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "discAmt"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "double"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "disc"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "double"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
