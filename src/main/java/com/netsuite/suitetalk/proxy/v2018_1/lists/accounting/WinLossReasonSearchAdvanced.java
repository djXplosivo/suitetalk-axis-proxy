...
public class WinLossReasonSearchAdvanced extends SearchRecord implements Serializable {
   private WinLossReasonSearch criteria;
   private WinLossReasonSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(WinLossReasonSearchAdvanced.class, true);

   public WinLossReasonSearchAdvanced() {
      super();
   }

   public WinLossReasonSearchAdvanced(String savedSearchId, String savedSearchScriptId, WinLossReasonSearch criteria, WinLossReasonSearchRow columns) {
      super();
   ...
   public void setCriteria(WinLossReasonSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(WinLossReasonSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof WinLossReasonSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "WinLossReasonSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "WinLossReasonSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "WinLossReasonSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
