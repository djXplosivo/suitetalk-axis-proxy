...
public class DepartmentSearchRow extends SearchRow implements Serializable {
   private DepartmentSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(DepartmentSearchRow.class, true);

   public DepartmentSearchRow() {
      super();
   }

   public DepartmentSearchRow(DepartmentSearchRowBasic basic, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(DepartmentSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof DepartmentSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "DepartmentSearchRow"));
