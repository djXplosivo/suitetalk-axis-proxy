...
public class SubsidiarySearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(SubsidiarySearchBasic.class, true);

   public SubsidiarySearchBasic() {
      super();
   }

   public SubsidiarySearchBasic(SearchMultiSelectField accountingBook, SearchMultiSelectField accountingBookCurrency, SearchStringField address, SearchStringField city, SearchEnumMultiSelectField country, SearchMultiSelectField currency, SearchDateField effectiveFrom, SearchStringField email, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchStringField fax, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isElimination, SearchBooleanField isInactive, SearchStringField legalName, SearchStringField name, SearchStringField nameNoHierarchy, SearchMultiSelectField nexus, SearchStringField phone, SearchDoubleField purchaseOrderAmount, SearchDoubleField purchaseOrderQuantity, SearchDoubleField purchaseOrderQuantityDiff, SearchDoubleField receiptAmount, SearchDoubleField receiptQuantity, SearchDoubleField receiptQuantityDiff, SearchStringField state, SearchMultiSelectField taxEngine, SearchStringField taxIdNum, SearchStringField taxRegistrationNumber, SearchStringField tranPrefix, SearchStringField url, SearchDateField validUntil, SearchStringField zip, SearchCustomFieldList customFieldList) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SubsidiarySearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "SubsidiarySearchBasic"));
