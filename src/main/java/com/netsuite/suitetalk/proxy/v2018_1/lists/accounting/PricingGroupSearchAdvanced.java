...
public class PricingGroupSearchAdvanced extends SearchRecord implements Serializable {
   private PricingGroupSearch criteria;
   private PricingGroupSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PricingGroupSearchAdvanced.class, true);

   public PricingGroupSearchAdvanced() {
      super();
   }

   public PricingGroupSearchAdvanced(String savedSearchId, String savedSearchScriptId, PricingGroupSearch criteria, PricingGroupSearchRow columns) {
      super();
   ...
   public void setCriteria(PricingGroupSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(PricingGroupSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PricingGroupSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PricingGroupSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PricingGroupSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PricingGroupSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
