...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.UnitsTypeSearchBasic;
...
public class UnitsTypeSearch extends SearchRecord implements Serializable {
   private UnitsTypeSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(UnitsTypeSearch.class, true);

   public UnitsTypeSearch() {
      super();
   }

   public UnitsTypeSearch(UnitsTypeSearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(UnitsTypeSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof UnitsTypeSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "UnitsTypeSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "UnitsTypeSearchBasic"));
