...
public class CustomerMessageSearchAdvanced extends SearchRecord implements Serializable {
   private CustomerMessageSearch criteria;
   private CustomerMessageSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerMessageSearchAdvanced.class, true);

   public CustomerMessageSearchAdvanced() {
      super();
   }

   public CustomerMessageSearchAdvanced(String savedSearchId, String savedSearchScriptId, CustomerMessageSearch criteria, CustomerMessageSearchRow columns) {
      super();
   ...
   public void setCriteria(CustomerMessageSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(CustomerMessageSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerMessageSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CustomerMessageSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CustomerMessageSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CustomerMessageSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
