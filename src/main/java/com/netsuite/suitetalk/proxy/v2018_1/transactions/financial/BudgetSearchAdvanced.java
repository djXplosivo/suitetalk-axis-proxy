...
public class BudgetSearchAdvanced extends SearchRecord implements Serializable {
   private BudgetSearch criteria;
   private BudgetSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(BudgetSearchAdvanced.class, true);

   public BudgetSearchAdvanced() {
      super();
   }

   public BudgetSearchAdvanced(String savedSearchId, String savedSearchScriptId, BudgetSearch criteria, BudgetSearchRow columns) {
      super();
   ...
   public void setCriteria(BudgetSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(BudgetSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof BudgetSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "BudgetSearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "BudgetSearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "BudgetSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
