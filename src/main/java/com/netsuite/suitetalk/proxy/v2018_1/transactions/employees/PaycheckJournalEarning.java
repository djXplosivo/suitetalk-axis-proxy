...
public class PaycheckJournalEarning implements Serializable {
   private Long id;
   ...
   private static TypeDesc typeDesc = new TypeDesc(PaycheckJournalEarning.class, true);

   public PaycheckJournalEarning() {
      super();
   }

   public PaycheckJournalEarning(Long id, RecordRef payrollItem, Double hours, Double amount, RecordRef department, RecordRef _class, RecordRef location, CustomFieldList customFieldList) {
      super();
      this.id = id;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PaycheckJournalEarning)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = (this.id == null && other.getId() == null || this.id != null && this.id.equals(other.getId())) && (this.payrollItem == null && other.getPayrollItem() == null || this.payrollItem != null && this.payrollItem.equals(other.getPayrollItem())) && (this.hours == null && other.getHours() == null || this.hours != null && this.hours.equals(other.getHours())) && (this.amount == null && other.getAmount() == null || this.amount != null && this.amount.equals(other.getAmount())) && (this.department == null && other.getDepartment() == null || this.department != null && this.department.equals(other.getDepartment())) && (this._class == null && other.get_class() == null || this._class != null && this._class.equals(other.get_class())) && (this.location == null && other.getLocation() == null || this.location != null && this.location.equals(other.getLocation())) && (this.customFieldList == null && other.getCustomFieldList() == null || this.customFieldList != null && this.customFieldList.equals(other.getCustomFieldList()));
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "PaycheckJournalEarning"));
