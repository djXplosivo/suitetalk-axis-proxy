...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.PartnerCategorySearchRowBasic;
...
public class PartnerCategorySearchRow extends SearchRow implements Serializable {
   private PartnerCategorySearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PartnerCategorySearchRow.class, true);

   public PartnerCategorySearchRow() {
      super();
   }

   public PartnerCategorySearchRow(PartnerCategorySearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PartnerCategorySearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PartnerCategorySearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PartnerCategorySearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PartnerCategorySearchRowBasic"));
