...
public class InvalidCredentialsFault extends SoapFault implements Serializable {
   ...
   public InvalidCredentialsFault(FaultCodeType code, String message1) {
      super(code, message1);
   }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:faults.platform.webservices.netsuite.com", "InvalidCredentialsFault"));
   }
}
