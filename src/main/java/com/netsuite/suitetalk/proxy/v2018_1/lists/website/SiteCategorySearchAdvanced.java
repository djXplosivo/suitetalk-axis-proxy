...
public class SiteCategorySearchAdvanced extends SearchRecord implements Serializable {
   private SiteCategorySearch criteria;
   private SiteCategorySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SiteCategorySearchAdvanced.class, true);

   public SiteCategorySearchAdvanced() {
      super();
   }

   public SiteCategorySearchAdvanced(String savedSearchId, String savedSearchScriptId, SiteCategorySearch criteria, SiteCategorySearchRow columns) {
      super();
   ...
   public void setCriteria(SiteCategorySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(SiteCategorySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SiteCategorySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:website_2018_1.lists.webservices.netsuite.com", "SiteCategorySearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:website_2018_1.lists.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:website_2018_1.lists.webservices.netsuite.com", "SiteCategorySearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:website_2018_1.lists.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:website_2018_1.lists.webservices.netsuite.com", "SiteCategorySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
