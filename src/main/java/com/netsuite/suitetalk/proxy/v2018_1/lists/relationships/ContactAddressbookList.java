...
public class ContactAddressbookList implements Serializable {
   private ContactAddressbook[] addressbook;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ContactAddressbookList.class, true);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ContactAddressbookList)) {
         return false;
      } else {
         ContactAddressbookList other = (ContactAddressbookList)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "ContactAddressbookList"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "ContactAddressbook"));
