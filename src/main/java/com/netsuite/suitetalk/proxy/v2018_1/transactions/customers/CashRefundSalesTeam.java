...
public class CashRefundSalesTeam implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CashRefundSalesTeam.class, true);

   public CashRefundSalesTeam() {
      super();
   }

   public CashRefundSalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CashRefundSalesTeam)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CashRefundSalesTeam"));
