...
public class TaxTypeSearchAdvanced extends SearchRecord implements Serializable {
   private TaxTypeSearch criteria;
   private TaxTypeSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TaxTypeSearchAdvanced.class, true);

   public TaxTypeSearchAdvanced() {
      super();
   }

   public TaxTypeSearchAdvanced(String savedSearchId, String savedSearchScriptId, TaxTypeSearch criteria, TaxTypeSearchRow columns) {
      super();
   ...
   public void setCriteria(TaxTypeSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TaxTypeSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TaxTypeSearchAdvanced)) {
         return false;
      } else {
         TaxTypeSearchAdvanced other = (TaxTypeSearchAdvanced)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxTypeSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxTypeSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxTypeSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
