...
public class CustomerMessageSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private SearchColumnStringField[] preferred;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerMessageSearchRowBasic.class, true);

   public CustomerMessageSearchRowBasic() {
      super();
   }

   public CustomerMessageSearchRowBasic(SearchColumnStringField[] description, SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name, SearchColumnStringField[] preferred) {
      super();
   ...
   public SearchColumnStringField[] getPreferred() {
      return this.preferred;
   }

   public void setPreferred(SearchColumnStringField[] preferred) {
      this.preferred = preferred;
   }

   public SearchColumnStringField getPreferred(int i) {
      return this.preferred[i];
   }

   public void setPreferred(int i, SearchColumnStringField _value) {
      this.preferred[i] = _value;
   }

   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerMessageSearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomerMessageSearchRowBasic"));
