...
public class ItemDemandSource implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:types.accounting_2018_1.lists.webservices.netsuite.com", "ItemDemandSource"));
   }
}
