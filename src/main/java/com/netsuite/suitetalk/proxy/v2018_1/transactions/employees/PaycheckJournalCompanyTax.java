...
public class PaycheckJournalCompanyTax implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(PaycheckJournalCompanyTax.class, true);

   public PaycheckJournalCompanyTax() {
      super();
   }

   public PaycheckJournalCompanyTax(Long id, RecordRef payrollItem, Double amount, RecordRef department, RecordRef _class, RecordRef location, CustomFieldList customFieldList) {
      super();
      this.id = id;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PaycheckJournalCompanyTax)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "PaycheckJournalCompanyTax"));
