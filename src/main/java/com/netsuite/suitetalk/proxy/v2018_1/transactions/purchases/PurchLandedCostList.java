...
public class PurchLandedCostList implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(PurchLandedCostList.class, true);

   public PurchLandedCostList() {
      super();
   }

   public PurchLandedCostList(LandedCostSummary[] landedCost, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PurchLandedCostList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "PurchLandedCostList"));
