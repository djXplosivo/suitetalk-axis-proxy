...
public class CrmCustomFieldFilter implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CrmCustomFieldFilter.class, true);

   public CrmCustomFieldFilter() {
      super();
   }

   public CrmCustomFieldFilter(RecordRef fldFilter, Boolean fldFilterChecked, CustomizationFilterCompareType fldFilterCompareType, String fldFilterVal, FldFilterSelList fldFilterSelList, Boolean fldFilterNotNull) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CrmCustomFieldFilter)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "CrmCustomFieldFilter"));
