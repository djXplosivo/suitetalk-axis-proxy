...
public class NoteTypeSearchAdvanced extends SearchRecord implements Serializable {
   private NoteTypeSearch criteria;
   private NoteTypeSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(NoteTypeSearchAdvanced.class, true);

   public NoteTypeSearchAdvanced() {
      super();
   }

   public NoteTypeSearchAdvanced(String savedSearchId, String savedSearchScriptId, NoteTypeSearch criteria, NoteTypeSearchRow columns) {
      super();
   ...
   public void setCriteria(NoteTypeSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(NoteTypeSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof NoteTypeSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "NoteTypeSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "NoteTypeSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "NoteTypeSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
