...
public class LotNumberedAssemblyItem extends Record implements Serializable {
   ...
   private LotNumberedAssemblyItemBillOfMaterialsList billOfMaterialsList;
   private ItemMemberList memberList;
   private ItemAccountingBookDetailList accountingBookDetailList;
   private LotNumberedInventoryItemLocationsList locationsList;
   private SiteCategoryList siteCategoryList;
   private InventoryItemBinNumberList binNumberList;
   private LotNumberedInventoryItemNumbersList numbersList;
   ...
   private static TypeDesc typeDesc = new TypeDesc(LotNumberedAssemblyItem.class, true);

   public LotNumberedAssemblyItem() {
      super();
   }

   public LotNumberedAssemblyItem(NullField nullFieldList, String internalId, String externalId, Calendar createdDate, Calendar lastModifiedDate, RecordRef customForm, String itemId, String upcCode, String displayName, String vendorName, RecordRef parent, Boolean printItems, Boolean isOnline, Boolean isGcoCompliant, Boolean offerSupport, Boolean useComponentYield, Boolean isInactive, Boolean availableToPartners, RecordRefList subsidiaryList, RecordRef department, Boolean includeChildren, RecordRef _class, RecordRef location, RecordRef costCategory, String description, RecordRef cogsAccount, RecordRef vendor, RecordRef incomeAccount, RecordRef intercoIncomeAccount, RecordRef assetAccount, Boolean matchBillToReceipt, RecordRef billQtyVarianceAcct, RecordRef billPriceVarianceAcct, RecordRef billExchRateVarianceAcct, RecordRef gainLossAccount, RecordRef salesTaxCode, RecordRef purchaseTaxCode, RecordRef prodQtyVarianceAcct, RecordRef prodPriceVarianceAcct, RecordRef purchasePriceVarianceAcct, RecordRef wipVarianceAcct, RecordRef taxSchedule, RecordRef scrapAcct, Double shippingCost, RecordRef wipAcct, Double handlingCost, Double weight, ItemWeightUnit weightUnit, ItemCostingMethod costingMethod, Boolean isTaxable, String costingMethodDisplay, Double rate, RecordRef unitsType, RecordRef stockUnit, RecordRef purchaseUnit, RecordRef saleUnit, Boolean trackLandedCost, String matrixItemNameTemplate, RecordRef billingSchedule, RecordRef deferredRevenueAccount, RecordRef revRecSchedule, String stockDescription, Boolean producer, String manufacturer, String mpn, Boolean multManufactureAddr, String manufactureraddr1, String manufacturerCity, String manufacturerState, String manufacturerZip, Country countryOfManufacture, AssemblyItemEffectiveBomControl effectiveBomControl, String manufacturerTaxId, String defaultRevision, RecordRef defaultItemShipMethod, ShippingCarrier itemCarrier, Boolean roundUpAsComponent, Double purchaseOrderQuantity, Double purchaseOrderAmount, Double purchaseOrderQuantityDiff, Double receiptQuantity, Double receiptAmount, Double receiptQuantityDiff, Boolean isDropShipItem, Boolean isPhantom, RecordRefList itemShipMethodList, String scheduleBNumber, Long scheduleBQuantity, RecordRef scheduleBCode, String manufacturerTariff, ItemPreferenceCriterion preferenceCriterion, RecordRef issueProduct, Long minimumQuantity, Boolean enforceMinQtyInternally, RecordRef softDescriptor, Boolean isSpecialWorkOrderItem, Boolean pricesIncludeTax, RecordRef quantityPricingSchedule, Boolean buildEntireAssembly, Double quantityOnHand, Boolean useMarginalRates, Long reorderMultiple, Double cost, ItemCostEstimateType costEstimateType, Boolean isHazmatItem, String hazmatId, String hazmatShippingName, String hazmatHazardClass, HazmatPackingGroup hazmatPackingGroup, String hazmatItemUnits, Double hazmatItemUnitsQty, Double costEstimate, Double transferPrice, ItemOverallQuantityPricingType overallQuantityPricingType, RecordRef pricingGroup, RecordRef intercoCogsAccount, Double vsoePrice, VsoeSopGroup vsoeSopGroup, VsoeDeferral vsoeDeferral, VsoePermitDiscount vsoePermitDiscount, Boolean vsoeDelivered, RecordRef itemRevenueCategory, RecordRef unbuildVarianceAccount, RecordRef revenueRecognitionRule, RecordRef revRecForecastRule, RecordRef revenueAllocationGroup, RecordRef createRevenuePlansOn, Boolean directRevenuePosting, RecordRef dropshipExpenseAccount, RecordRef preferredLocation, Boolean isStorePickupAllowed, Double totalValue, Boolean useBins, Double averageCost, Double lastPurchasePrice, String purchaseDescription, Long leadTime, Boolean autoLeadTime, Long buildTime, Double safetyStockLevel, Long safetyStockLevelDays, Boolean seasonalDemand, String serialNumbers, Double reorderPoint, Double preferredStockLevel, Calendar expirationDate, Calendar lastInvtCountDate, Calendar nextInvtCountDate, Long invtCountInterval, ItemInvtClassification invtClassification, Double demandModifier, Boolean autoReorderPoint, Boolean autoPreferredStockLevel, Double preferredStockLevelDays, Boolean shipIndividually, RecordRef shipPackage, Double defaultReturnCost, RecordRef supplyReplenishmentMethod, RecordRef alternateDemandSourceItem, Double fixedLotSize, RecordRef supplyType, Long demandTimeFence, Long supplyTimeFence, Long rescheduleInDays, Long rescheduleOutDays, RecordRef supplyLotSizingMethod, RecordRef demandSource, Double quantityCommitted, Double quantityAvailable, Double quantityBackOrdered, Double quantityOnOrder, String storeDisplayName, RecordRef storeDisplayThumbnail, RecordRef storeDisplayImage, String storeDescription, String storeDetailedDescription, RecordRef storeItemTemplate, String pageTitle, String metaTagHtml, Boolean excludeFromSitemap, SitemapPriority sitemapPriority, String urlComponent, String searchKeywords, Boolean isDonationItem, Boolean showDefaultDonationAmount, Double maxDonationAmount, Boolean dontShowPrice, String noPriceMessage, String outOfStockMessage, String shoppingDotComCategory, ItemOutOfStockBehavior outOfStockBehavior, Long shopzillaCategoryId, String nexTagCategory, ProductFeedList productFeedList, String relatedItemsDescription, Boolean onSpecial, String specialsDescription, String featuredDescription, ItemOptionsList itemOptionsList, RecordRefList itemNumberOptionsList, ItemVendorList itemVendorList, PricingMatrix pricingMatrix, LotNumberedAssemblyItemBillOfMaterialsList billOfMaterialsList, ItemMemberList memberList, ItemAccountingBookDetailList accountingBookDetailList, LotNumberedInventoryItemLocationsList locationsList, SiteCategoryList siteCategoryList, InventoryItemBinNumberList binNumberList, LotNumberedInventoryItemNumbersList numbersList, TranslationList translationsList, PresentationItemList presentationItemList, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   public void setBillOfMaterialsList(LotNumberedAssemblyItemBillOfMaterialsList billOfMaterialsList) {
      this.billOfMaterialsList = billOfMaterialsList;
   }
   ...
   public void setLocationsList(LotNumberedInventoryItemLocationsList locationsList) {
      this.locationsList = locationsList;
   }
   ...
   public void setNumbersList(LotNumberedInventoryItemNumbersList numbersList) {
      this.numbersList = numbersList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof LotNumberedAssemblyItem)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "LotNumberedAssemblyItem"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "LotNumberedAssemblyItemBillOfMaterialsList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "LotNumberedInventoryItemLocationsList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "LotNumberedInventoryItemNumbersList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
