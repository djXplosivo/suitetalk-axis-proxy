...
public class ItemFulfillmentExportTypeUps implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:types.sales_2018_1.transactions.webservices.netsuite.com", "ItemFulfillmentExportTypeUps"));
   }
}
