...
public class PayrollItemSearchAdvanced extends SearchRecord implements Serializable {
   private PayrollItemSearch criteria;
   private PayrollItemSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PayrollItemSearchAdvanced.class, true);

   public PayrollItemSearchAdvanced() {
      super();
   }

   public PayrollItemSearchAdvanced(String savedSearchId, String savedSearchScriptId, PayrollItemSearch criteria, PayrollItemSearchRow columns) {
      super();
   ...
   public void setCriteria(PayrollItemSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(PayrollItemSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PayrollItemSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "PayrollItemSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "PayrollItemSearch"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "PayrollItemSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
