...
public class InvoiceItem implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(InvoiceItem.class, true);

   public InvoiceItem() {
      super();
   }

   public InvoiceItem(RecordRef job, RecordRef item, Long line, String description, Double amount, Boolean isTaxable, CustomFieldList options, RecordRef subscriptionLine, Boolean deferRevRec, Double quantity, Double currentPercent, RecordRef units, InventoryDetail inventoryDetail, String serialNumbers, String binNumbers, RecordRef price, String rate, Double percentComplete, Double quantityOnHand, Double quantityAvailable, Double quantityOrdered, Double quantityRemaining, Double quantityFulfilled, Double amountOrdered, RecordRef department, Long orderLine, String licenseCode, RecordRef _class, RecordRef location, RecordRef revRecSchedule, Calendar revRecStartDate, Calendar revRecEndDate, Double grossAmt, ItemCostEstimateType costEstimateType, Double costEstimate, String taxDetailsReference, Boolean excludeFromRateRequest, RecordRef catchUpPeriod, Double tax1Amt, RecordRef taxCode, Double taxRate1, Double taxRate2, String giftCertFrom, String giftCertRecipientName, String giftCertRecipientEmail, String giftCertMessage, Double taxAmount, String giftCertNumber, Long shipGroup, Boolean itemIsFulfilled, RecordRef shipAddress, RecordRef shipMethod, VsoeSopGroup vsoeSopGroup, Boolean vsoeIsEstimate, Double vsoePrice, Double vsoeAmount, Double vsoeAllocation, VsoeDeferral vsoeDeferral, VsoePermitDiscount vsoePermitDiscount, Boolean vsoeDelivered, RecordRef chargeType, RecordRefList chargesList, CustomFieldList customFieldList) {
      super();
      this.job = job;
      this.item = item;
      this.line = line;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "InvoiceItem"));
