...
public class VendorSearchAdvanced extends SearchRecord implements Serializable {
   private VendorSearch criteria;
   private VendorSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(VendorSearchAdvanced.class, true);

   public VendorSearchAdvanced() {
      super();
   }

   public VendorSearchAdvanced(String savedSearchId, String savedSearchScriptId, VendorSearch criteria, VendorSearchRow columns) {
      super();
   ...
   public void setCriteria(VendorSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(VendorSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof VendorSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "VendorSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "VendorSearch"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "VendorSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
