...
public class WorkOrderItemList implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(WorkOrderItemList.class, true);

   public WorkOrderItemList() {
      super();
   }

   public WorkOrderItemList(WorkOrderItem[] item, boolean replaceAll) {
      super();
      this.item = item;
   ...
   public void setItem(WorkOrderItem[] item) {
      this.item = item;
   }

   public WorkOrderItem getItem(int i) {
      return this.item[i];
   }

   public void setItem(int i, WorkOrderItem _value) {
      this.item[i] = _value;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof WorkOrderItemList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:inventory_2018_1.transactions.webservices.netsuite.com", "WorkOrderItemList"));
      ...
      elemField.setXmlType(new QName("urn:inventory_2018_1.transactions.webservices.netsuite.com", "WorkOrderItem"));
