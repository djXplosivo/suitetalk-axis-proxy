...
public class NexusSearchAdvanced extends SearchRecord implements Serializable {
   private NexusSearch criteria;
   private NexusSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(NexusSearchAdvanced.class, true);

   public NexusSearchAdvanced() {
      super();
   }

   public NexusSearchAdvanced(String savedSearchId, String savedSearchScriptId, NexusSearch criteria, NexusSearchRow columns) {
      super();
   ...
   public void setCriteria(NexusSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(NexusSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof NexusSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "NexusSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "NexusSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "NexusSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
