...
public class PartnerSearchAdvanced extends SearchRecord implements Serializable {
   private PartnerSearch criteria;
   private PartnerSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PartnerSearchAdvanced.class, true);

   public PartnerSearchAdvanced() {
      super();
   }

   public PartnerSearchAdvanced(String savedSearchId, String savedSearchScriptId, PartnerSearch criteria, PartnerSearchRow columns) {
      super();
   ...
   public void setCriteria(PartnerSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(PartnerSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PartnerSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "PartnerSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "PartnerSearch"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "PartnerSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
