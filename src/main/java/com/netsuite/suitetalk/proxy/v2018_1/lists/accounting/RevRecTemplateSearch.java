...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.RevRecTemplateSearchBasic;
...
public class RevRecTemplateSearch extends SearchRecord implements Serializable {
   private RevRecTemplateSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(RevRecTemplateSearch.class, true);

   public RevRecTemplateSearch() {
      super();
   }

   public RevRecTemplateSearch(RevRecTemplateSearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(RevRecTemplateSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof RevRecTemplateSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecTemplateSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "RevRecTemplateSearchBasic"));
