...
public class ClassificationSearchRow extends SearchRow implements Serializable {
   private ClassificationSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ClassificationSearchRow.class, true);

   public ClassificationSearchRow() {
      super();
   }

   public ClassificationSearchRow(ClassificationSearchRowBasic basic, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(ClassificationSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ClassificationSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ClassificationSearchRow"));
