...
public class InvoiceExpCost implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(InvoiceExpCost.class, true);

   public InvoiceExpCost() {
      super();
   }

   public InvoiceExpCost(Boolean apply, Long doc, Long line, String taxDetailsReference, Calendar billedDate, String jobDisp, String employeeDisp, String categoryDisp, String memo, String department, String _class, String location, Double originalAmount, Double amount, Double taxAmount, String taxableDisp, RecordRef revRecSchedule, Calendar revRecStartDate, Calendar revRecEndDate, Double grossAmt, Double tax1Amt, RecordRef taxCode, Double taxRate1, Double taxRate2) {
      super();
      this.apply = apply;
      this.doc = doc;
      this.line = line;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InvoiceExpCost)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "InvoiceExpCost"));
