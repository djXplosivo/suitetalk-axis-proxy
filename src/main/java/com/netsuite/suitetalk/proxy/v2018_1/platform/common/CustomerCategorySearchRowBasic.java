...
public class CustomerCategorySearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomerCategorySearchRowBasic.class, true);

   public CustomerCategorySearchRowBasic() {
      super();
   }

   public CustomerCategorySearchRowBasic(SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerCategorySearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomerCategorySearchRowBasic"));
