...
public class ItemAccountMappingSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private SearchEnumMultiSelectField itemAccount;
   ...
   private static TypeDesc typeDesc = new TypeDesc(ItemAccountMappingSearchBasic.class, true);

   public ItemAccountMappingSearchBasic() {
      super();
   }

   public ItemAccountMappingSearchBasic(SearchMultiSelectField accountingBook, SearchMultiSelectField _class, SearchMultiSelectCustomField customDimension, SearchMultiSelectField department, SearchMultiSelectField destinationAccount, SearchDateField effectiveDate, SearchDateField endDate, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchEnumMultiSelectField itemAccount, SearchMultiSelectField location, SearchMultiSelectField sourceAccount, SearchMultiSelectField subsidiary, SearchCustomFieldList customFieldList) {
      super();
   ...
   public void setItemAccount(SearchEnumMultiSelectField itemAccount) {
      this.itemAccount = itemAccount;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemAccountMappingSearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ItemAccountMappingSearchBasic"));
