...
public class ClassificationSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(ClassificationSearchBasic.class, true);

   public ClassificationSearchBasic() {
      super();
   }

   public ClassificationSearchBasic(SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField name, SearchStringField nameNoHierarchy, SearchMultiSelectField subsidiary, SearchCustomFieldList customFieldList) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ClassificationSearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ClassificationSearchBasic"));
