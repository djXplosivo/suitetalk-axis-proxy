...
public class TaskTimeItemList implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "TaskTimeItemList"));
