...
public class CreditMemoPartnersList implements Serializable {
   private Partners[] partners;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CreditMemoPartnersList.class, true);

   public CreditMemoPartnersList() {
      super();
   }

   public CreditMemoPartnersList(Partners[] partners, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CreditMemoPartnersList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CreditMemoPartnersList"));
