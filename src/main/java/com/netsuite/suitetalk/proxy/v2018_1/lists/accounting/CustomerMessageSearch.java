...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.CustomerMessageSearchBasic;
...
public class CustomerMessageSearch extends SearchRecord implements Serializable {
   private CustomerMessageSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerMessageSearch.class, true);

   public CustomerMessageSearch() {
      super();
   }

   public CustomerMessageSearch(CustomerMessageSearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(CustomerMessageSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerMessageSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CustomerMessageSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomerMessageSearchBasic"));
