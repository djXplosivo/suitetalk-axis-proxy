...
public class PricingGroup extends Record implements Serializable {
   private String name;
   ...
   private static TypeDesc typeDesc = new TypeDesc(PricingGroup.class, true);

   public PricingGroup() {
      super();
   }

   public PricingGroup(NullField nullFieldList, String internalId, String externalId, String name, Boolean isInactive) {
      super(nullFieldList);
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PricingGroup"));
