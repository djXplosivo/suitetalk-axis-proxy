...
public class CustomerSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerSearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomerSearchBasic"));
