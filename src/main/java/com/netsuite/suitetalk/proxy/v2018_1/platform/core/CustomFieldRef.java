...
public abstract class CustomFieldRef implements Serializable {
   private String internalId;
   private String scriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomFieldRef.class, true);

   public CustomFieldRef() {
      super();
   }

   public CustomFieldRef(String internalId, String scriptId) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomFieldRef)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "CustomFieldRef"));
