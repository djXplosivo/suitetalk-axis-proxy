...
public class TopicSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(TopicSearchRowBasic.class, true);

   public TopicSearchRowBasic() {
      super();
   }

   public TopicSearchRowBasic(SearchColumnStringField[] description, SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TopicSearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "TopicSearchRowBasic"));
