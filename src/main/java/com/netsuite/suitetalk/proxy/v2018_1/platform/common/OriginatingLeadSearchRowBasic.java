...
public class OriginatingLeadSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private SearchColumnStringField[] stage;
   ...
   public SearchColumnStringField[] getStage() {
      return this.stage;
   }

   public void setStage(SearchColumnStringField[] stage) {
      this.stage = stage;
   }

   public SearchColumnStringField getStage(int i) {
      return this.stage[i];
   }

   public void setStage(int i, SearchColumnStringField _value) {
      this.stage[i] = _value;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof OriginatingLeadSearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "OriginatingLeadSearchRowBasic"));
