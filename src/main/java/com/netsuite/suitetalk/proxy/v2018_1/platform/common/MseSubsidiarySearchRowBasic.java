...
public class MseSubsidiarySearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private SearchColumnBooleanField[] primary;
   ...
   public SearchColumnBooleanField[] getPrimary() {
      return this.primary;
   }

   public void setPrimary(SearchColumnBooleanField[] primary) {
      this.primary = primary;
   }

   public SearchColumnBooleanField getPrimary(int i) {
      return this.primary[i];
   }

   public void setPrimary(int i, SearchColumnBooleanField _value) {
      this.primary[i] = _value;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof MseSubsidiarySearchRowBasic)) {
         return false;
      } else {
         MseSubsidiarySearchRowBasic other = (MseSubsidiarySearchRowBasic)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getPrimary() != null) {
            for(i = 0; i < Array.getLength(this.getPrimary()); ++i) {
               obj = Array.get(this.getPrimary(), i);
               if (obj != null && !obj.getClass().isArray()) {
                  _hashCode += obj.hashCode();
               }
            }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "MseSubsidiarySearchRowBasic"));
