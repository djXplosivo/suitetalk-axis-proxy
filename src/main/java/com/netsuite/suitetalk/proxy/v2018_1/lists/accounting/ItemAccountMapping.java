...
import com.netsuite.suitetalk.proxy.v2018_1.lists.accounting.types.ItemAccountMappingItemAccount;
...
public class ItemAccountMapping extends Record implements Serializable {
   private RecordRef customForm;
   private Calendar effectiveDate;
   private Calendar endDate;
   private RecordRef accountingBook;
   private RecordRef subsidiary;
   private ItemAccountMappingItemAccount itemAccount;
   ...
   private static TypeDesc typeDesc = new TypeDesc(ItemAccountMapping.class, true);

   public ItemAccountMapping() {
      super();
   }

   public ItemAccountMapping(NullField nullFieldList, String internalId, String externalId, RecordRef customForm, Calendar effectiveDate, Calendar endDate, RecordRef accountingBook, RecordRef subsidiary, ItemAccountMappingItemAccount itemAccount, RecordRef sourceAccount, RecordRef _class, RecordRef department, RecordRef location, RecordRef destinationAccount, BaseRef customDimension, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   public void setItemAccount(ItemAccountMappingItemAccount itemAccount) {
      this.itemAccount = itemAccount;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemAccountMapping)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.customForm == null && other.getCustomForm() == null || this.customForm != null && this.customForm.equals(other.getCustomForm())) && (this.effectiveDate == null && other.getEffectiveDate() == null || this.effectiveDate != null && this.effectiveDate.equals(other.getEffectiveDate())) && (this.endDate == null && other.getEndDate() == null || this.endDate != null && this.endDate.equals(other.getEndDate())) && (this.accountingBook == null && other.getAccountingBook() == null || this.accountingBook != null && this.accountingBook.equals(other.getAccountingBook())) && (this.subsidiary == null && other.getSubsidiary() == null || this.subsidiary != null && this.subsidiary.equals(other.getSubsidiary())) && (this.itemAccount == null && other.getItemAccount() == null || this.itemAccount != null && this.itemAccount.equals(other.getItemAccount())) && (this.sourceAccount == null && other.getSourceAccount() == null || this.sourceAccount != null && this.sourceAccount.equals(other.getSourceAccount())) && (this._class == null && other.get_class() == null || this._class != null && this._class.equals(other.get_class())) && (this.department == null && other.getDepartment() == null || this.department != null && this.department.equals(other.getDepartment())) && (this.location == null && other.getLocation() == null || this.location != null && this.location.equals(other.getLocation())) && (this.destinationAccount == null && other.getDestinationAccount() == null || this.destinationAccount != null && this.destinationAccount.equals(other.getDestinationAccount())) && (this.customDimension == null && other.getCustomDimension() == null || this.customDimension != null && this.customDimension.equals(other.getCustomDimension())) && (this.customFieldList == null && other.getCustomFieldList() == null || this.customFieldList != null && this.customFieldList.equals(other.getCustomFieldList())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getItemAccount() != null) {
            _hashCode += this.getItemAccount().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemAccountMapping"));
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "itemAccount"));
      elemField.setXmlType(new QName("urn:types.accounting_2018_1.lists.webservices.netsuite.com", "ItemAccountMappingItemAccount"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
