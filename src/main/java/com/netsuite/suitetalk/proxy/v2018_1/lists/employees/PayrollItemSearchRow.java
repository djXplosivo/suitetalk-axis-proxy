...
public class PayrollItemSearchRow extends SearchRow implements Serializable {
   private PayrollItemSearchRowBasic basic;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PayrollItemSearchRow.class, true);

   public PayrollItemSearchRow() {
      super();
   }

   public PayrollItemSearchRow(PayrollItemSearchRowBasic basic, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PayrollItemSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PayrollItemSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "PayrollItemSearchRow"));
