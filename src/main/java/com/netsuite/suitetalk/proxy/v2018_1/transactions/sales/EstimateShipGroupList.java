...
public class EstimateShipGroupList implements Serializable {
   private TransactionShipGroup[] shipGroup;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(EstimateShipGroupList.class, true);

   public EstimateShipGroupList() {
      super();
   }

   public EstimateShipGroupList(TransactionShipGroup[] shipGroup, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof EstimateShipGroupList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "EstimateShipGroupList"));
