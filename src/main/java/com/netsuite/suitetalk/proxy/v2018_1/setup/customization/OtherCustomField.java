...
public class OtherCustomField extends CustomFieldType implements Serializable {
   ...
   private OtherCustomFieldFilterList filterList;
   ...
   private static TypeDesc typeDesc = new TypeDesc(OtherCustomField.class, true);

   public OtherCustomField() {
      super();
   }

   public OtherCustomField(NullField nullFieldList, CustomizationFieldType fieldType, String scriptId, String internalId, RecordRef recType, String label, RecordRef owner, String description, RecordRef selectRecordType, Boolean storeValue, Boolean showInList, RecordRef insertBefore, CustomizationDisplayType displayType, Long displayWidth, Long displayHeight, String help, String linkText, Boolean isMandatory, Boolean checkSpelling, Long maxLength, Double minValue, Double maxValue, Boolean defaultChecked, String defaultValue, Boolean isFormula, RecordRef defaultSelection, CustomizationDynamicDefault dynamicDefault, RecordRef searchDefault, RecordRef searchCompareField, RecordRef sourceList, RecordRef sourceFrom, RecordRef sourceFilterBy, OtherCustomFieldFilterList filterList, CustomizationAccessLevel accessLevel, CustomizationSearchLevel searchLevel, CustomFieldRoleAccessList roleAccessList, CustomFieldDepartmentAccessList deptAccessList, CustomFieldSubAccessList subAccessList, CustomFieldTranslationsList translationsList) {
   ...
   public void setFilterList(OtherCustomFieldFilterList filterList) {
      this.filterList = filterList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof OtherCustomField)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "OtherCustomField"));
      ...
      elemField.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "OtherCustomFieldFilterList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
