...
public class JobTypeSearchAdvanced extends SearchRecord implements Serializable {
   private JobTypeSearch criteria;
   private JobTypeSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(JobTypeSearchAdvanced.class, true);

   public JobTypeSearchAdvanced() {
      super();
   }

   public JobTypeSearchAdvanced(String savedSearchId, String savedSearchScriptId, JobTypeSearch criteria, JobTypeSearchRow columns) {
      super();
   ...
   public void setCriteria(JobTypeSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(JobTypeSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof JobTypeSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobTypeSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobTypeSearch"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobTypeSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
