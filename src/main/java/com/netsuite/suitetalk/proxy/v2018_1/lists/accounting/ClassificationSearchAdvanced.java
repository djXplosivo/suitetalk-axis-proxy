...
public class ClassificationSearchAdvanced extends SearchRecord implements Serializable {
   private ClassificationSearch criteria;
   private ClassificationSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ClassificationSearchAdvanced.class, true);

   public ClassificationSearchAdvanced() {
      super();
   }

   public ClassificationSearchAdvanced(String savedSearchId, String savedSearchScriptId, ClassificationSearch criteria, ClassificationSearchRow columns) {
      super();
   ...
   public void setCriteria(ClassificationSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ClassificationSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ClassificationSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ClassificationSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ClassificationSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ClassificationSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
