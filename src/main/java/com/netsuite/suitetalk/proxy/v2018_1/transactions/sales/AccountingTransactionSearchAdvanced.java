...
public class AccountingTransactionSearchAdvanced extends SearchRecord implements Serializable {
   private AccountingTransactionSearch criteria;
   private AccountingTransactionSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(AccountingTransactionSearchAdvanced.class, true);

   public AccountingTransactionSearchAdvanced() {
      super();
   }

   public AccountingTransactionSearchAdvanced(String savedSearchId, String savedSearchScriptId, AccountingTransactionSearch criteria, AccountingTransactionSearchRow columns) {
      super();
   ...
   public void setCriteria(AccountingTransactionSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(AccountingTransactionSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AccountingTransactionSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "AccountingTransactionSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "AccountingTransactionSearch"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "AccountingTransactionSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
