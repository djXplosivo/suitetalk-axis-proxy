...
public class InventoryNumberSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private SearchBooleanField isOnHand;
   ...
   private SearchDoubleField quantityInTransit;
   ...
   private static TypeDesc typeDesc = new TypeDesc(InventoryNumberSearchBasic.class, true);

   public InventoryNumberSearchBasic() {
      super();
   }

   public InventoryNumberSearchBasic(SearchDateField expirationDate, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchStringField inventoryNumber, SearchBooleanField isOnHand, SearchMultiSelectField item, SearchMultiSelectField location, SearchStringField memo, SearchDoubleField quantityAvailable, SearchDoubleField quantityInTransit, SearchDoubleField quantityOnHand, SearchDoubleField quantityOnOrder, SearchCustomFieldList customFieldList) {
      super();
   ...
   public void setIsOnHand(SearchBooleanField isOnHand) {
      this.isOnHand = isOnHand;
   }
   ...
   public void setQuantityInTransit(SearchDoubleField quantityInTransit) {
      this.quantityInTransit = quantityInTransit;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InventoryNumberSearchBasic)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.expirationDate == null && other.getExpirationDate() == null || this.expirationDate != null && this.expirationDate.equals(other.getExpirationDate())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId())) && (this.externalIdString == null && other.getExternalIdString() == null || this.externalIdString != null && this.externalIdString.equals(other.getExternalIdString())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.internalIdNumber == null && other.getInternalIdNumber() == null || this.internalIdNumber != null && this.internalIdNumber.equals(other.getInternalIdNumber())) && (this.inventoryNumber == null && other.getInventoryNumber() == null || this.inventoryNumber != null && this.inventoryNumber.equals(other.getInventoryNumber())) && (this.isOnHand == null && other.getIsOnHand() == null || this.isOnHand != null && this.isOnHand.equals(other.getIsOnHand())) && (this.item == null && other.getItem() == null || this.item != null && this.item.equals(other.getItem())) && (this.location == null && other.getLocation() == null || this.location != null && this.location.equals(other.getLocation())) && (this.memo == null && other.getMemo() == null || this.memo != null && this.memo.equals(other.getMemo())) && (this.quantityAvailable == null && other.getQuantityAvailable() == null || this.quantityAvailable != null && this.quantityAvailable.equals(other.getQuantityAvailable())) && (this.quantityInTransit == null && other.getQuantityInTransit() == null || this.quantityInTransit != null && this.quantityInTransit.equals(other.getQuantityInTransit())) && (this.quantityOnHand == null && other.getQuantityOnHand() == null || this.quantityOnHand != null && this.quantityOnHand.equals(other.getQuantityOnHand())) && (this.quantityOnOrder == null && other.getQuantityOnOrder() == null || this.quantityOnOrder != null && this.quantityOnOrder.equals(other.getQuantityOnOrder())) && (this.customFieldList == null && other.getCustomFieldList() == null || this.customFieldList != null && this.customFieldList.equals(other.getCustomFieldList()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getIsOnHand() != null) {
            _hashCode += this.getIsOnHand().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "InventoryNumberSearchBasic"));
