...
public class SalesTaxItemSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(SalesTaxItemSearchBasic.class, true);

   public SalesTaxItemSearchBasic() {
      super();
   }

   public SalesTaxItemSearchBasic(SearchStringField description, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField itemId, SearchMultiSelectField taxType) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesTaxItemSearchBasic)) {
         return false;
      } else {
         SalesTaxItemSearchBasic other = (SalesTaxItemSearchBasic)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "SalesTaxItemSearchBasic"));
