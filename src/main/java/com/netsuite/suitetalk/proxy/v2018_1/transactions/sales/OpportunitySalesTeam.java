...
public class OpportunitySalesTeam implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(OpportunitySalesTeam.class, true);

   public OpportunitySalesTeam() {
      super();
   }

   public OpportunitySalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof OpportunitySalesTeam)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "OpportunitySalesTeam"));
