...
public class TermSearchAdvanced extends SearchRecord implements Serializable {
   private TermSearch criteria;
   private TermSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TermSearchAdvanced.class, true);

   public TermSearchAdvanced() {
      super();
   }

   public TermSearchAdvanced(String savedSearchId, String savedSearchScriptId, TermSearch criteria, TermSearchRow columns) {
      super();
   ...
   public void setCriteria(TermSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TermSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TermSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TermSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TermSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TermSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
