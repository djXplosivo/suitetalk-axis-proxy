...
public class SearchColumnDateCustomField extends SearchColumnCustomField implements Serializable {
   private Calendar searchValue;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SearchColumnDateCustomField.class, true);

   public SearchColumnDateCustomField() {
      super();
   }

   public SearchColumnDateCustomField(String internalId, String scriptId, String customLabel, Calendar searchValue) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SearchColumnDateCustomField)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "SearchColumnDateCustomField"));
