...
public class AccountSearch extends SearchRecord implements Serializable {
   private AccountSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private CustomSearchJoin[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(AccountSearch.class, true);

   public AccountSearch() {
      super();
   }

   public AccountSearch(AccountSearchBasic basic, EmployeeSearchBasic userJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(AccountSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AccountSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AccountSearch"));
