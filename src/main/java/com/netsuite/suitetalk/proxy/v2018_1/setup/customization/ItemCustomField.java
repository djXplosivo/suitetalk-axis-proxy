...
import com.netsuite.suitetalk.proxy.v2018_1.setup.customization.types.ItemCustomFieldItemSubType;
...
public class ItemCustomField extends CustomFieldType implements Serializable {
   ...
   private ItemCustomFieldItemSubType itemSubType;
   private ItemCustomFieldFilterList filterList;
   ...
   private static TypeDesc typeDesc = new TypeDesc(ItemCustomField.class, true);

   public ItemCustomField() {
      super();
   }

   public ItemCustomField(NullField nullFieldList, CustomizationFieldType fieldType, String scriptId, String internalId, String label, RecordRef owner, Boolean itemMatrix, String description, RecordRef selectRecordType, Boolean storeValue, Boolean showInList, Boolean globalSearch, Boolean isParent, RecordRef insertBefore, RecordRef subtab, CustomizationDisplayType displayType, Long displayWidth, Long displayHeight, String help, RecordRef parentSubtab, String linkText, Boolean isMandatory, Boolean checkSpelling, Long maxLength, Double minValue, Double maxValue, Boolean defaultChecked, String defaultValue, Boolean isFormula, RecordRef defaultSelection, CustomizationDynamicDefault dynamicDefault, RecordRef searchDefault, RecordRef searchCompareField, RecordRef sourceList, RecordRef sourceFrom, RecordRef sourceFilterBy, Boolean appliesToInventory, Boolean appliesToNonInventory, Boolean appliesToService, Boolean appliesToOtherCharge, Boolean appliesToGroup, Boolean appliesToKit, Boolean appliesToItemAssembly, Boolean availableToSso, ItemCustomFieldItemSubType itemSubType, ItemCustomFieldFilterList filterList, Boolean appliesToPriceList, CustomizationAccessLevel accessLevel, CustomizationSearchLevel searchLevel, CustomFieldRoleAccessList roleAccessList, CustomFieldDepartmentAccessList deptAccessList, CustomFieldSubAccessList subAccessList, CustomFieldTranslationsList translationsList) {
   ...
   public Boolean getItemMatrix() {
      return this.itemMatrix;
   }

   public void setItemMatrix(Boolean itemMatrix) {
      this.itemMatrix = itemMatrix;
   }
   ...
   public Boolean getAppliesToInventory() {
   ...
   public Boolean getAppliesToNonInventory() {
   ...
   public Boolean getAppliesToService() {
   ...
   public Boolean getAppliesToOtherCharge() {
   ...
   public Boolean getAppliesToKit() {
   ...
   public Boolean getAppliesToItemAssembly() {
   ...
   public void setItemSubType(ItemCustomFieldItemSubType itemSubType) {
      this.itemSubType = itemSubType;
   }
   ...
   public void setFilterList(ItemCustomFieldFilterList filterList) {
      this.filterList = filterList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemCustomField)) {
         return false;
      } else {
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getItemMatrix() != null) {
            _hashCode += this.getItemMatrix().hashCode();
         }
         ...
         if (this.getAppliesToInventory() != null) {
            _hashCode += this.getAppliesToInventory().hashCode();
         }

         if (this.getAppliesToNonInventory() != null) {
            _hashCode += this.getAppliesToNonInventory().hashCode();
         }

         if (this.getAppliesToService() != null) {
            _hashCode += this.getAppliesToService().hashCode();
         }

         if (this.getAppliesToOtherCharge() != null) {
            _hashCode += this.getAppliesToOtherCharge().hashCode();
         }
         ...
         if (this.getAppliesToKit() != null) {
            _hashCode += this.getAppliesToKit().hashCode();
         }

         if (this.getAppliesToItemAssembly() != null) {
            _hashCode += this.getAppliesToItemAssembly().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "ItemCustomField"));
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "itemMatrix"));
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "appliesToInventory"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "appliesToNonInventory"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "appliesToService"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "appliesToOtherCharge"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "appliesToKit"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "appliesToItemAssembly"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "itemSubType"));
      elemField.setXmlType(new QName("urn:types.customization_2018_1.setup.webservices.netsuite.com", "ItemCustomFieldItemSubType"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      ...
      elemField.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "ItemCustomFieldFilterList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
