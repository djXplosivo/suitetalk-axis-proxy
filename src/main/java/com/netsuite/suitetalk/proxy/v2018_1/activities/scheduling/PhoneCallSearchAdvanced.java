...
public class PhoneCallSearchAdvanced extends SearchRecord implements Serializable {
   private PhoneCallSearch criteria;
   private PhoneCallSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PhoneCallSearchAdvanced.class, true);

   public PhoneCallSearchAdvanced() {
      super();
   }

   public PhoneCallSearchAdvanced(String savedSearchId, String savedSearchScriptId, PhoneCallSearch criteria, PhoneCallSearchRow columns) {
      super();
   ...
   public void setCriteria(PhoneCallSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(PhoneCallSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PhoneCallSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "PhoneCallSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "PhoneCallSearch"));
      ...
      elemField.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "PhoneCallSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
