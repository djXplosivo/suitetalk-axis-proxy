...
public class TransactionSearchAdvanced extends SearchRecord implements Serializable {
   private TransactionSearch criteria;
   private TransactionSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TransactionSearchAdvanced.class, true);

   public TransactionSearchAdvanced() {
      super();
   }

   public TransactionSearchAdvanced(String savedSearchId, String savedSearchScriptId, TransactionSearch criteria, TransactionSearchRow columns) {
      super();
   ...
   public void setCriteria(TransactionSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TransactionSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TransactionSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "TransactionSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "TransactionSearch"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "TransactionSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
