...
import com.netsuite.suitetalk.proxy.v2018_1.lists.marketing.types.CampaignCampaignDirectMailStatus;
...
public class CampaignDirectMail implements Serializable {
   ...
   private Double cost;
   private CampaignCampaignDirectMailStatus status;
   private Calendar dateScheduled;
   private RecordRef promoCode;
   private CustomFieldList customFieldList;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CampaignDirectMail.class, true);

   public CampaignDirectMail() {
      super();
   }

   public CampaignDirectMail(String internalId, RecordRef campaignGroup, RecordRef template, String description, RecordRef subscription, RecordRef channel, Double cost, CampaignCampaignDirectMailStatus status, Calendar dateScheduled, RecordRef promoCode, CustomFieldList customFieldList) {
      super();
   ...
   public void setStatus(CampaignCampaignDirectMailStatus status) {
      this.status = status;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CampaignDirectMail)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:marketing_2018_1.lists.webservices.netsuite.com", "CampaignDirectMail"));
      ...
      elemField.setXmlName(new QName("urn:marketing_2018_1.lists.webservices.netsuite.com", "template"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlType(new QName("urn:types.marketing_2018_1.lists.webservices.netsuite.com", "CampaignCampaignDirectMailStatus"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
