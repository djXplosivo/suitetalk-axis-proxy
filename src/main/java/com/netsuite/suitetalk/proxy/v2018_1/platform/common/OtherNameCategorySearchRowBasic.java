...
public class OtherNameCategorySearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(OtherNameCategorySearchRowBasic.class, true);

   public OtherNameCategorySearchRowBasic() {
      super();
   }

   public OtherNameCategorySearchRowBasic(SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof OtherNameCategorySearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "OtherNameCategorySearchRowBasic"));
