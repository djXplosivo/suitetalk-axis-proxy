...
public class EmployeeAddressbook implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(EmployeeAddressbook.class, true);

   public EmployeeAddressbook() {
      super();
   }

   public EmployeeAddressbook(Boolean defaultShipping, Boolean defaultBilling, String label, Address addressbookAddress, String internalId) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof EmployeeAddressbook)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "EmployeeAddressbook"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("defaultShipping");
      elemField.setXmlName(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "defaultShipping"));
      ...
      elemField.setXmlName(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "defaultBilling"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "label"));
      ...
      elemField.setXmlName(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "addressbookAddress"));
      ...
      elemField.setXmlName(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "internalId"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
