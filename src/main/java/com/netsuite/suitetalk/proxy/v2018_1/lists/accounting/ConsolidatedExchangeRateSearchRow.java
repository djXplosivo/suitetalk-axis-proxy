...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.ConsolidatedExchangeRateSearchRowBasic;
...
public class ConsolidatedExchangeRateSearchRow extends SearchRow implements Serializable {
   ...
   public ConsolidatedExchangeRateSearchRow(ConsolidatedExchangeRateSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ConsolidatedExchangeRateSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ConsolidatedExchangeRateSearchRowBasic"));
