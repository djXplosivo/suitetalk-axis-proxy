...
public class CustomRecordCustomField extends CustomFieldType implements Serializable {
   ...
   private Boolean roleRestrict;
   private CustomRecordCustomFieldFilterList filterList;
   ...
   public Boolean getRoleRestrict() {
      return this.roleRestrict;
   }

   public void setRoleRestrict(Boolean roleRestrict) {
      this.roleRestrict = roleRestrict;
   }
   ...
   public void setFilterList(CustomRecordCustomFieldFilterList filterList) {
      this.filterList = filterList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomRecordCustomField)) {
         return false;
      } else {
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getRoleRestrict() != null) {
            _hashCode += this.getRoleRestrict().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "CustomRecordCustomField"));
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "roleRestrict"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "CustomRecordCustomFieldFilterList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
