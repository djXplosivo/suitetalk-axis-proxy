...
public class SolutionSearchAdvanced extends SearchRecord implements Serializable {
   private SolutionSearch criteria;
   private SolutionSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SolutionSearchAdvanced.class, true);

   public SolutionSearchAdvanced() {
      super();
   }

   public SolutionSearchAdvanced(String savedSearchId, String savedSearchScriptId, SolutionSearch criteria, SolutionSearchRow columns) {
      super();
   ...
   public void setCriteria(SolutionSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(SolutionSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SolutionSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "SolutionSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "SolutionSearch"));
      ...
      elemField.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "SolutionSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
