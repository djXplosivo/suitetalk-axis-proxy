...
public class VendorCategorySearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private SearchBooleanField isTaxAgency;
   private SearchStringField name;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(VendorCategorySearchBasic.class, true);

   public VendorCategorySearchBasic() {
      super();
   }

   public VendorCategorySearchBasic(SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchBooleanField isTaxAgency, SearchStringField name) {
      super();
   ...
   public void setIsTaxAgency(SearchBooleanField isTaxAgency) {
      this.isTaxAgency = isTaxAgency;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof VendorCategorySearchBasic)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId())) && (this.externalIdString == null && other.getExternalIdString() == null || this.externalIdString != null && this.externalIdString.equals(other.getExternalIdString())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.internalIdNumber == null && other.getInternalIdNumber() == null || this.internalIdNumber != null && this.internalIdNumber.equals(other.getInternalIdNumber())) && (this.isInactive == null && other.getIsInactive() == null || this.isInactive != null && this.isInactive.equals(other.getIsInactive())) && (this.isTaxAgency == null && other.getIsTaxAgency() == null || this.isTaxAgency != null && this.isTaxAgency.equals(other.getIsTaxAgency())) && (this.name == null && other.getName() == null || this.name != null && this.name.equals(other.getName()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getIsTaxAgency() != null) {
            _hashCode += this.getIsTaxAgency().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "VendorCategorySearchBasic"));
