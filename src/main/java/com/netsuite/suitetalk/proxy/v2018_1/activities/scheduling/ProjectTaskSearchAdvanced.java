...
public class ProjectTaskSearchAdvanced extends SearchRecord implements Serializable {
   private ProjectTaskSearch criteria;
   private ProjectTaskSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ProjectTaskSearchAdvanced.class, true);

   public ProjectTaskSearchAdvanced() {
      super();
   }

   public ProjectTaskSearchAdvanced(String savedSearchId, String savedSearchScriptId, ProjectTaskSearch criteria, ProjectTaskSearchRow columns) {
      super();
   ...
   public void setCriteria(ProjectTaskSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ProjectTaskSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ProjectTaskSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "ProjectTaskSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "ProjectTaskSearch"));
      ...
      elemField.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "ProjectTaskSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
