...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.VendorCategorySearchRowBasic;
...
public class VendorCategorySearchRow extends SearchRow implements Serializable {
   private VendorCategorySearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(VendorCategorySearchRow.class, true);

   public VendorCategorySearchRow() {
      super();
   }

   public VendorCategorySearchRow(VendorCategorySearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(VendorCategorySearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof VendorCategorySearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "VendorCategorySearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "VendorCategorySearchRowBasic"));
