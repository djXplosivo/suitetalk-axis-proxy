...
public class InventoryNumberSearchRow extends SearchRow implements Serializable {
   private InventoryNumberSearchRowBasic basic;
   ...
   private static TypeDesc typeDesc = new TypeDesc(InventoryNumberSearchRow.class, true);

   public InventoryNumberSearchRow() {
      super();
   }

   public InventoryNumberSearchRow(InventoryNumberSearchRowBasic basic, ItemSearchRowBasic itemJoin, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(InventoryNumberSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InventoryNumberSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "InventoryNumberSearchRow"));
