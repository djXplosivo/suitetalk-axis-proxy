...
public class CustomerRefundApplyList implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomerRefundApplyList.class, true);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerRefundApplyList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CustomerRefundApplyList"));
      ...
      elemField.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CustomerRefundApply"));
