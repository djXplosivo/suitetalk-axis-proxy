...
public class ManufacturingCostTemplateSearchRow extends SearchRow implements Serializable {
   private ManufacturingCostTemplateSearchRowBasic basic;
   ...
   private static TypeDesc typeDesc = new TypeDesc(ManufacturingCostTemplateSearchRow.class, true);

   public ManufacturingCostTemplateSearchRow() {
      super();
   }

   public ManufacturingCostTemplateSearchRow(ManufacturingCostTemplateSearchRowBasic basic, ItemSearchRowBasic itemJoin, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(ManufacturingCostTemplateSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ManufacturingCostTemplateSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:supplychain_2018_1.lists.webservices.netsuite.com", "ManufacturingCostTemplateSearchRow"));
