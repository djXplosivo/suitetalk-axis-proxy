...
public class InventoryNumberBinSearchBasic extends SearchRecordBasic implements Serializable {
   private SearchMultiSelectField binNumber;
   private SearchStringField inventoryNumber;
   ...
   private static TypeDesc typeDesc = new TypeDesc(InventoryNumberBinSearchBasic.class, true);

   public InventoryNumberBinSearchBasic() {
      super();
   }

   public InventoryNumberBinSearchBasic(SearchMultiSelectField binNumber, SearchStringField inventoryNumber, SearchMultiSelectField location, SearchDoubleField quantityAvailable, SearchDoubleField quantityOnHand) {
      super();
   ...
   public void setInventoryNumber(SearchStringField inventoryNumber) {
      this.inventoryNumber = inventoryNumber;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InventoryNumberBinSearchBasic)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.binNumber == null && other.getBinNumber() == null || this.binNumber != null && this.binNumber.equals(other.getBinNumber())) && (this.inventoryNumber == null && other.getInventoryNumber() == null || this.inventoryNumber != null && this.inventoryNumber.equals(other.getInventoryNumber())) && (this.location == null && other.getLocation() == null || this.location != null && this.location.equals(other.getLocation())) && (this.quantityAvailable == null && other.getQuantityAvailable() == null || this.quantityAvailable != null && this.quantityAvailable.equals(other.getQuantityAvailable())) && (this.quantityOnHand == null && other.getQuantityOnHand() == null || this.quantityOnHand != null && this.quantityOnHand.equals(other.getQuantityOnHand()));
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "InventoryNumberBinSearchBasic"));
