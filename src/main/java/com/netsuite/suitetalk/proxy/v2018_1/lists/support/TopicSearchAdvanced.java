...
public class TopicSearchAdvanced extends SearchRecord implements Serializable {
   private TopicSearch criteria;
   private TopicSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TopicSearchAdvanced.class, true);

   public TopicSearchAdvanced() {
      super();
   }

   public TopicSearchAdvanced(String savedSearchId, String savedSearchScriptId, TopicSearch criteria, TopicSearchRow columns) {
      super();
   ...
   public void setCriteria(TopicSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TopicSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TopicSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "TopicSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "TopicSearch"));
      ...
      elemField.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "TopicSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
