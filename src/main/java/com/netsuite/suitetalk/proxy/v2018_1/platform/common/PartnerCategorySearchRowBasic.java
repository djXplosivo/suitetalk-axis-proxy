...
public class PartnerCategorySearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(PartnerCategorySearchRowBasic.class, true);

   public PartnerCategorySearchRowBasic() {
      super();
   }

   public PartnerCategorySearchRowBasic(SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name, SearchColumnSelectField[] parent) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PartnerCategorySearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PartnerCategorySearchRowBasic"));
