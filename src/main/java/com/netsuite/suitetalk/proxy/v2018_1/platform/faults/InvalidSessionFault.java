...
public class InvalidSessionFault extends SoapFault implements Serializable {
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(InvalidSessionFault.class, true);

   public InvalidSessionFault() {
      super();
   }

   public InvalidSessionFault(FaultCodeType code, String message1) {
      super(code, message1);
   }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:faults_2018_1.platform.webservices.netsuite.com", "InvalidSessionFault"));
   }
}
