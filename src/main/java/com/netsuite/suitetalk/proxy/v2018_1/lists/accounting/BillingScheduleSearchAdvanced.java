...
public class BillingScheduleSearchAdvanced extends SearchRecord implements Serializable {
   private BillingScheduleSearch criteria;
   private BillingScheduleSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(BillingScheduleSearchAdvanced.class, true);

   public BillingScheduleSearchAdvanced() {
      super();
   }

   public BillingScheduleSearchAdvanced(String savedSearchId, String savedSearchScriptId, BillingScheduleSearch criteria, BillingScheduleSearchRow columns) {
      super();
   ...
   public void setCriteria(BillingScheduleSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(BillingScheduleSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof BillingScheduleSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "BillingScheduleSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "BillingScheduleSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "BillingScheduleSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
