...
public class InvoiceItemList implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(InvoiceItemList.class, true);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InvoiceItemList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "InvoiceItemList"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "InvoiceItem"));
