...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.TermSearchBasic;
...
public class TermSearch extends SearchRecord implements Serializable {
   private TermSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TermSearch.class, true);

   public TermSearch() {
      super();
   }

   public TermSearch(TermSearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(TermSearchBasic basic) {
      this.basic = basic;
   }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TermSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "TermSearchBasic"));
