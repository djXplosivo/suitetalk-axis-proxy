...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.FairValuePriceSearchRowBasic;
...
public class FairValuePriceSearchRow extends SearchRow implements Serializable {
   private FairValuePriceSearchRowBasic basic;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(FairValuePriceSearchRow.class, true);

   public FairValuePriceSearchRow() {
      super();
   }

   public FairValuePriceSearchRow(FairValuePriceSearchRowBasic basic, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(FairValuePriceSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof FairValuePriceSearchRow)) {
         return false;
      } else {
         FairValuePriceSearchRow other = (FairValuePriceSearchRow)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "FairValuePriceSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "FairValuePriceSearchRowBasic"));
