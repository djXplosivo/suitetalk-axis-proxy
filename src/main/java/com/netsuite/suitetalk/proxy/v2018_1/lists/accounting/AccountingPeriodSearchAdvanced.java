...
public class AccountingPeriodSearchAdvanced extends SearchRecord implements Serializable {
   private AccountingPeriodSearch criteria;
   private AccountingPeriodSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(AccountingPeriodSearchAdvanced.class, true);

   public AccountingPeriodSearchAdvanced() {
      super();
   }

   public AccountingPeriodSearchAdvanced(String savedSearchId, String savedSearchScriptId, AccountingPeriodSearch criteria, AccountingPeriodSearchRow columns) {
      super();
   ...
   public void setCriteria(AccountingPeriodSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(AccountingPeriodSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AccountingPeriodSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AccountingPeriodSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AccountingPeriodSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AccountingPeriodSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
