...
public class TransactionColumnCustomFieldFilter implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(TransactionColumnCustomFieldFilter.class, true);

   public TransactionColumnCustomFieldFilter() {
      super();
   }

   public TransactionColumnCustomFieldFilter(RecordRef fldFilter, Boolean fldFilterChecked, CustomizationFilterCompareType fldFilterCompareType, String fldFilterVal, FldFilterSelList fldFilterSelList, Boolean fldFilterNotNull) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TransactionColumnCustomFieldFilter)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "TransactionColumnCustomFieldFilter"));
