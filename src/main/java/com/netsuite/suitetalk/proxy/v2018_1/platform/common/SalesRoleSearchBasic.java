...
public class SalesRoleSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(SalesRoleSearchBasic.class, true);

   public SalesRoleSearchBasic() {
      super();
   }

   public SalesRoleSearchBasic(SearchStringField description, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesRoleSearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "SalesRoleSearchBasic"));
