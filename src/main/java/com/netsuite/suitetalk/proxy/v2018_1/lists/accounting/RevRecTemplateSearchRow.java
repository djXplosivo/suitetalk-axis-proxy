...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.RevRecTemplateSearchRowBasic;
...
public class RevRecTemplateSearchRow extends SearchRow implements Serializable {
   private RevRecTemplateSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(RevRecTemplateSearchRow.class, true);

   public RevRecTemplateSearchRow() {
      super();
   }

   public RevRecTemplateSearchRow(RevRecTemplateSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(RevRecTemplateSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof RevRecTemplateSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecTemplateSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "RevRecTemplateSearchRowBasic"));
