...
public class VendorCategorySearchRowBasic extends SearchRowBasic implements Serializable {
   private SearchColumnSelectField[] externalId;
   private SearchColumnSelectField[] internalId;
   private SearchColumnBooleanField[] isInactive;
   private SearchColumnBooleanField[] isTaxAgency;
   private SearchColumnStringField[] name;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(VendorCategorySearchRowBasic.class, true);

   public VendorCategorySearchRowBasic() {
      super();
   }

   public VendorCategorySearchRowBasic(SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnBooleanField[] isTaxAgency, SearchColumnStringField[] name) {
      super();
   ...
   public SearchColumnBooleanField[] getIsTaxAgency() {
      return this.isTaxAgency;
   }

   public void setIsTaxAgency(SearchColumnBooleanField[] isTaxAgency) {
      this.isTaxAgency = isTaxAgency;
   }

   public SearchColumnBooleanField getIsTaxAgency(int i) {
      return this.isTaxAgency[i];
   }

   public void setIsTaxAgency(int i, SearchColumnBooleanField _value) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof VendorCategorySearchRowBasic)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && Arrays.equals(this.externalId, other.getExternalId())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && Arrays.equals(this.internalId, other.getInternalId())) && (this.isInactive == null && other.getIsInactive() == null || this.isInactive != null && Arrays.equals(this.isInactive, other.getIsInactive())) && (this.isTaxAgency == null && other.getIsTaxAgency() == null || this.isTaxAgency != null && Arrays.equals(this.isTaxAgency, other.getIsTaxAgency())) && (this.name == null && other.getName() == null || this.name != null && Arrays.equals(this.name, other.getName()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getIsTaxAgency() != null) {
            for(i = 0; i < Array.getLength(this.getIsTaxAgency()); ++i) {
               obj = Array.get(this.getIsTaxAgency(), i);
               if (obj != null && !obj.getClass().isArray()) {
                  _hashCode += obj.hashCode();
               }
            }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "VendorCategorySearchRowBasic"));
      ...
      elemField.setXmlName(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "isTaxAgency"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "SearchColumnBooleanField"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      elemField.setMaxOccursUnbounded(true);
