...
public class ExpenseCategorySearchAdvanced extends SearchRecord implements Serializable {
   private ExpenseCategorySearch criteria;
   private ExpenseCategorySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ExpenseCategorySearchAdvanced.class, true);

   public ExpenseCategorySearchAdvanced() {
      super();
   }

   public ExpenseCategorySearchAdvanced(String savedSearchId, String savedSearchScriptId, ExpenseCategorySearch criteria, ExpenseCategorySearchRow columns) {
      super();
   ...
   public void setCriteria(ExpenseCategorySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ExpenseCategorySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ExpenseCategorySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ExpenseCategorySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ExpenseCategorySearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ExpenseCategorySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
