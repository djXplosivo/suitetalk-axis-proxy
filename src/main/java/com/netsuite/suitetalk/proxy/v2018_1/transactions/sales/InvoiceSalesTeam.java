...
public class InvoiceSalesTeam implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(InvoiceSalesTeam.class, true);

   public InvoiceSalesTeam() {
      super();
   }

   public InvoiceSalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InvoiceSalesTeam)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "InvoiceSalesTeam"));
