...
public class OtherNameCategorySearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(OtherNameCategorySearchBasic.class, true);

   public OtherNameCategorySearchBasic() {
      super();
   }

   public OtherNameCategorySearchBasic(SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof OtherNameCategorySearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "OtherNameCategorySearchBasic"));
