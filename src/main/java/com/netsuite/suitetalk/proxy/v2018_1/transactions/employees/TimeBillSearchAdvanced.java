...
public class TimeBillSearchAdvanced extends SearchRecord implements Serializable {
   private TimeBillSearch criteria;
   private TimeBillSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TimeBillSearchAdvanced.class, true);

   public TimeBillSearchAdvanced() {
      super();
   }

   public TimeBillSearchAdvanced(String savedSearchId, String savedSearchScriptId, TimeBillSearch criteria, TimeBillSearchRow columns) {
      super();
   ...
   public void setCriteria(TimeBillSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TimeBillSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TimeBillSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeBillSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeBillSearch"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeBillSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
