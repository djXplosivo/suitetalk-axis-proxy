...
public class ProjectTaskTimeItemList implements Serializable {
   private TimeItem[] timeItem;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ProjectTaskTimeItemList.class, true);

   public ProjectTaskTimeItemList() {
      super();
   }

   public ProjectTaskTimeItemList(TimeItem[] timeItem, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ProjectTaskTimeItemList)) {
         return false;
      } else {
         ProjectTaskTimeItemList other = (ProjectTaskTimeItemList)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "ProjectTaskTimeItemList"));
