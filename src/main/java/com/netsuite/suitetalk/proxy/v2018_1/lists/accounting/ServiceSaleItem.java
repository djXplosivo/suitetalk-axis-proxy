...
public class ServiceSaleItem extends Record implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(ServiceSaleItem.class, true);

   public ServiceSaleItem() {
      super();
   }

   public ServiceSaleItem(NullField nullFieldList, String internalId, String externalId, Calendar createdDate, Calendar lastModifiedDate, String salesDescription, Boolean includeChildren, RecordRef incomeAccount, Boolean isTaxable, ItemMatrixType matrixType, RecordRef taxSchedule, ItemCostEstimateType costEstimateType, Double costEstimate, RecordRef unitsType, RecordRef saleUnit, RecordRef issueProduct, String costEstimateUnits, RecordRef billingSchedule, RecordRef deferredRevenueAccount, RecordRef revRecSchedule, Long minimumQuantity, Boolean enforceMinQtyInternally, String softDescriptor, Boolean pricesIncludeTax, RecordRef quantityPricingSchedule, Boolean useMarginalRates, ItemOverallQuantityPricingType overallQuantityPricingType, Boolean isFulfillable, RecordRef costCategory, RecordRef pricingGroup, String minimumQuantityUnits, Double vsoePrice, VsoeSopGroup vsoeSopGroup, VsoeDeferral vsoeDeferral, VsoePermitDiscount vsoePermitDiscount, Boolean vsoeDelivered, RecordRef itemRevenueCategory, Boolean deferRevRec, RecordRef revenueRecognitionRule, RecordRef revRecForecastRule, RecordRef revenueAllocationGroup, RecordRef createRevenuePlansOn, Boolean directRevenuePosting, Boolean contingentRevenueHandling, RecordRef revReclassFXAccount, Boolean createJob, String matrixItemNameTemplate, String storeDisplayName, RecordRef storeDisplayThumbnail, RecordRef storeDisplayImage, String storeDescription, String storeDetailedDescription, RecordRef storeItemTemplate, String pageTitle, String urlComponent, String metaTagHtml, Boolean excludeFromSitemap, SitemapPriority sitemapPriority, String searchKeywords, Boolean isDonationItem, Boolean showDefaultDonationAmount, Double maxDonationAmount, Boolean dontShowPrice, String noPriceMessage, String outOfStockMessage, Boolean onSpecial, ItemOutOfStockBehavior outOfStockBehavior, String relatedItemsDescription, String specialsDescription, ServiceItemTaskTemplatesList itemTaskTemplatesList, String featuredDescription, RecordRef customForm, String itemId, String upcCode, String displayName, RecordRef parent, Boolean isOnline, Boolean isGcoCompliant, Boolean offerSupport, Boolean isInactive, Boolean availableToPartners, RecordRef department, RecordRef _class, RecordRef location, RecordRefList subsidiaryList, BillingRatesMatrix billingRatesMatrix, ItemAccountingBookDetailList accountingBookDetailList, ItemOptionsList itemOptionsList, MatrixOptionList matrixOptionList, PricingMatrix pricingMatrix, RecordRef purchaseTaxCode, Double rate, RecordRef salesTaxCode, SiteCategoryList siteCategoryList, TranslationList translationsList, PresentationItemList presentationItemList, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ServiceSaleItem)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ServiceSaleItem"));
