...
public class InventoryNumberSearch extends SearchRecord implements Serializable {
   private InventoryNumberSearchBasic basic;
   ...
   private static TypeDesc typeDesc = new TypeDesc(InventoryNumberSearch.class, true);

   public InventoryNumberSearch() {
      super();
   }

   public InventoryNumberSearch(InventoryNumberSearchBasic basic, ItemSearchBasic itemJoin, EmployeeSearchBasic userJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(InventoryNumberSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InventoryNumberSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "InventoryNumberSearch"));
