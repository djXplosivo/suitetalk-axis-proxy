...
public class PromotionCodeSearch extends SearchRecord implements Serializable {
   private PromotionCodeSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private CustomSearchJoin[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PromotionCodeSearch.class, true);

   public PromotionCodeSearch() {
      super();
   }

   public PromotionCodeSearch(PromotionCodeSearchBasic basic, EmployeeSearchBasic userJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PromotionCodeSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PromotionCodeSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:marketing_2018_1.lists.webservices.netsuite.com", "PromotionCodeSearch"));
