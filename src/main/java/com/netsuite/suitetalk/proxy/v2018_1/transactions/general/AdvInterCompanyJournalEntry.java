...
public class AdvInterCompanyJournalEntry extends Record implements Serializable {
   ...
   private Boolean performAutoBalance;
   private AdvInterCompanyJournalEntryLineList lineList;
   private AdvInterCompanyJournalEntryAccountingBookDetailList accountingBookDetailList;
   private CustomFieldList customFieldList;
   private String internalId;
   private String externalId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(AdvInterCompanyJournalEntry.class, true);

   public AdvInterCompanyJournalEntry() {
      super();
   }

   public AdvInterCompanyJournalEntry(NullField nullFieldList, String internalId, String externalId, RecordRef postingPeriod, RecordRef customForm, Calendar tranDate, RecordRef currency, String tranId, Calendar reversalDate, Boolean reversalDefer, RecordRef parentExpenseAlloc, Boolean isBookSpecific, RecordRef accountingBook, String reversalEntry, RecordRef createdFrom, RecordRef department, RecordRef _class, RecordRef location, RecordRef subsidiary, String memo, Boolean approved, Calendar createdDate, Calendar lastModifiedDate, Boolean performAutoBalance, AdvInterCompanyJournalEntryLineList lineList, AdvInterCompanyJournalEntryAccountingBookDetailList accountingBookDetailList, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   public Boolean getPerformAutoBalance() {
      return this.performAutoBalance;
   }

   public void setPerformAutoBalance(Boolean performAutoBalance) {
      this.performAutoBalance = performAutoBalance;
   }
   ...
   public void setLineList(AdvInterCompanyJournalEntryLineList lineList) {
      this.lineList = lineList;
   }
   ...
   public void setAccountingBookDetailList(AdvInterCompanyJournalEntryAccountingBookDetailList accountingBookDetailList) {
      this.accountingBookDetailList = accountingBookDetailList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AdvInterCompanyJournalEntry)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.postingPeriod == null && other.getPostingPeriod() == null || this.postingPeriod != null && this.postingPeriod.equals(other.getPostingPeriod())) && (this.customForm == null && other.getCustomForm() == null || this.customForm != null && this.customForm.equals(other.getCustomForm())) && (this.tranDate == null && other.getTranDate() == null || this.tranDate != null && this.tranDate.equals(other.getTranDate())) && (this.currency == null && other.getCurrency() == null || this.currency != null && this.currency.equals(other.getCurrency())) && (this.tranId == null && other.getTranId() == null || this.tranId != null && this.tranId.equals(other.getTranId())) && (this.reversalDate == null && other.getReversalDate() == null || this.reversalDate != null && this.reversalDate.equals(other.getReversalDate())) && (this.reversalDefer == null && other.getReversalDefer() == null || this.reversalDefer != null && this.reversalDefer.equals(other.getReversalDefer())) && (this.parentExpenseAlloc == null && other.getParentExpenseAlloc() == null || this.parentExpenseAlloc != null && this.parentExpenseAlloc.equals(other.getParentExpenseAlloc())) && (this.isBookSpecific == null && other.getIsBookSpecific() == null || this.isBookSpecific != null && this.isBookSpecific.equals(other.getIsBookSpecific())) && (this.accountingBook == null && other.getAccountingBook() == null || this.accountingBook != null && this.accountingBook.equals(other.getAccountingBook())) && (this.reversalEntry == null && other.getReversalEntry() == null || this.reversalEntry != null && this.reversalEntry.equals(other.getReversalEntry())) && (this.createdFrom == null && other.getCreatedFrom() == null || this.createdFrom != null && this.createdFrom.equals(other.getCreatedFrom())) && (this.department == null && other.getDepartment() == null || this.department != null && this.department.equals(other.getDepartment())) && (this._class == null && other.get_class() == null || this._class != null && this._class.equals(other.get_class())) && (this.location == null && other.getLocation() == null || this.location != null && this.location.equals(other.getLocation())) && (this.subsidiary == null && other.getSubsidiary() == null || this.subsidiary != null && this.subsidiary.equals(other.getSubsidiary())) && (this.memo == null && other.getMemo() == null || this.memo != null && this.memo.equals(other.getMemo())) && (this.approved == null && other.getApproved() == null || this.approved != null && this.approved.equals(other.getApproved())) && (this.createdDate == null && other.getCreatedDate() == null || this.createdDate != null && this.createdDate.equals(other.getCreatedDate())) && (this.lastModifiedDate == null && other.getLastModifiedDate() == null || this.lastModifiedDate != null && this.lastModifiedDate.equals(other.getLastModifiedDate())) && (this.performAutoBalance == null && other.getPerformAutoBalance() == null || this.performAutoBalance != null && this.performAutoBalance.equals(other.getPerformAutoBalance())) && (this.lineList == null && other.getLineList() == null || this.lineList != null && this.lineList.equals(other.getLineList())) && (this.accountingBookDetailList == null && other.getAccountingBookDetailList() == null || this.accountingBookDetailList != null && this.accountingBookDetailList.equals(other.getAccountingBookDetailList())) && (this.customFieldList == null && other.getCustomFieldList() == null || this.customFieldList != null && this.customFieldList.equals(other.getCustomFieldList())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getPerformAutoBalance() != null) {
            _hashCode += this.getPerformAutoBalance().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "AdvInterCompanyJournalEntry"));
      ...
      elemField.setXmlName(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "performAutoBalance"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlType(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "AdvInterCompanyJournalEntryLineList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      ...
      elemField.setXmlType(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "AdvInterCompanyJournalEntryAccountingBookDetailList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
