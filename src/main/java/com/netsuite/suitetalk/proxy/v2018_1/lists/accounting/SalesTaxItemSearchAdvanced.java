...
public class SalesTaxItemSearchAdvanced extends SearchRecord implements Serializable {
   private SalesTaxItemSearch criteria;
   private SalesTaxItemSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SalesTaxItemSearchAdvanced.class, true);

   public SalesTaxItemSearchAdvanced() {
      super();
   }

   public SalesTaxItemSearchAdvanced(String savedSearchId, String savedSearchScriptId, SalesTaxItemSearch criteria, SalesTaxItemSearchRow columns) {
      super();
   ...
   public void setCriteria(SalesTaxItemSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(SalesTaxItemSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesTaxItemSearchAdvanced)) {
         return false;
      } else {
         SalesTaxItemSearchAdvanced other = (SalesTaxItemSearchAdvanced)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SalesTaxItemSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SalesTaxItemSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SalesTaxItemSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
