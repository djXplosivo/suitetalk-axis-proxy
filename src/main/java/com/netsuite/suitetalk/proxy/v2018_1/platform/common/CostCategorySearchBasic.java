...
public class CostCategorySearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private SearchEnumMultiSelectField itemCostType;
   private SearchStringField name;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CostCategorySearchBasic.class, true);

   public CostCategorySearchBasic() {
      super();
   }

   public CostCategorySearchBasic(SearchMultiSelectField account, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchEnumMultiSelectField itemCostType, SearchStringField name) {
      super();
   ...
   public void setItemCostType(SearchEnumMultiSelectField itemCostType) {
      this.itemCostType = itemCostType;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CostCategorySearchBasic)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.account == null && other.getAccount() == null || this.account != null && this.account.equals(other.getAccount())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId())) && (this.externalIdString == null && other.getExternalIdString() == null || this.externalIdString != null && this.externalIdString.equals(other.getExternalIdString())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.internalIdNumber == null && other.getInternalIdNumber() == null || this.internalIdNumber != null && this.internalIdNumber.equals(other.getInternalIdNumber())) && (this.isInactive == null && other.getIsInactive() == null || this.isInactive != null && this.isInactive.equals(other.getIsInactive())) && (this.itemCostType == null && other.getItemCostType() == null || this.itemCostType != null && this.itemCostType.equals(other.getItemCostType())) && (this.name == null && other.getName() == null || this.name != null && this.name.equals(other.getName()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getItemCostType() != null) {
            _hashCode += this.getItemCostType().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CostCategorySearchBasic"));
