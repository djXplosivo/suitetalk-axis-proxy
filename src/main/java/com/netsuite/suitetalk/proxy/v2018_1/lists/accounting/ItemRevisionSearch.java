...
public class ItemRevisionSearch extends SearchRecord implements Serializable {
   private ItemRevisionSearchBasic basic;
   private ItemSearchBasic itemJoin;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ItemRevisionSearch.class, true);

   public ItemRevisionSearch() {
      super();
   }

   public ItemRevisionSearch(ItemRevisionSearchBasic basic, ItemSearchBasic itemJoin, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(ItemRevisionSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemRevisionSearch)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.basic == null && other.getBasic() == null || this.basic != null && this.basic.equals(other.getBasic())) && (this.itemJoin == null && other.getItemJoin() == null || this.itemJoin != null && this.itemJoin.equals(other.getItemJoin())) && (this.userJoin == null && other.getUserJoin() == null || this.userJoin != null && this.userJoin.equals(other.getUserJoin()));
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemRevisionSearch"));
