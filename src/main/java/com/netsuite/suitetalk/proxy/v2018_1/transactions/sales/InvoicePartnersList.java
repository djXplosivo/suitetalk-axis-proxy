...
public class InvoicePartnersList implements Serializable {
   private Partners[] partners;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(InvoicePartnersList.class, true);

   public InvoicePartnersList() {
      super();
   }

   public InvoicePartnersList(Partners[] partners, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InvoicePartnersList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "InvoicePartnersList"));
