...
public class VendorRoles implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "VendorRoles"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("selectedRole");
      elemField.setXmlName(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "selectedRole"));
