...
public class ExpenseCategorySearch extends SearchRecord implements Serializable {
   private ExpenseCategorySearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private CustomSearchJoin[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ExpenseCategorySearch.class, true);

   public ExpenseCategorySearch() {
      super();
   }

   public ExpenseCategorySearch(ExpenseCategorySearchBasic basic, EmployeeSearchBasic userJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(ExpenseCategorySearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ExpenseCategorySearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ExpenseCategorySearch"));
