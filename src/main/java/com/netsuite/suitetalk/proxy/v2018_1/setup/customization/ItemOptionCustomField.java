...
public class ItemOptionCustomField extends CustomFieldType implements Serializable {
   ...
   private Boolean colAllItems;
   private ItemsList itemsList;
   private Boolean colKitItem;
   private ItemOptionCustomFieldFilterList filterList;
   private String colOptionLabel;
   ...
   private static TypeDesc typeDesc = new TypeDesc(ItemOptionCustomField.class, true);

   public ItemOptionCustomField() {
      super();
   }

   public ItemOptionCustomField(NullField nullFieldList, CustomizationFieldType fieldType, String scriptId, String internalId, String label, RecordRef owner, String description, RecordRef selectRecordType, Boolean storeValue, RecordRef insertBefore, CustomizationDisplayType displayType, Long displayWidth, Long displayHeight, String help, String linkText, Boolean isMandatory, Long maxLength, Double minValue, Double maxValue, Boolean defaultChecked, String defaultValue, Boolean isFormula, RecordRef defaultSelection, CustomizationDynamicDefault dynamicDefault, RecordRef searchDefault, RecordRef searchCompareField, RecordRef sourceList, RecordRef sourceFrom, RecordRef sourceFilterBy, Boolean colPurchase, Boolean colSale, Boolean colOpportunity, Boolean colStore, Boolean colStoreHidden, Boolean colTransferOrder, Boolean colAllItems, ItemsList itemsList, Boolean colKitItem, ItemOptionCustomFieldFilterList filterList, String colOptionLabel, CustomizationAccessLevel accessLevel, CustomizationSearchLevel searchLevel, CustomFieldRoleAccessList roleAccessList, CustomFieldDepartmentAccessList deptAccessList, CustomFieldSubAccessList subAccessList, CustomFieldTranslationsList translationsList) {
   ...
   public Boolean getColAllItems() {
      return this.colAllItems;
   }

   public void setColAllItems(Boolean colAllItems) {
      this.colAllItems = colAllItems;
   }
   ...
   public void setFilterList(ItemOptionCustomFieldFilterList filterList) {
      this.filterList = filterList;
   }
   ...
   public void setColOptionLabel(String colOptionLabel) {
      this.colOptionLabel = colOptionLabel;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemOptionCustomField)) {
         return false;
      } else {
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getColAllItems() != null) {
            _hashCode += this.getColAllItems().hashCode();
         }
         ...
         if (this.getColOptionLabel() != null) {
            _hashCode += this.getColOptionLabel().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "ItemOptionCustomField"));
      ...
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "colAllItems"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "ItemsList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      ...
      elemField.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "ItemOptionCustomFieldFilterList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("colOptionLabel");
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "colOptionLabel"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
