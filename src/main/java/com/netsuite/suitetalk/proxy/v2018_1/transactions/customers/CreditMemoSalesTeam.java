...
public class CreditMemoSalesTeam implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CreditMemoSalesTeam.class, true);

   public CreditMemoSalesTeam() {
      super();
   }

   public CreditMemoSalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CreditMemoSalesTeam)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CreditMemoSalesTeam"));
