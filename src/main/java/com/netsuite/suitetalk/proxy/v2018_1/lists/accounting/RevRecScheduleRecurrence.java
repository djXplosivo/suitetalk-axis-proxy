...
public class RevRecScheduleRecurrence implements Serializable {
   private RecordRef incomeaccount;
   private Long periodOffset;
   private String recamount;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(RevRecScheduleRecurrence.class, true);

   public RevRecScheduleRecurrence() {
      super();
   }

   public RevRecScheduleRecurrence(RecordRef incomeaccount, Long periodOffset, String recamount) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof RevRecScheduleRecurrence)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecScheduleRecurrence"));
