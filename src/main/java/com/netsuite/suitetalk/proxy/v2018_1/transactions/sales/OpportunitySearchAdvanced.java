...
public class OpportunitySearchAdvanced extends SearchRecord implements Serializable {
   private OpportunitySearch criteria;
   private OpportunitySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(OpportunitySearchAdvanced.class, true);

   public OpportunitySearchAdvanced() {
      super();
   }

   public OpportunitySearchAdvanced(String savedSearchId, String savedSearchScriptId, OpportunitySearch criteria, OpportunitySearchRow columns) {
      super();
   ...
   public void setCriteria(OpportunitySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(OpportunitySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof OpportunitySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "OpportunitySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "OpportunitySearch"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "OpportunitySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
