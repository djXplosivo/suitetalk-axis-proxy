...
public class PartnerCategorySearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(PartnerCategorySearchBasic.class, true);

   public PartnerCategorySearchBasic() {
      super();
   }

   public PartnerCategorySearchBasic(SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField name, SearchMultiSelectField parent) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PartnerCategorySearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PartnerCategorySearchBasic"));
