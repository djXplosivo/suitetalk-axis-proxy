...
public class DepartmentSearchAdvanced extends SearchRecord implements Serializable {
   private DepartmentSearch criteria;
   private DepartmentSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(DepartmentSearchAdvanced.class, true);

   public DepartmentSearchAdvanced() {
      super();
   }

   public DepartmentSearchAdvanced(String savedSearchId, String savedSearchScriptId, DepartmentSearch criteria, DepartmentSearchRow columns) {
      super();
   ...
   public void setCriteria(DepartmentSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(DepartmentSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof DepartmentSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "DepartmentSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "DepartmentSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "DepartmentSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
