...
public class PricingGroupSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(PricingGroupSearchBasic.class, true);

   public PricingGroupSearchBasic() {
      super();
   }

   public PricingGroupSearchBasic(SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PricingGroupSearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PricingGroupSearchBasic"));
