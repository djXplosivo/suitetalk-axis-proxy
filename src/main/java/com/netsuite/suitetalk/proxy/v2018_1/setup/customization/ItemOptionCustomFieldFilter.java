...
public class ItemOptionCustomFieldFilter implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(ItemOptionCustomFieldFilter.class, true);

   public ItemOptionCustomFieldFilter() {
      super();
   }

   public ItemOptionCustomFieldFilter(RecordRef fldFilter, Boolean fldFilterChecked, CustomizationFilterCompareType fldFilterCompareType, String fldFilterVal, FldFilterSelList fldFilterSelList, Boolean fldFilterNotNull) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemOptionCustomFieldFilter)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "ItemOptionCustomFieldFilter"));
