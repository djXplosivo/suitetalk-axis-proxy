...
public class CustomerStatusSearchAdvanced extends SearchRecord implements Serializable {
   private CustomerStatusSearch criteria;
   private CustomerStatusSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerStatusSearchAdvanced.class, true);

   public CustomerStatusSearchAdvanced() {
      super();
   }

   public CustomerStatusSearchAdvanced(String savedSearchId, String savedSearchScriptId, CustomerStatusSearch criteria, CustomerStatusSearchRow columns) {
      super();
   ...
   public void setCriteria(CustomerStatusSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(CustomerStatusSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerStatusSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerStatusSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerStatusSearch"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerStatusSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
