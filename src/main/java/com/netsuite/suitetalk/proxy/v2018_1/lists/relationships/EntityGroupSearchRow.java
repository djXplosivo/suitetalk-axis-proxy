...
public class EntityGroupSearchRow extends SearchRow implements Serializable {
   private EntityGroupSearchRowBasic basic;
   private EntitySearchRowBasic groupMemberJoin;
   private EmployeeSearchRowBasic userJoin;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(EntityGroupSearchRow.class, true);

   public EntityGroupSearchRow() {
      super();
   }

   public EntityGroupSearchRow(EntityGroupSearchRowBasic basic, EntitySearchRowBasic groupMemberJoin, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(EntityGroupSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public void setGroupMemberJoin(EntitySearchRowBasic groupMemberJoin) {
      this.groupMemberJoin = groupMemberJoin;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof EntityGroupSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "EntityGroupSearchRow"));
