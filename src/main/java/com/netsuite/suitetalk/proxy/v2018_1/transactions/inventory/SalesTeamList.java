...
public class SalesTeamList implements Serializable {
   private CustomerSalesTeam[] salesTeam;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SalesTeamList.class, true);

   public SalesTeamList() {
      super();
   }

   public SalesTeamList(CustomerSalesTeam[] salesTeam, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesTeamList)) {
         return false;
      } else {
         SalesTeamList other = (SalesTeamList)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:inventory_2018_1.transactions.webservices.netsuite.com", "SalesTeamList"));
      ...
      elemField.setXmlName(new QName("urn:inventory_2018_1.transactions.webservices.netsuite.com", "salesTeam"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomerSalesTeam"));
