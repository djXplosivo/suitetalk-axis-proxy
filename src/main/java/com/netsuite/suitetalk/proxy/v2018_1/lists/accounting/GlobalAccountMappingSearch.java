...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.GlobalAccountMappingSearchBasic;
...
public class GlobalAccountMappingSearch extends SearchRecord implements Serializable {
   private GlobalAccountMappingSearchBasic basic;
   ...
   private static TypeDesc typeDesc = new TypeDesc(GlobalAccountMappingSearch.class, true);

   public GlobalAccountMappingSearch() {
      super();
   }

   public GlobalAccountMappingSearch(GlobalAccountMappingSearchBasic basic, ClassificationSearchBasic classJoin, DepartmentSearchBasic departmentJoin, AccountSearchBasic destinationAccountJoin, LocationSearchBasic locationJoin, AccountSearchBasic sourceAccountJoin, SubsidiarySearchBasic subsidiaryJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(GlobalAccountMappingSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GlobalAccountMappingSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GlobalAccountMappingSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "GlobalAccountMappingSearchBasic"));
