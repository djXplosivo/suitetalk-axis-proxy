...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.CustomerStatusSearchRowBasic;
...
public class CustomerStatusSearchRow extends SearchRow implements Serializable {
   private CustomerStatusSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerStatusSearchRow.class, true);

   public CustomerStatusSearchRow() {
      super();
   }

   public CustomerStatusSearchRow(CustomerStatusSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(CustomerStatusSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerStatusSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerStatusSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomerStatusSearchRowBasic"));
