...
public class WorkOrderIssueComponent implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(WorkOrderIssueComponent.class, true);

   public WorkOrderIssueComponent() {
      super();
   }

   public WorkOrderIssueComponent(RecordRef item, Long operationSequenceNumber, Double quantity, InventoryDetail componentInventoryDetail, Long lineNumber) {
      super();
      this.item = item;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof WorkOrderIssueComponent)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = (this.item == null && other.getItem() == null || this.item != null && this.item.equals(other.getItem())) && (this.operationSequenceNumber == null && other.getOperationSequenceNumber() == null || this.operationSequenceNumber != null && this.operationSequenceNumber.equals(other.getOperationSequenceNumber())) && (this.quantity == null && other.getQuantity() == null || this.quantity != null && this.quantity.equals(other.getQuantity())) && (this.componentInventoryDetail == null && other.getComponentInventoryDetail() == null || this.componentInventoryDetail != null && this.componentInventoryDetail.equals(other.getComponentInventoryDetail())) && (this.lineNumber == null && other.getLineNumber() == null || this.lineNumber != null && this.lineNumber.equals(other.getLineNumber()));
   ...
   static {
      typeDesc.setXmlType(new QName("urn:inventory_2018_1.transactions.webservices.netsuite.com", "WorkOrderIssueComponent"));
