...
public class SupportCaseSearch extends SearchRecord implements Serializable {
   private SupportCaseSearchBasic basic;
   private EntitySearchBasic companyJoin;
   ...
   private static TypeDesc typeDesc = new TypeDesc(SupportCaseSearch.class, true);

   public SupportCaseSearch() {
      super();
   }

   public SupportCaseSearch(SupportCaseSearchBasic basic, EntitySearchBasic companyJoin, ContactSearchBasic contactJoin, CustomerSearchBasic customerJoin, EmployeeSearchBasic employeeJoin, FileSearchBasic fileJoin, IssueSearchBasic issueJoin, ItemSearchBasic itemJoin, MessageSearchBasic messagesJoin, TimeBillSearchBasic timeJoin, TransactionSearchBasic transactionJoin, EmployeeSearchBasic userJoin, NoteSearchBasic userNotesJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(SupportCaseSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public void setCompanyJoin(EntitySearchBasic companyJoin) {
      this.companyJoin = companyJoin;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SupportCaseSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "SupportCaseSearch"));
