...
public class Department extends Record implements Serializable {
   private String name;
   ...
   private static TypeDesc typeDesc = new TypeDesc(Department.class, true);

   public Department() {
      super();
   }

   public Department(NullField nullFieldList, String internalId, String externalId, String name, Boolean includeChildren, RecordRef parent, Boolean isInactive, ClassTranslationList classTranslationList, RecordRefList subsidiaryList, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "Department"));
