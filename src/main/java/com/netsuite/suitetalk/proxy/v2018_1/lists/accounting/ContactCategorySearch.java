...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.ContactCategorySearchBasic;
...
public class ContactCategorySearch extends SearchRecord implements Serializable {
   private ContactCategorySearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ContactCategorySearch.class, true);

   public ContactCategorySearch() {
      super();
   }

   public ContactCategorySearch(ContactCategorySearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(ContactCategorySearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ContactCategorySearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ContactCategorySearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ContactCategorySearchBasic"));
