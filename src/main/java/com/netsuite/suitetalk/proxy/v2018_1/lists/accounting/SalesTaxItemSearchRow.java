...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.TaxTypeSearchRowBasic;
...
public class SalesTaxItemSearchRow extends SearchRow implements Serializable {
   private SalesTaxItemSearchRowBasic basic;
   private TaxTypeSearchRowBasic taxTypeJoin;
   private EmployeeSearchRowBasic userJoin;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SalesTaxItemSearchRow.class, true);

   public SalesTaxItemSearchRow() {
      super();
   }

   public SalesTaxItemSearchRow(SalesTaxItemSearchRowBasic basic, TaxTypeSearchRowBasic taxTypeJoin, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(SalesTaxItemSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public void setTaxTypeJoin(TaxTypeSearchRowBasic taxTypeJoin) {
      this.taxTypeJoin = taxTypeJoin;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesTaxItemSearchRow)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.basic == null && other.getBasic() == null || this.basic != null && this.basic.equals(other.getBasic())) && (this.taxTypeJoin == null && other.getTaxTypeJoin() == null || this.taxTypeJoin != null && this.taxTypeJoin.equals(other.getTaxTypeJoin())) && (this.userJoin == null && other.getUserJoin() == null || this.userJoin != null && this.userJoin.equals(other.getUserJoin())) && (this.customSearchJoin == null && other.getCustomSearchJoin() == null || this.customSearchJoin != null && Arrays.equals(this.customSearchJoin, other.getCustomSearchJoin()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getTaxTypeJoin() != null) {
            _hashCode += this.getTaxTypeJoin().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SalesTaxItemSearchRow"));
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "taxTypeJoin"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "TaxTypeSearchRowBasic"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
