...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.TaxGroupSearchRowBasic;
...
public class TaxGroupSearchRow extends SearchRow implements Serializable {
   private TaxGroupSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TaxGroupSearchRow.class, true);

   public TaxGroupSearchRow() {
      super();
   }

   public TaxGroupSearchRow(TaxGroupSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(TaxGroupSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TaxGroupSearchRow)) {
         return false;
      } else {
         TaxGroupSearchRow other = (TaxGroupSearchRow)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxGroupSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "TaxGroupSearchRowBasic"));
