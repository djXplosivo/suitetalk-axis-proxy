...
public class PriceLevelSearchRowBasic extends SearchRowBasic implements Serializable {
   private SearchColumnDoubleField[] discountPct;
   ...
   private static TypeDesc typeDesc = new TypeDesc(PriceLevelSearchRowBasic.class, true);

   public PriceLevelSearchRowBasic() {
      super();
   }

   public PriceLevelSearchRowBasic(SearchColumnDoubleField[] discountPct, SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnBooleanField[] isOnline, SearchColumnStringField[] name) {
      super();
   ...
   public SearchColumnDoubleField[] getDiscountPct() {
      return this.discountPct;
   }

   public void setDiscountPct(SearchColumnDoubleField[] discountPct) {
      this.discountPct = discountPct;
   }

   public SearchColumnDoubleField getDiscountPct(int i) {
      return this.discountPct[i];
   }

   public void setDiscountPct(int i, SearchColumnDoubleField _value) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PriceLevelSearchRowBasic)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.discountPct == null && other.getDiscountPct() == null || this.discountPct != null && Arrays.equals(this.discountPct, other.getDiscountPct())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && Arrays.equals(this.externalId, other.getExternalId())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && Arrays.equals(this.internalId, other.getInternalId())) && (this.isInactive == null && other.getIsInactive() == null || this.isInactive != null && Arrays.equals(this.isInactive, other.getIsInactive())) && (this.isOnline == null && other.getIsOnline() == null || this.isOnline != null && Arrays.equals(this.isOnline, other.getIsOnline())) && (this.name == null && other.getName() == null || this.name != null && Arrays.equals(this.name, other.getName()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         int i;
         Object obj;
         if (this.getDiscountPct() != null) {
            for(i = 0; i < Array.getLength(this.getDiscountPct()); ++i) {
               obj = Array.get(this.getDiscountPct(), i);
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PriceLevelSearchRowBasic"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("discountPct");
      elemField.setXmlName(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "discountPct"));
