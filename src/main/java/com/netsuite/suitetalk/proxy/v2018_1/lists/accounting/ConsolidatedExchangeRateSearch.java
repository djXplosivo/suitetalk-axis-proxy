...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.ConsolidatedExchangeRateSearchBasic;
...
public class ConsolidatedExchangeRateSearch extends SearchRecord implements Serializable {
   private ConsolidatedExchangeRateSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ConsolidatedExchangeRateSearch.class, true);

   public ConsolidatedExchangeRateSearch() {
      super();
   }

   public ConsolidatedExchangeRateSearch(ConsolidatedExchangeRateSearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(ConsolidatedExchangeRateSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ConsolidatedExchangeRateSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ConsolidatedExchangeRateSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ConsolidatedExchangeRateSearchBasic"));
