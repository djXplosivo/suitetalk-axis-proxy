...
public class PaymentMethodSearchAdvanced extends SearchRecord implements Serializable {
   private PaymentMethodSearch criteria;
   private PaymentMethodSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PaymentMethodSearchAdvanced.class, true);

   public PaymentMethodSearchAdvanced() {
      super();
   }

   public PaymentMethodSearchAdvanced(String savedSearchId, String savedSearchScriptId, PaymentMethodSearch criteria, PaymentMethodSearchRow columns) {
      super();
   ...
   public void setCriteria(PaymentMethodSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(PaymentMethodSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PaymentMethodSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PaymentMethodSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PaymentMethodSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PaymentMethodSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
