...
public class LotNumberedAssemblyItemBillOfMaterials implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(LotNumberedAssemblyItemBillOfMaterials.class, true);

   public LotNumberedAssemblyItemBillOfMaterials() {
      super();
   }

   public LotNumberedAssemblyItemBillOfMaterials(RecordRef billOfMaterials, String currentRevision, Boolean masterDefault, RecordRefList defaultForLocationList, String inactive, String memo) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof LotNumberedAssemblyItemBillOfMaterials)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "LotNumberedAssemblyItemBillOfMaterials"));
