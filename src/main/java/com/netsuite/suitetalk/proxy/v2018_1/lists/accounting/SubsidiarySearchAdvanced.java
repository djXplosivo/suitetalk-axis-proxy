...
public class SubsidiarySearchAdvanced extends SearchRecord implements Serializable {
   private SubsidiarySearch criteria;
   private SubsidiarySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SubsidiarySearchAdvanced.class, true);

   public SubsidiarySearchAdvanced() {
      super();
   }

   public SubsidiarySearchAdvanced(String savedSearchId, String savedSearchScriptId, SubsidiarySearch criteria, SubsidiarySearchRow columns) {
      super();
   ...
   public void setCriteria(SubsidiarySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(SubsidiarySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SubsidiarySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SubsidiarySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SubsidiarySearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SubsidiarySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
