...
public class PaycheckJournalCompanyContribution implements Serializable {
   private Long id;
   ...
   private static TypeDesc typeDesc = new TypeDesc(PaycheckJournalCompanyContribution.class, true);

   public PaycheckJournalCompanyContribution() {
      super();
   }

   public PaycheckJournalCompanyContribution(Long id, RecordRef payrollItem, Double amount, RecordRef department, RecordRef _class, RecordRef location, CustomFieldList customFieldList) {
      super();
      this.id = id;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PaycheckJournalCompanyContribution)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "PaycheckJournalCompanyContribution"));
