...
public class AdvInterCompanyJournalEntryAccountingBookDetail implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(AdvInterCompanyJournalEntryAccountingBookDetail.class, true);

   public AdvInterCompanyJournalEntryAccountingBookDetail() {
      super();
   }

   public AdvInterCompanyJournalEntryAccountingBookDetail(RecordRef accountingBook, RecordRef currency, RecordRef subsidiary, Double exchangeRate) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AdvInterCompanyJournalEntryAccountingBookDetail)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "AdvInterCompanyJournalEntryAccountingBookDetail"));
