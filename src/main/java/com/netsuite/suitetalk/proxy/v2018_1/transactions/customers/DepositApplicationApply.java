...
public class DepositApplicationApply implements Serializable {
   private Long doc;
   private Long line;
   ...
   private static TypeDesc typeDesc = new TypeDesc(DepositApplicationApply.class, true);

   public DepositApplicationApply() {
      super();
   }

   public DepositApplicationApply(Long doc, Long line, Boolean apply, Calendar applyDate, String job, String type, String refNum, Double total, Double due, String currency, Double amount) {
      super();
      this.doc = doc;
      this.line = line;
      this.apply = apply;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof DepositApplicationApply)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "DepositApplicationApply"));
