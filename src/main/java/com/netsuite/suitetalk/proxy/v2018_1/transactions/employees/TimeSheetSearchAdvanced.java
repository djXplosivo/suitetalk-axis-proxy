...
public class TimeSheetSearchAdvanced extends SearchRecord implements Serializable {
   private TimeSheetSearch criteria;
   private TimeSheetSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TimeSheetSearchAdvanced.class, true);

   public TimeSheetSearchAdvanced() {
      super();
   }

   public TimeSheetSearchAdvanced(String savedSearchId, String savedSearchScriptId, TimeSheetSearch criteria, TimeSheetSearchRow columns) {
      super();
   ...
   public void setCriteria(TimeSheetSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TimeSheetSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TimeSheetSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeSheetSearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeSheetSearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeSheetSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
