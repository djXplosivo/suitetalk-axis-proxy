...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.UnitsTypeSearchRowBasic;
...
public class UnitsTypeSearchRow extends SearchRow implements Serializable {
   private UnitsTypeSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(UnitsTypeSearchRow.class, true);

   public UnitsTypeSearchRow() {
      super();
   }

   public UnitsTypeSearchRow(UnitsTypeSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(UnitsTypeSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof UnitsTypeSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "UnitsTypeSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "UnitsTypeSearchRowBasic"));
