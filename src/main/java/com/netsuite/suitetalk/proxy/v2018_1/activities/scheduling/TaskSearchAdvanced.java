...
public class TaskSearchAdvanced extends SearchRecord implements Serializable {
   private TaskSearch criteria;
   private TaskSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TaskSearchAdvanced.class, true);

   public TaskSearchAdvanced() {
      super();
   }

   public TaskSearchAdvanced(String savedSearchId, String savedSearchScriptId, TaskSearch criteria, TaskSearchRow columns) {
      super();
   ...
   public void setCriteria(TaskSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TaskSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TaskSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "TaskSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "TaskSearch"));
      ...
      elemField.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "TaskSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
