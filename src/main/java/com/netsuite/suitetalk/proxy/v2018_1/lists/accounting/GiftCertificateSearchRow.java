...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.GiftCertificateSearchRowBasic;
...
public class GiftCertificateSearchRow extends SearchRow implements Serializable {
   private GiftCertificateSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GiftCertificateSearchRow.class, true);

   public GiftCertificateSearchRow() {
      super();
   }

   public GiftCertificateSearchRow(GiftCertificateSearchRowBasic basic, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(GiftCertificateSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GiftCertificateSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GiftCertificateSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "GiftCertificateSearchRowBasic"));
