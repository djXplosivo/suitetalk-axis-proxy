...
public class VendorCreditExpense implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(VendorCreditExpense.class, true);

   public VendorCreditExpense() {
      super();
   }

   public VendorCreditExpense(Long orderLine, Long line, RecordRef category, RecordRef account, Double amount, Double taxAmount, RecordRef taxCode, Double taxRate1, Double taxRate2, Double tax1Amt, Double grossAmt, String taxDetailsReference, String memo, RecordRef department, RecordRef _class, RecordRef location, RecordRef customer, Boolean isBillable, RecordRef amortizationSched, Calendar amortizStartDate, Calendar amortizationEndDate, String amortizationResidual, CustomFieldList customFieldList) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof VendorCreditExpense)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:purchases_2018_1.transactions.webservices.netsuite.com", "VendorCreditExpense"));
