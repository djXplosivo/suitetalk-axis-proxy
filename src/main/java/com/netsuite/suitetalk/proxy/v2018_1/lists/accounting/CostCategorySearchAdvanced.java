...
public class CostCategorySearchAdvanced extends SearchRecord implements Serializable {
   private CostCategorySearch criteria;
   private CostCategorySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CostCategorySearchAdvanced.class, true);

   public CostCategorySearchAdvanced() {
      super();
   }

   public CostCategorySearchAdvanced(String savedSearchId, String savedSearchScriptId, CostCategorySearch criteria, CostCategorySearchRow columns) {
      super();
   ...
   public void setCriteria(CostCategorySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(CostCategorySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CostCategorySearchAdvanced)) {
         return false;
      } else {
         CostCategorySearchAdvanced other = (CostCategorySearchAdvanced)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CostCategorySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CostCategorySearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CostCategorySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
