...
public class CustomerPaymentCredit implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomerPaymentCredit.class, true);

   public CustomerPaymentCredit() {
      super();
   }

   public CustomerPaymentCredit(Boolean apply, Long doc, Long line, Calendar creditDate, String type, String refNum, String appliedTo, Double total, Double due, String currency, Double amount) {
      super();
      this.apply = apply;
      this.doc = doc;
      this.line = line;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerPaymentCredit)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CustomerPaymentCredit"));
      ...
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "creditDate"));
      ...
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "appliedTo"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
