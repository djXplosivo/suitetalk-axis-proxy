...
public class OriginatingLeadSearchRow extends SearchRow implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "OriginatingLeadSearchRow"));
