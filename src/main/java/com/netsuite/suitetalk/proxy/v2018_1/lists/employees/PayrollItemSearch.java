...
public class PayrollItemSearch extends SearchRecord implements Serializable {
   private PayrollItemSearchBasic basic;
   private CustomSearchJoin[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PayrollItemSearch.class, true);

   public PayrollItemSearch() {
      super();
   }

   public PayrollItemSearch(PayrollItemSearchBasic basic, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PayrollItemSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PayrollItemSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "PayrollItemSearch"));
