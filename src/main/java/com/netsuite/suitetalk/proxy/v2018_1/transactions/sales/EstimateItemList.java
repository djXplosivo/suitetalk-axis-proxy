...
public class EstimateItemList implements Serializable {
   private EstimateItem[] item;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(EstimateItemList.class, true);

   public EstimateItemList() {
      super();
   }

   public EstimateItemList(EstimateItem[] item, boolean replaceAll) {
      super();
      this.item = item;
   ...
   public void setItem(int i, EstimateItem _value) {
      this.item[i] = _value;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof EstimateItemList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "EstimateItemList"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "EstimateItem"));
