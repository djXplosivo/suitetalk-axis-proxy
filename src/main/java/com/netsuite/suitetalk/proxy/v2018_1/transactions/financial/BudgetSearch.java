...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.BudgetSearchBasic;
...
public class BudgetSearch extends SearchRecord implements Serializable {
   private BudgetSearchBasic basic;
   private CustomSearchJoin[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(BudgetSearch.class, true);

   public BudgetSearch() {
      super();
   }

   public BudgetSearch(BudgetSearchBasic basic, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(BudgetSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof BudgetSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "BudgetSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "BudgetSearchBasic"));
