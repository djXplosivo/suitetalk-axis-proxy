...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.TaxTypeSearchBasic;
...
public class SalesTaxItemSearch extends SearchRecord implements Serializable {
   private SalesTaxItemSearchBasic basic;
   private TaxTypeSearchBasic taxTypeJoin;
   private EmployeeSearchBasic userJoin;
   private CustomSearchJoin[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SalesTaxItemSearch.class, true);

   public SalesTaxItemSearch() {
      super();
   }

   public SalesTaxItemSearch(SalesTaxItemSearchBasic basic, TaxTypeSearchBasic taxTypeJoin, EmployeeSearchBasic userJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(SalesTaxItemSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public void setTaxTypeJoin(TaxTypeSearchBasic taxTypeJoin) {
      this.taxTypeJoin = taxTypeJoin;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesTaxItemSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SalesTaxItemSearch"));
      ...
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "TaxTypeSearchBasic"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
