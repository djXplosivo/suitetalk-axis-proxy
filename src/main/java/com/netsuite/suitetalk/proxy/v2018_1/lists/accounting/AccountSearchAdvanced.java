...
public class AccountSearchAdvanced extends SearchRecord implements Serializable {
   private AccountSearch criteria;
   private AccountSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(AccountSearchAdvanced.class, true);

   public AccountSearchAdvanced() {
      super();
   }

   public AccountSearchAdvanced(String savedSearchId, String savedSearchScriptId, AccountSearch criteria, AccountSearchRow columns) {
      super();
   ...
   public void setCriteria(AccountSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(AccountSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AccountSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AccountSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AccountSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AccountSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
