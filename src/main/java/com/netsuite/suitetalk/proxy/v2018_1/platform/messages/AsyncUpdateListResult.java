...
public class AsyncUpdateListResult extends AsyncResult implements Serializable {
   private WriteResponseList writeResponseList;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(AsyncUpdateListResult.class, true);

   public AsyncUpdateListResult() {
      super();
   }

   public AsyncUpdateListResult(WriteResponseList writeResponseList) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AsyncUpdateListResult)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:messages_2018_1.platform.webservices.netsuite.com", "AsyncUpdateListResult"));
