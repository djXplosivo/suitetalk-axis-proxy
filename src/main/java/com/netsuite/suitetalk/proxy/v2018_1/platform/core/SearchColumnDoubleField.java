...
public class SearchColumnDoubleField extends SearchColumnField implements Serializable {
   private Double searchValue;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SearchColumnDoubleField.class, true);

   public SearchColumnDoubleField() {
      super();
   }

   public SearchColumnDoubleField(String customLabel, Double searchValue) {
      super(customLabel);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SearchColumnDoubleField)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "SearchColumnDoubleField"));
