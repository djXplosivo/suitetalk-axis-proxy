...
public class TaxGroupSearchAdvanced extends SearchRecord implements Serializable {
   private TaxGroupSearch criteria;
   private TaxGroupSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TaxGroupSearchAdvanced.class, true);

   public TaxGroupSearchAdvanced() {
      super();
   }

   public TaxGroupSearchAdvanced(String savedSearchId, String savedSearchScriptId, TaxGroupSearch criteria, TaxGroupSearchRow columns) {
      super();
   ...
   public void setCriteria(TaxGroupSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TaxGroupSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TaxGroupSearchAdvanced)) {
         return false;
      } else {
         TaxGroupSearchAdvanced other = (TaxGroupSearchAdvanced)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxGroupSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxGroupSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxGroupSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
