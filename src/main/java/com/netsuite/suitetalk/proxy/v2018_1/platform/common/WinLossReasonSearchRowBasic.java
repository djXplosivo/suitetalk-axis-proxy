...
public class WinLossReasonSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(WinLossReasonSearchRowBasic.class, true);

   public WinLossReasonSearchRowBasic() {
      super();
   }

   public WinLossReasonSearchRowBasic(SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof WinLossReasonSearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "WinLossReasonSearchRowBasic"));
