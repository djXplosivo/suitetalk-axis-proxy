...
public class UnitsTypeSearchAdvanced extends SearchRecord implements Serializable {
   private UnitsTypeSearch criteria;
   private UnitsTypeSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(UnitsTypeSearchAdvanced.class, true);

   public UnitsTypeSearchAdvanced() {
      super();
   }

   public UnitsTypeSearchAdvanced(String savedSearchId, String savedSearchScriptId, UnitsTypeSearch criteria, UnitsTypeSearchRow columns) {
      super();
   ...
   public void setCriteria(UnitsTypeSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(UnitsTypeSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof UnitsTypeSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "UnitsTypeSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "UnitsTypeSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "UnitsTypeSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
