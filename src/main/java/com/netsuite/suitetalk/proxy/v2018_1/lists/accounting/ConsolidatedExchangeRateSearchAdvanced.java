...
public class ConsolidatedExchangeRateSearchAdvanced extends SearchRecord implements Serializable {
   private ConsolidatedExchangeRateSearch criteria;
   private ConsolidatedExchangeRateSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ConsolidatedExchangeRateSearchAdvanced.class, true);

   public ConsolidatedExchangeRateSearchAdvanced() {
      super();
   }

   public ConsolidatedExchangeRateSearchAdvanced(String savedSearchId, String savedSearchScriptId, ConsolidatedExchangeRateSearch criteria, ConsolidatedExchangeRateSearchRow columns) {
      super();
   ...
   public void setCriteria(ConsolidatedExchangeRateSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ConsolidatedExchangeRateSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ConsolidatedExchangeRateSearchAdvanced)) {
         return false;
      } else {
         ConsolidatedExchangeRateSearchAdvanced other = (ConsolidatedExchangeRateSearchAdvanced)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ConsolidatedExchangeRateSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ConsolidatedExchangeRateSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ConsolidatedExchangeRateSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
