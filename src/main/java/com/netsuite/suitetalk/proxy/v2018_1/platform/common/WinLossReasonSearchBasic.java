...
public class WinLossReasonSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(WinLossReasonSearchBasic.class, true);

   public WinLossReasonSearchBasic() {
      super();
   }

   public WinLossReasonSearchBasic(SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof WinLossReasonSearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "WinLossReasonSearchBasic"));
