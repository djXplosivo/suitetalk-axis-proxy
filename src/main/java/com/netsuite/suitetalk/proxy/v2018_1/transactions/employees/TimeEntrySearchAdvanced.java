...
public class TimeEntrySearchAdvanced extends SearchRecord implements Serializable {
   private TimeEntrySearch criteria;
   private TimeEntrySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TimeEntrySearchAdvanced.class, true);

   public TimeEntrySearchAdvanced() {
      super();
   }

   public TimeEntrySearchAdvanced(String savedSearchId, String savedSearchScriptId, TimeEntrySearch criteria, TimeEntrySearchRow columns) {
      super();
   ...
   public void setCriteria(TimeEntrySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(TimeEntrySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TimeEntrySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeEntrySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeEntrySearch"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeEntrySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
