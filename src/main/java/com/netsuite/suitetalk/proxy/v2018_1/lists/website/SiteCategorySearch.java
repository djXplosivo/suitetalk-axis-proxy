...
public class SiteCategorySearch extends SearchRecord implements Serializable {
   private SiteCategorySearchBasic basic;
   private CustomerSearchBasic shopperJoin;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SiteCategorySearch.class, true);

   public SiteCategorySearch() {
      super();
   }

   public SiteCategorySearch(SiteCategorySearchBasic basic, CustomerSearchBasic shopperJoin, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(SiteCategorySearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SiteCategorySearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:website_2018_1.lists.webservices.netsuite.com", "SiteCategorySearch"));
