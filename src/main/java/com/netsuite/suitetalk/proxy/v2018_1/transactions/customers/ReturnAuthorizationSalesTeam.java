...
public class ReturnAuthorizationSalesTeam implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(ReturnAuthorizationSalesTeam.class, true);

   public ReturnAuthorizationSalesTeam() {
      super();
   }

   public ReturnAuthorizationSalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ReturnAuthorizationSalesTeam)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "ReturnAuthorizationSalesTeam"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("employee");
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "employee"));
      ...
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "salesRole"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "isPrimary"));
      ...
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "contribution"));
