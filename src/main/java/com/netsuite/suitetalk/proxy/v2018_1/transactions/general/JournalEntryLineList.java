...
public class JournalEntryLineList implements Serializable {
   private JournalEntryLine[] line;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(JournalEntryLineList.class, true);

   public JournalEntryLineList() {
      super();
   }

   public JournalEntryLineList(JournalEntryLine[] line, boolean replaceAll) {
      super();
      this.line = line;
   ...
   public JournalEntryLine getLine(int i) {
      return this.line[i];
   }

   public void setLine(int i, JournalEntryLine _value) {
      this.line[i] = _value;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof JournalEntryLineList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "JournalEntryLineList"));
      ...
      elemField.setXmlType(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "JournalEntryLine"));
