...
public class BinSearchAdvanced extends SearchRecord implements Serializable {
   private BinSearch criteria;
   private BinSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(BinSearchAdvanced.class, true);

   public BinSearchAdvanced() {
      super();
   }

   public BinSearchAdvanced(String savedSearchId, String savedSearchScriptId, BinSearch criteria, BinSearchRow columns) {
      super();
   ...
   public void setCriteria(BinSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(BinSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof BinSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "BinSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "BinSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "BinSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
