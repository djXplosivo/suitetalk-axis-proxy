...
public class ItemAccountMappingSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private SearchColumnEnumSelectField[] itemAccount;
   ...
   private static TypeDesc typeDesc = new TypeDesc(ItemAccountMappingSearchRowBasic.class, true);

   public ItemAccountMappingSearchRowBasic() {
      super();
   }

   public ItemAccountMappingSearchRowBasic(SearchColumnSelectField[] accountingBook, SearchColumnSelectField[] _class, SearchColumnSelectCustomField[] customDimension, SearchColumnSelectField[] department, SearchColumnSelectField[] destinationAccount, SearchColumnDateField[] effectiveDate, SearchColumnDateField[] endDate, SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnEnumSelectField[] itemAccount, SearchColumnSelectField[] location, SearchColumnSelectField[] sourceAccount, SearchColumnSelectField[] subsidiary, SearchColumnCustomFieldList customFieldList) {
      super();
   ...
   public SearchColumnEnumSelectField[] getItemAccount() {
      return this.itemAccount;
   }

   public void setItemAccount(SearchColumnEnumSelectField[] itemAccount) {
      this.itemAccount = itemAccount;
   }

   public SearchColumnEnumSelectField getItemAccount(int i) {
      return this.itemAccount[i];
   }

   public void setItemAccount(int i, SearchColumnEnumSelectField _value) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemAccountMappingSearchRowBasic)) {
         return false;
      } else {
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getItemAccount() != null) {
            for(i = 0; i < Array.getLength(this.getItemAccount()); ++i) {
               obj = Array.get(this.getItemAccount(), i);
               if (obj != null && !obj.getClass().isArray()) {
                  _hashCode += obj.hashCode();
               }
            }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ItemAccountMappingSearchRowBasic"));
      ...
      elemField.setXmlName(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "itemAccount"));
