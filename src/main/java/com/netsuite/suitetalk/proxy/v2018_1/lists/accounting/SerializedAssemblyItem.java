...
import com.netsuite.suitetalk.proxy.v2018_1.lists.accounting.types.AssemblyItemEffectiveBomControl;
...
public class SerializedAssemblyItem extends Record implements Serializable {
   ...
   private RecordRef prodQtyVarianceAcct;
   private RecordRef prodPriceVarianceAcct;
   private RecordRef purchasePriceVarianceAcct;
   private RecordRef wipVarianceAcct;
   private RecordRef taxSchedule;
   private RecordRef scrapAcct;
   private Double shippingCost;
   private RecordRef wipAcct;
   ...
   private AssemblyItemEffectiveBomControl effectiveBomControl;
   ...
   private RecordRef scheduleBCode;
   ...
   private Boolean isSpecialWorkOrderItem;
   private Boolean pricesIncludeTax;
   private RecordRef quantityPricingSchedule;
   private Boolean buildEntireAssembly;
   ...
   private RecordRef unbuildVarianceAccount;
   ...
   private SerializedAssemblyItemBillOfMaterialsList billOfMaterialsList;
   ...
   private static TypeDesc typeDesc = new TypeDesc(SerializedAssemblyItem.class, true);

   public SerializedAssemblyItem() {
      super();
   }

   public SerializedAssemblyItem(NullField nullFieldList, String internalId, String externalId, Calendar createdDate, Calendar lastModifiedDate, RecordRef customForm, String itemId, String upcCode, String displayName, String vendorName, RecordRef parent, Boolean printItems, Boolean isOnline, Calendar lastInvtCountDate, Calendar nextInvtCountDate, Long invtCountInterval, ItemInvtClassification invtClassification, Boolean isGcoCompliant, Boolean offerSupport, Boolean useComponentYield, Boolean isInactive, RecordRefList subsidiaryList, Boolean availableToPartners, Boolean includeChildren, RecordRef department, RecordRef _class, RecordRef location, String description, RecordRef cogsAccount, RecordRef vendor, RecordRef incomeAccount, RecordRef intercoIncomeAccount, RecordRef assetAccount, Boolean matchBillToReceipt, RecordRef billQtyVarianceAcct, RecordRef billPriceVarianceAcct, RecordRef billExchRateVarianceAcct, RecordRef gainLossAccount, RecordRef salesTaxCode, RecordRef costCategory, RecordRef purchaseTaxCode, RecordRef prodQtyVarianceAcct, RecordRef prodPriceVarianceAcct, RecordRef purchasePriceVarianceAcct, RecordRef wipVarianceAcct, RecordRef taxSchedule, RecordRef scrapAcct, Double shippingCost, RecordRef wipAcct, String shippingCostUnits, Double handlingCost, Double weight, String handlingCostUnits, ItemWeightUnit weightUnit, String weightUnits, ItemCostingMethod costingMethod, Boolean isTaxable, String costingMethodDisplay, Double rate, RecordRef unitsType, RecordRef stockUnit, RecordRef purchaseUnit, RecordRef saleUnit, Boolean trackLandedCost, String matrixItemNameTemplate, RecordRef billingSchedule, RecordRef deferredRevenueAccount, RecordRef revRecSchedule, String stockDescription, Boolean producer, String manufacturer, String mpn, Boolean multManufactureAddr, String manufactureraddr1, String manufacturerCity, String manufacturerState, String manufacturerZip, Country countryOfManufacture, AssemblyItemEffectiveBomControl effectiveBomControl, String minimumQuantityUnits, String defaultRevision, RecordRef defaultItemShipMethod, ShippingCarrier itemCarrier, Boolean roundUpAsComponent, Double purchaseOrderQuantity, Double purchaseOrderAmount, Double purchaseOrderQuantityDiff, Double receiptQuantity, Double receiptAmount, Double receiptQuantityDiff, Boolean isDropShipItem, Boolean isPhantom, RecordRefList itemShipMethodList, String manufacturerTaxId, String scheduleBNumber, Long scheduleBQuantity, RecordRef scheduleBCode, String manufacturerTariff, ItemPreferenceCriterion preferenceCriterion, RecordRef issueProduct, Long minimumQuantity, Boolean enforceMinQtyInternally, RecordRef softDescriptor, Boolean isSpecialWorkOrderItem, Boolean pricesIncludeTax, RecordRef quantityPricingSchedule, Boolean buildEntireAssembly, Double quantityOnHand, String quantityOnHandUnits, Boolean useMarginalRates, Long reorderMultiple, Double cost, ItemCostEstimateType costEstimateType, Boolean isHazmatItem, String hazmatId, String hazmatShippingName, String hazmatHazardClass, HazmatPackingGroup hazmatPackingGroup, String hazmatItemUnits, Double hazmatItemUnitsQty, Double costEstimate, Double transferPrice, ItemOverallQuantityPricingType overallQuantityPricingType, RecordRef pricingGroup, RecordRef intercoCogsAccount, Double vsoePrice, VsoeSopGroup vsoeSopGroup, VsoeDeferral vsoeDeferral, VsoePermitDiscount vsoePermitDiscount, Boolean vsoeDelivered, RecordRef itemRevenueCategory, RecordRef unbuildVarianceAccount, RecordRef revenueRecognitionRule, RecordRef revRecForecastRule, RecordRef revenueAllocationGroup, RecordRef createRevenuePlansOn, Boolean directRevenuePosting, RecordRef dropshipExpenseAccount, RecordRef preferredLocation, Boolean isStorePickupAllowed, Double totalValue, Boolean useBins, Double averageCost, Double lastPurchasePrice, String purchaseDescription, Long leadTime, Boolean autoLeadTime, Long buildTime, Double safetyStockLevel, String safetyStockLevelUnits, Long safetyStockLevelDays, Boolean seasonalDemand, String serialNumbers, Double reorderPoint, String reorderPointUnits, Double preferredStockLevel, String preferredStockLevelUnits, Double demandModifier, Boolean autoReorderPoint, Boolean autoPreferredStockLevel, Double preferredStockLevelDays, Double defaultReturnCost, RecordRef supplyReplenishmentMethod, RecordRef alternateDemandSourceItem, Double fixedLotSize, RecordRef supplyType, Long demandTimeFence, Long supplyTimeFence, Long rescheduleInDays, Long rescheduleOutDays, RecordRef supplyLotSizingMethod, RecordRef demandSource, Boolean shipIndividually, Double quantityCommitted, Double quantityAvailable, Double quantityBackOrdered, Double quantityOnOrder, RecordRef shipPackage, String storeDisplayName, RecordRef storeDisplayThumbnail, RecordRef storeDisplayImage, String storeDescription, String storeDetailedDescription, RecordRef storeItemTemplate, String pageTitle, String metaTagHtml, Boolean excludeFromSitemap, SitemapPriority sitemapPriority, String urlComponent, String searchKeywords, Boolean isDonationItem, Boolean showDefaultDonationAmount, Double maxDonationAmount, Boolean dontShowPrice, String noPriceMessage, String shoppingDotComCategory, Long shopzillaCategoryId, String outOfStockMessage, String nexTagCategory, ItemOutOfStockBehavior outOfStockBehavior, ProductFeedList productFeedList, String relatedItemsDescription, Boolean onSpecial, String specialsDescription, String featuredDescription, ItemOptionsList itemOptionsList, RecordRefList itemNumberOptionsList, ItemVendorList itemVendorList, PricingMatrix pricingMatrix, SerializedAssemblyItemBillOfMaterialsList billOfMaterialsList, ItemMemberList memberList, ItemAccountingBookDetailList accountingBookDetailList, SerializedInventoryItemLocationsList locationsList, SiteCategoryList siteCategoryList, InventoryItemBinNumberList binNumberList, SerializedInventoryItemNumbersList numbersList, TranslationList translationsList, PresentationItemList presentationItemList, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   public void setProdQtyVarianceAcct(RecordRef prodQtyVarianceAcct) {
      this.prodQtyVarianceAcct = prodQtyVarianceAcct;
   }
   ...
   public void setProdPriceVarianceAcct(RecordRef prodPriceVarianceAcct) {
      this.prodPriceVarianceAcct = prodPriceVarianceAcct;
   }
   ...
   public void setWipVarianceAcct(RecordRef wipVarianceAcct) {
      this.wipVarianceAcct = wipVarianceAcct;
   }
   ...
   public void setScrapAcct(RecordRef scrapAcct) {
      this.scrapAcct = scrapAcct;
   }
   ...
   public void setWipAcct(RecordRef wipAcct) {
      this.wipAcct = wipAcct;
   }
   ...
   public void setEffectiveBomControl(AssemblyItemEffectiveBomControl effectiveBomControl) {
      this.effectiveBomControl = effectiveBomControl;
   }
   ...
   public void setScheduleBCode(RecordRef scheduleBCode) {
      this.scheduleBCode = scheduleBCode;
   }
   ...
   public void setIsSpecialWorkOrderItem(Boolean isSpecialWorkOrderItem) {
      this.isSpecialWorkOrderItem = isSpecialWorkOrderItem;
   }
   ...
   public void setBuildEntireAssembly(Boolean buildEntireAssembly) {
      this.buildEntireAssembly = buildEntireAssembly;
   }
   ...
   public void setUnbuildVarianceAccount(RecordRef unbuildVarianceAccount) {
      this.unbuildVarianceAccount = unbuildVarianceAccount;
   }
   ...
   public void setBillOfMaterialsList(SerializedAssemblyItemBillOfMaterialsList billOfMaterialsList) {
      this.billOfMaterialsList = billOfMaterialsList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SerializedAssemblyItem)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.createdDate == null && other.getCreatedDate() == null || this.createdDate != null && this.createdDate.equals(other.getCreatedDate())) && (this.lastModifiedDate == null && other.getLastModifiedDate() == null || this.lastModifiedDate != null && this.lastModifiedDate.equals(other.getLastModifiedDate())) && (this.customForm == null && other.getCustomForm() == null || this.customForm != null && this.customForm.equals(other.getCustomForm())) && (this.itemId == null && other.getItemId() == null || this.itemId != null && this.itemId.equals(other.getItemId())) && (this.upcCode == null && other.getUpcCode() == null || this.upcCode != null && this.upcCode.equals(other.getUpcCode())) && (this.displayName == null && other.getDisplayName() == null || this.displayName != null && this.displayName.equals(other.getDisplayName())) && (this.vendorName == null && other.getVendorName() == null || this.vendorName != null && this.vendorName.equals(other.getVendorName())) && (this.parent == null && other.getParent() == null || this.parent != null && this.parent.equals(other.getParent())) && (this.printItems == null && other.getPrintItems() == null || this.printItems != null && this.printItems.equals(other.getPrintItems())) && (this.isOnline == null && other.getIsOnline() == null || this.isOnline != null && this.isOnline.equals(other.getIsOnline())) && (this.lastInvtCountDate == null && other.getLastInvtCountDate() == null || this.lastInvtCountDate != null && this.lastInvtCountDate.equals(other.getLastInvtCountDate())) && (this.nextInvtCountDate == null && other.getNextInvtCountDate() == null || this.nextInvtCountDate != null && this.nextInvtCountDate.equals(other.getNextInvtCountDate())) && (this.invtCountInterval == null && other.getInvtCountInterval() == null || this.invtCountInterval != null && this.invtCountInterval.equals(other.getInvtCountInterval())) && (this.invtClassification == null && other.getInvtClassification() == null || this.invtClassification != null && this.invtClassification.equals(other.getInvtClassification())) && (this.isGcoCompliant == null && other.getIsGcoCompliant() == null || this.isGcoCompliant != null && this.isGcoCompliant.equals(other.getIsGcoCompliant())) && (this.offerSupport == null && other.getOfferSupport() == null || this.offerSupport != null && this.offerSupport.equals(other.getOfferSupport())) && (this.useComponentYield == null && other.getUseComponentYield() == null || this.useComponentYield != null && this.useComponentYield.equals(other.getUseComponentYield())) && (this.isInactive == null && other.getIsInactive() == null || this.isInactive != null && this.isInactive.equals(other.getIsInactive())) && (this.subsidiaryList == null && other.getSubsidiaryList() == null || this.subsidiaryList != null && this.subsidiaryList.equals(other.getSubsidiaryList())) && (this.availableToPartners == null && other.getAvailableToPartners() == null || this.availableToPartners != null && this.availableToPartners.equals(other.getAvailableToPartners())) && (this.includeChildren == null && other.getIncludeChildren() == null || this.includeChildren != null && this.includeChildren.equals(other.getIncludeChildren())) && (this.department == null && other.getDepartment() == null || this.department != null && this.department.equals(other.getDepartment())) && (this._class == null && other.get_class() == null || this._class != null && this._class.equals(other.get_class())) && (this.location == null && other.getLocation() == null || this.location != null && this.location.equals(other.getLocation())) && (this.description == null && other.getDescription() == null || this.description != null && this.description.equals(other.getDescription())) && (this.cogsAccount == null && other.getCogsAccount() == null || this.cogsAccount != null && this.cogsAccount.equals(other.getCogsAccount())) && (this.vendor == null && other.getVendor() == null || this.vendor != null && this.vendor.equals(other.getVendor())) && (this.incomeAccount == null && other.getIncomeAccount() == null || this.incomeAccount != null && this.incomeAccount.equals(other.getIncomeAccount())) && (this.intercoIncomeAccount == null && other.getIntercoIncomeAccount() == null || this.intercoIncomeAccount != null && this.intercoIncomeAccount.equals(other.getIntercoIncomeAccount())) && (this.assetAccount == null && other.getAssetAccount() == null || this.assetAccount != null && this.assetAccount.equals(other.getAssetAccount())) && (this.matchBillToReceipt == null && other.getMatchBillToReceipt() == null || this.matchBillToReceipt != null && this.matchBillToReceipt.equals(other.getMatchBillToReceipt())) && (this.billQtyVarianceAcct == null && other.getBillQtyVarianceAcct() == null || this.billQtyVarianceAcct != null && this.billQtyVarianceAcct.equals(other.getBillQtyVarianceAcct())) && (this.billPriceVarianceAcct == null && other.getBillPriceVarianceAcct() == null || this.billPriceVarianceAcct != null && this.billPriceVarianceAcct.equals(other.getBillPriceVarianceAcct())) && (this.billExchRateVarianceAcct == null && other.getBillExchRateVarianceAcct() == null || this.billExchRateVarianceAcct != null && this.billExchRateVarianceAcct.equals(other.getBillExchRateVarianceAcct())) && (this.gainLossAccount == null && other.getGainLossAccount() == null || this.gainLossAccount != null && this.gainLossAccount.equals(other.getGainLossAccount())) && (this.salesTaxCode == null && other.getSalesTaxCode() == null || this.salesTaxCode != null && this.salesTaxCode.equals(other.getSalesTaxCode())) && (this.costCategory == null && other.getCostCategory() == null || this.costCategory != null && this.costCategory.equals(other.getCostCategory())) && (this.purchaseTaxCode == null && other.getPurchaseTaxCode() == null || this.purchaseTaxCode != null && this.purchaseTaxCode.equals(other.getPurchaseTaxCode())) && (this.prodQtyVarianceAcct == null && other.getProdQtyVarianceAcct() == null || this.prodQtyVarianceAcct != null && this.prodQtyVarianceAcct.equals(other.getProdQtyVarianceAcct())) && (this.prodPriceVarianceAcct == null && other.getProdPriceVarianceAcct() == null || this.prodPriceVarianceAcct != null && this.prodPriceVarianceAcct.equals(other.getProdPriceVarianceAcct())) && (this.purchasePriceVarianceAcct == null && other.getPurchasePriceVarianceAcct() == null || this.purchasePriceVarianceAcct != null && this.purchasePriceVarianceAcct.equals(other.getPurchasePriceVarianceAcct())) && (this.wipVarianceAcct == null && other.getWipVarianceAcct() == null || this.wipVarianceAcct != null && this.wipVarianceAcct.equals(other.getWipVarianceAcct())) && (this.taxSchedule == null && other.getTaxSchedule() == null || this.taxSchedule != null && this.taxSchedule.equals(other.getTaxSchedule())) && (this.scrapAcct == null && other.getScrapAcct() == null || this.scrapAcct != null && this.scrapAcct.equals(other.getScrapAcct())) && (this.shippingCost == null && other.getShippingCost() == null || this.shippingCost != null && this.shippingCost.equals(other.getShippingCost())) && (this.wipAcct == null && other.getWipAcct() == null || this.wipAcct != null && this.wipAcct.equals(other.getWipAcct())) && (this.shippingCostUnits == null && other.getShippingCostUnits() == null || this.shippingCostUnits != null && this.shippingCostUnits.equals(other.getShippingCostUnits())) && (this.handlingCost == null && other.getHandlingCost() == null || this.handlingCost != null && this.handlingCost.equals(other.getHandlingCost())) && (this.weight == null && other.getWeight() == null || this.weight != null && this.weight.equals(other.getWeight())) && (this.handlingCostUnits == null && other.getHandlingCostUnits() == null || this.handlingCostUnits != null && this.handlingCostUnits.equals(other.getHandlingCostUnits())) && (this.weightUnit == null && other.getWeightUnit() == null || this.weightUnit != null && this.weightUnit.equals(other.getWeightUnit())) && (this.weightUnits == null && other.getWeightUnits() == null || this.weightUnits != null && this.weightUnits.equals(other.getWeightUnits())) && (this.costingMethod == null && other.getCostingMethod() == null || this.costingMethod != null && this.costingMethod.equals(other.getCostingMethod())) && (this.isTaxable == null && other.getIsTaxable() == null || this.isTaxable != null && this.isTaxable.equals(other.getIsTaxable())) && (this.costingMethodDisplay == null && other.getCostingMethodDisplay() == null || this.costingMethodDisplay != null && this.costingMethodDisplay.equals(other.getCostingMethodDisplay())) && (this.rate == null && other.getRate() == null || this.rate != null && this.rate.equals(other.getRate())) && (this.unitsType == null && other.getUnitsType() == null || this.unitsType != null && this.unitsType.equals(other.getUnitsType())) && (this.stockUnit == null && other.getStockUnit() == null || this.stockUnit != null && this.stockUnit.equals(other.getStockUnit())) && (this.purchaseUnit == null && other.getPurchaseUnit() == null || this.purchaseUnit != null && this.purchaseUnit.equals(other.getPurchaseUnit())) && (this.saleUnit == null && other.getSaleUnit() == null || this.saleUnit != null && this.saleUnit.equals(other.getSaleUnit())) && (this.trackLandedCost == null && other.getTrackLandedCost() == null || this.trackLandedCost != null && this.trackLandedCost.equals(other.getTrackLandedCost())) && (this.matrixItemNameTemplate == null && other.getMatrixItemNameTemplate() == null || this.matrixItemNameTemplate != null && this.matrixItemNameTemplate.equals(other.getMatrixItemNameTemplate())) && (this.billingSchedule == null && other.getBillingSchedule() == null || this.billingSchedule != null && this.billingSchedule.equals(other.getBillingSchedule())) && (this.deferredRevenueAccount == null && other.getDeferredRevenueAccount() == null || this.deferredRevenueAccount != null && this.deferredRevenueAccount.equals(other.getDeferredRevenueAccount())) && (this.revRecSchedule == null && other.getRevRecSchedule() == null || this.revRecSchedule != null && this.revRecSchedule.equals(other.getRevRecSchedule())) && (this.stockDescription == null && other.getStockDescription() == null || this.stockDescription != null && this.stockDescription.equals(other.getStockDescription())) && (this.producer == null && other.getProducer() == null || this.producer != null && this.producer.equals(other.getProducer())) && (this.manufacturer == null && other.getManufacturer() == null || this.manufacturer != null && this.manufacturer.equals(other.getManufacturer())) && (this.mpn == null && other.getMpn() == null || this.mpn != null && this.mpn.equals(other.getMpn())) && (this.multManufactureAddr == null && other.getMultManufactureAddr() == null || this.multManufactureAddr != null && this.multManufactureAddr.equals(other.getMultManufactureAddr())) && (this.manufactureraddr1 == null && other.getManufactureraddr1() == null || this.manufactureraddr1 != null && this.manufactureraddr1.equals(other.getManufactureraddr1())) && (this.manufacturerCity == null && other.getManufacturerCity() == null || this.manufacturerCity != null && this.manufacturerCity.equals(other.getManufacturerCity())) && (this.manufacturerState == null && other.getManufacturerState() == null || this.manufacturerState != null && this.manufacturerState.equals(other.getManufacturerState())) && (this.manufacturerZip == null && other.getManufacturerZip() == null || this.manufacturerZip != null && this.manufacturerZip.equals(other.getManufacturerZip())) && (this.countryOfManufacture == null && other.getCountryOfManufacture() == null || this.countryOfManufacture != null && this.countryOfManufacture.equals(other.getCountryOfManufacture())) && (this.effectiveBomControl == null && other.getEffectiveBomControl() == null || this.effectiveBomControl != null && this.effectiveBomControl.equals(other.getEffectiveBomControl())) && (this.minimumQuantityUnits == null && other.getMinimumQuantityUnits() == null || this.minimumQuantityUnits != null && this.minimumQuantityUnits.equals(other.getMinimumQuantityUnits())) && (this.defaultRevision == null && other.getDefaultRevision() == null || this.defaultRevision != null && this.defaultRevision.equals(other.getDefaultRevision())) && (this.defaultItemShipMethod == null && other.getDefaultItemShipMethod() == null || this.defaultItemShipMethod != null && this.defaultItemShipMethod.equals(other.getDefaultItemShipMethod())) && (this.itemCarrier == null && other.getItemCarrier() == null || this.itemCarrier != null && this.itemCarrier.equals(other.getItemCarrier())) && (this.roundUpAsComponent == null && other.getRoundUpAsComponent() == null || this.roundUpAsComponent != null && this.roundUpAsComponent.equals(other.getRoundUpAsComponent())) && (this.purchaseOrderQuantity == null && other.getPurchaseOrderQuantity() == null || this.purchaseOrderQuantity != null && this.purchaseOrderQuantity.equals(other.getPurchaseOrderQuantity())) && (this.purchaseOrderAmount == null && other.getPurchaseOrderAmount() == null || this.purchaseOrderAmount != null && this.purchaseOrderAmount.equals(other.getPurchaseOrderAmount())) && (this.purchaseOrderQuantityDiff == null && other.getPurchaseOrderQuantityDiff() == null || this.purchaseOrderQuantityDiff != null && this.purchaseOrderQuantityDiff.equals(other.getPurchaseOrderQuantityDiff())) && (this.receiptQuantity == null && other.getReceiptQuantity() == null || this.receiptQuantity != null && this.receiptQuantity.equals(other.getReceiptQuantity())) && (this.receiptAmount == null && other.getReceiptAmount() == null || this.receiptAmount != null && this.receiptAmount.equals(other.getReceiptAmount())) && (this.receiptQuantityDiff == null && other.getReceiptQuantityDiff() == null || this.receiptQuantityDiff != null && this.receiptQuantityDiff.equals(other.getReceiptQuantityDiff())) && (this.isDropShipItem == null && other.getIsDropShipItem() == null || this.isDropShipItem != null && this.isDropShipItem.equals(other.getIsDropShipItem())) && (this.isPhantom == null && other.getIsPhantom() == null || this.isPhantom != null && this.isPhantom.equals(other.getIsPhantom())) && (this.itemShipMethodList == null && other.getItemShipMethodList() == null || this.itemShipMethodList != null && this.itemShipMethodList.equals(other.getItemShipMethodList())) && (this.manufacturerTaxId == null && other.getManufacturerTaxId() == null || this.manufacturerTaxId != null && this.manufacturerTaxId.equals(other.getManufacturerTaxId())) && (this.scheduleBNumber == null && other.getScheduleBNumber() == null || this.scheduleBNumber != null && this.scheduleBNumber.equals(other.getScheduleBNumber())) && (this.scheduleBQuantity == null && other.getScheduleBQuantity() == null || this.scheduleBQuantity != null && this.scheduleBQuantity.equals(other.getScheduleBQuantity())) && (this.scheduleBCode == null && other.getScheduleBCode() == null || this.scheduleBCode != null && this.scheduleBCode.equals(other.getScheduleBCode())) && (this.manufacturerTariff == null && other.getManufacturerTariff() == null || this.manufacturerTariff != null && this.manufacturerTariff.equals(other.getManufacturerTariff())) && (this.preferenceCriterion == null && other.getPreferenceCriterion() == null || this.preferenceCriterion != null && this.preferenceCriterion.equals(other.getPreferenceCriterion())) && (this.issueProduct == null && other.getIssueProduct() == null || this.issueProduct != null && this.issueProduct.equals(other.getIssueProduct())) && (this.minimumQuantity == null && other.getMinimumQuantity() == null || this.minimumQuantity != null && this.minimumQuantity.equals(other.getMinimumQuantity())) && (this.enforceMinQtyInternally == null && other.getEnforceMinQtyInternally() == null || this.enforceMinQtyInternally != null && this.enforceMinQtyInternally.equals(other.getEnforceMinQtyInternally())) && (this.softDescriptor == null && other.getSoftDescriptor() == null || this.softDescriptor != null && this.softDescriptor.equals(other.getSoftDescriptor())) && (this.isSpecialWorkOrderItem == null && other.getIsSpecialWorkOrderItem() == null || this.isSpecialWorkOrderItem != null && this.isSpecialWorkOrderItem.equals(other.getIsSpecialWorkOrderItem())) && (this.pricesIncludeTax == null && other.getPricesIncludeTax() == null || this.pricesIncludeTax != null && this.pricesIncludeTax.equals(other.getPricesIncludeTax())) && (this.quantityPricingSchedule == null && other.getQuantityPricingSchedule() == null || this.quantityPricingSchedule != null && this.quantityPricingSchedule.equals(other.getQuantityPricingSchedule())) && (this.buildEntireAssembly == null && other.getBuildEntireAssembly() == null || this.buildEntireAssembly != null && this.buildEntireAssembly.equals(other.getBuildEntireAssembly())) && (this.quantityOnHand == null && other.getQuantityOnHand() == null || this.quantityOnHand != null && this.quantityOnHand.equals(other.getQuantityOnHand())) && (this.quantityOnHandUnits == null && other.getQuantityOnHandUnits() == null || this.quantityOnHandUnits != null && this.quantityOnHandUnits.equals(other.getQuantityOnHandUnits())) && (this.useMarginalRates == null && other.getUseMarginalRates() == null || this.useMarginalRates != null && this.useMarginalRates.equals(other.getUseMarginalRates())) && (this.reorderMultiple == null && other.getReorderMultiple() == null || this.reorderMultiple != null && this.reorderMultiple.equals(other.getReorderMultiple())) && (this.cost == null && other.getCost() == null || this.cost != null && this.cost.equals(other.getCost())) && (this.costEstimateType == null && other.getCostEstimateType() == null || this.costEstimateType != null && this.costEstimateType.equals(other.getCostEstimateType())) && (this.isHazmatItem == null && other.getIsHazmatItem() == null || this.isHazmatItem != null && this.isHazmatItem.equals(other.getIsHazmatItem())) && (this.hazmatId == null && other.getHazmatId() == null || this.hazmatId != null && this.hazmatId.equals(other.getHazmatId())) && (this.hazmatShippingName == null && other.getHazmatShippingName() == null || this.hazmatShippingName != null && this.hazmatShippingName.equals(other.getHazmatShippingName())) && (this.hazmatHazardClass == null && other.getHazmatHazardClass() == null || this.hazmatHazardClass != null && this.hazmatHazardClass.equals(other.getHazmatHazardClass())) && (this.hazmatPackingGroup == null && other.getHazmatPackingGroup() == null || this.hazmatPackingGroup != null && this.hazmatPackingGroup.equals(other.getHazmatPackingGroup())) && (this.hazmatItemUnits == null && other.getHazmatItemUnits() == null || this.hazmatItemUnits != null && this.hazmatItemUnits.equals(other.getHazmatItemUnits())) && (this.hazmatItemUnitsQty == null && other.getHazmatItemUnitsQty() == null || this.hazmatItemUnitsQty != null && this.hazmatItemUnitsQty.equals(other.getHazmatItemUnitsQty())) && (this.costEstimate == null && other.getCostEstimate() == null || this.costEstimate != null && this.costEstimate.equals(other.getCostEstimate())) && (this.transferPrice == null && other.getTransferPrice() == null || this.transferPrice != null && this.transferPrice.equals(other.getTransferPrice())) && (this.overallQuantityPricingType == null && other.getOverallQuantityPricingType() == null || this.overallQuantityPricingType != null && this.overallQuantityPricingType.equals(other.getOverallQuantityPricingType())) && (this.pricingGroup == null && other.getPricingGroup() == null || this.pricingGroup != null && this.pricingGroup.equals(other.getPricingGroup())) && (this.intercoCogsAccount == null && other.getIntercoCogsAccount() == null || this.intercoCogsAccount != null && this.intercoCogsAccount.equals(other.getIntercoCogsAccount())) && (this.vsoePrice == null && other.getVsoePrice() == null || this.vsoePrice != null && this.vsoePrice.equals(other.getVsoePrice())) && (this.vsoeSopGroup == null && other.getVsoeSopGroup() == null || this.vsoeSopGroup != null && this.vsoeSopGroup.equals(other.getVsoeSopGroup())) && (this.vsoeDeferral == null && other.getVsoeDeferral() == null || this.vsoeDeferral != null && this.vsoeDeferral.equals(other.getVsoeDeferral())) && (this.vsoePermitDiscount == null && other.getVsoePermitDiscount() == null || this.vsoePermitDiscount != null && this.vsoePermitDiscount.equals(other.getVsoePermitDiscount())) && (this.vsoeDelivered == null && other.getVsoeDelivered() == null || this.vsoeDelivered != null && this.vsoeDelivered.equals(other.getVsoeDelivered())) && (this.itemRevenueCategory == null && other.getItemRevenueCategory() == null || this.itemRevenueCategory != null && this.itemRevenueCategory.equals(other.getItemRevenueCategory())) && (this.unbuildVarianceAccount == null && other.getUnbuildVarianceAccount() == null || this.unbuildVarianceAccount != null && this.unbuildVarianceAccount.equals(other.getUnbuildVarianceAccount())) && (this.revenueRecognitionRule == null && other.getRevenueRecognitionRule() == null || this.revenueRecognitionRule != null && this.revenueRecognitionRule.equals(other.getRevenueRecognitionRule())) && (this.revRecForecastRule == null && other.getRevRecForecastRule() == null || this.revRecForecastRule != null && this.revRecForecastRule.equals(other.getRevRecForecastRule())) && (this.revenueAllocationGroup == null && other.getRevenueAllocationGroup() == null || this.revenueAllocationGroup != null && this.revenueAllocationGroup.equals(other.getRevenueAllocationGroup())) && (this.createRevenuePlansOn == null && other.getCreateRevenuePlansOn() == null || this.createRevenuePlansOn != null && this.createRevenuePlansOn.equals(other.getCreateRevenuePlansOn())) && (this.directRevenuePosting == null && other.getDirectRevenuePosting() == null || this.directRevenuePosting != null && this.directRevenuePosting.equals(other.getDirectRevenuePosting())) && (this.dropshipExpenseAccount == null && other.getDropshipExpenseAccount() == null || this.dropshipExpenseAccount != null && this.dropshipExpenseAccount.equals(other.getDropshipExpenseAccount())) && (this.preferredLocation == null && other.getPreferredLocation() == null || this.preferredLocation != null && this.preferredLocation.equals(other.getPreferredLocation())) && (this.isStorePickupAllowed == null && other.getIsStorePickupAllowed() == null || this.isStorePickupAllowed != null && this.isStorePickupAllowed.equals(other.getIsStorePickupAllowed())) && (this.totalValue == null && other.getTotalValue() == null || this.totalValue != null && this.totalValue.equals(other.getTotalValue())) && (this.useBins == null && other.getUseBins() == null || this.useBins != null && this.useBins.equals(other.getUseBins())) && (this.averageCost == null && other.getAverageCost() == null || this.averageCost != null && this.averageCost.equals(other.getAverageCost())) && (this.lastPurchasePrice == null && other.getLastPurchasePrice() == null || this.lastPurchasePrice != null && this.lastPurchasePrice.equals(other.getLastPurchasePrice())) && (this.purchaseDescription == null && other.getPurchaseDescription() == null || this.purchaseDescription != null && this.purchaseDescription.equals(other.getPurchaseDescription())) && (this.leadTime == null && other.getLeadTime() == null || this.leadTime != null && this.leadTime.equals(other.getLeadTime())) && (this.autoLeadTime == null && other.getAutoLeadTime() == null || this.autoLeadTime != null && this.autoLeadTime.equals(other.getAutoLeadTime())) && (this.buildTime == null && other.getBuildTime() == null || this.buildTime != null && this.buildTime.equals(other.getBuildTime())) && (this.safetyStockLevel == null && other.getSafetyStockLevel() == null || this.safetyStockLevel != null && this.safetyStockLevel.equals(other.getSafetyStockLevel())) && (this.safetyStockLevelUnits == null && other.getSafetyStockLevelUnits() == null || this.safetyStockLevelUnits != null && this.safetyStockLevelUnits.equals(other.getSafetyStockLevelUnits())) && (this.safetyStockLevelDays == null && other.getSafetyStockLevelDays() == null || this.safetyStockLevelDays != null && this.safetyStockLevelDays.equals(other.getSafetyStockLevelDays())) && (this.seasonalDemand == null && other.getSeasonalDemand() == null || this.seasonalDemand != null && this.seasonalDemand.equals(other.getSeasonalDemand())) && (this.serialNumbers == null && other.getSerialNumbers() == null || this.serialNumbers != null && this.serialNumbers.equals(other.getSerialNumbers())) && (this.reorderPoint == null && other.getReorderPoint() == null || this.reorderPoint != null && this.reorderPoint.equals(other.getReorderPoint())) && (this.reorderPointUnits == null && other.getReorderPointUnits() == null || this.reorderPointUnits != null && this.reorderPointUnits.equals(other.getReorderPointUnits())) && (this.preferredStockLevel == null && other.getPreferredStockLevel() == null || this.preferredStockLevel != null && this.preferredStockLevel.equals(other.getPreferredStockLevel())) && (this.preferredStockLevelUnits == null && other.getPreferredStockLevelUnits() == null || this.preferredStockLevelUnits != null && this.preferredStockLevelUnits.equals(other.getPreferredStockLevelUnits())) && (this.demandModifier == null && other.getDemandModifier() == null || this.demandModifier != null && this.demandModifier.equals(other.getDemandModifier())) && (this.autoReorderPoint == null && other.getAutoReorderPoint() == null || this.autoReorderPoint != null && this.autoReorderPoint.equals(other.getAutoReorderPoint())) && (this.autoPreferredStockLevel == null && other.getAutoPreferredStockLevel() == null || this.autoPreferredStockLevel != null && this.autoPreferredStockLevel.equals(other.getAutoPreferredStockLevel())) && (this.preferredStockLevelDays == null && other.getPreferredStockLevelDays() == null || this.preferredStockLevelDays != null && this.preferredStockLevelDays.equals(other.getPreferredStockLevelDays())) && (this.defaultReturnCost == null && other.getDefaultReturnCost() == null || this.defaultReturnCost != null && this.defaultReturnCost.equals(other.getDefaultReturnCost())) && (this.supplyReplenishmentMethod == null && other.getSupplyReplenishmentMethod() == null || this.supplyReplenishmentMethod != null && this.supplyReplenishmentMethod.equals(other.getSupplyReplenishmentMethod())) && (this.alternateDemandSourceItem == null && other.getAlternateDemandSourceItem() == null || this.alternateDemandSourceItem != null && this.alternateDemandSourceItem.equals(other.getAlternateDemandSourceItem())) && (this.fixedLotSize == null && other.getFixedLotSize() == null || this.fixedLotSize != null && this.fixedLotSize.equals(other.getFixedLotSize())) && (this.supplyType == null && other.getSupplyType() == null || this.supplyType != null && this.supplyType.equals(other.getSupplyType())) && (this.demandTimeFence == null && other.getDemandTimeFence() == null || this.demandTimeFence != null && this.demandTimeFence.equals(other.getDemandTimeFence())) && (this.supplyTimeFence == null && other.getSupplyTimeFence() == null || this.supplyTimeFence != null && this.supplyTimeFence.equals(other.getSupplyTimeFence())) && (this.rescheduleInDays == null && other.getRescheduleInDays() == null || this.rescheduleInDays != null && this.rescheduleInDays.equals(other.getRescheduleInDays())) && (this.rescheduleOutDays == null && other.getRescheduleOutDays() == null || this.rescheduleOutDays != null && this.rescheduleOutDays.equals(other.getRescheduleOutDays())) && (this.supplyLotSizingMethod == null && other.getSupplyLotSizingMethod() == null || this.supplyLotSizingMethod != null && this.supplyLotSizingMethod.equals(other.getSupplyLotSizingMethod())) && (this.demandSource == null && other.getDemandSource() == null || this.demandSource != null && this.demandSource.equals(other.getDemandSource())) && (this.shipIndividually == null && other.getShipIndividually() == null || this.shipIndividually != null && this.shipIndividually.equals(other.getShipIndividually())) && (this.quantityCommitted == null && other.getQuantityCommitted() == null || this.quantityCommitted != null && this.quantityCommitted.equals(other.getQuantityCommitted())) && (this.quantityAvailable == null && other.getQuantityAvailable() == null || this.quantityAvailable != null && this.quantityAvailable.equals(other.getQuantityAvailable())) && (this.quantityBackOrdered == null && other.getQuantityBackOrdered() == null || this.quantityBackOrdered != null && this.quantityBackOrdered.equals(other.getQuantityBackOrdered())) && (this.quantityOnOrder == null && other.getQuantityOnOrder() == null || this.quantityOnOrder != null && this.quantityOnOrder.equals(other.getQuantityOnOrder())) && (this.shipPackage == null && other.getShipPackage() == null || this.shipPackage != null && this.shipPackage.equals(other.getShipPackage())) && (this.storeDisplayName == null && other.getStoreDisplayName() == null || this.storeDisplayName != null && this.storeDisplayName.equals(other.getStoreDisplayName())) && (this.storeDisplayThumbnail == null && other.getStoreDisplayThumbnail() == null || this.storeDisplayThumbnail != null && this.storeDisplayThumbnail.equals(other.getStoreDisplayThumbnail())) && (this.storeDisplayImage == null && other.getStoreDisplayImage() == null || this.storeDisplayImage != null && this.storeDisplayImage.equals(other.getStoreDisplayImage())) && (this.storeDescription == null && other.getStoreDescription() == null || this.storeDescription != null && this.storeDescription.equals(other.getStoreDescription())) && (this.storeDetailedDescription == null && other.getStoreDetailedDescription() == null || this.storeDetailedDescription != null && this.storeDetailedDescription.equals(other.getStoreDetailedDescription())) && (this.storeItemTemplate == null && other.getStoreItemTemplate() == null || this.storeItemTemplate != null && this.storeItemTemplate.equals(other.getStoreItemTemplate())) && (this.pageTitle == null && other.getPageTitle() == null || this.pageTitle != null && this.pageTitle.equals(other.getPageTitle())) && (this.metaTagHtml == null && other.getMetaTagHtml() == null || this.metaTagHtml != null && this.metaTagHtml.equals(other.getMetaTagHtml())) && (this.excludeFromSitemap == null && other.getExcludeFromSitemap() == null || this.excludeFromSitemap != null && this.excludeFromSitemap.equals(other.getExcludeFromSitemap())) && (this.sitemapPriority == null && other.getSitemapPriority() == null || this.sitemapPriority != null && this.sitemapPriority.equals(other.getSitemapPriority())) && (this.urlComponent == null && other.getUrlComponent() == null || this.urlComponent != null && this.urlComponent.equals(other.getUrlComponent())) && (this.searchKeywords == null && other.getSearchKeywords() == null || this.searchKeywords != null && this.searchKeywords.equals(other.getSearchKeywords())) && (this.isDonationItem == null && other.getIsDonationItem() == null || this.isDonationItem != null && this.isDonationItem.equals(other.getIsDonationItem())) && (this.showDefaultDonationAmount == null && other.getShowDefaultDonationAmount() == null || this.showDefaultDonationAmount != null && this.showDefaultDonationAmount.equals(other.getShowDefaultDonationAmount())) && (this.maxDonationAmount == null && other.getMaxDonationAmount() == null || this.maxDonationAmount != null && this.maxDonationAmount.equals(other.getMaxDonationAmount())) && (this.dontShowPrice == null && other.getDontShowPrice() == null || this.dontShowPrice != null && this.dontShowPrice.equals(other.getDontShowPrice())) && (this.noPriceMessage == null && other.getNoPriceMessage() == null || this.noPriceMessage != null && this.noPriceMessage.equals(other.getNoPriceMessage())) && (this.shoppingDotComCategory == null && other.getShoppingDotComCategory() == null || this.shoppingDotComCategory != null && this.shoppingDotComCategory.equals(other.getShoppingDotComCategory())) && (this.shopzillaCategoryId == null && other.getShopzillaCategoryId() == null || this.shopzillaCategoryId != null && this.shopzillaCategoryId.equals(other.getShopzillaCategoryId())) && (this.outOfStockMessage == null && other.getOutOfStockMessage() == null || this.outOfStockMessage != null && this.outOfStockMessage.equals(other.getOutOfStockMessage())) && (this.nexTagCategory == null && other.getNexTagCategory() == null || this.nexTagCategory != null && this.nexTagCategory.equals(other.getNexTagCategory())) && (this.outOfStockBehavior == null && other.getOutOfStockBehavior() == null || this.outOfStockBehavior != null && this.outOfStockBehavior.equals(other.getOutOfStockBehavior())) && (this.productFeedList == null && other.getProductFeedList() == null || this.productFeedList != null && this.productFeedList.equals(other.getProductFeedList())) && (this.relatedItemsDescription == null && other.getRelatedItemsDescription() == null || this.relatedItemsDescription != null && this.relatedItemsDescription.equals(other.getRelatedItemsDescription())) && (this.onSpecial == null && other.getOnSpecial() == null || this.onSpecial != null && this.onSpecial.equals(other.getOnSpecial())) && (this.specialsDescription == null && other.getSpecialsDescription() == null || this.specialsDescription != null && this.specialsDescription.equals(other.getSpecialsDescription())) && (this.featuredDescription == null && other.getFeaturedDescription() == null || this.featuredDescription != null && this.featuredDescription.equals(other.getFeaturedDescription())) && (this.itemOptionsList == null && other.getItemOptionsList() == null || this.itemOptionsList != null && this.itemOptionsList.equals(other.getItemOptionsList())) && (this.itemNumberOptionsList == null && other.getItemNumberOptionsList() == null || this.itemNumberOptionsList != null && this.itemNumberOptionsList.equals(other.getItemNumberOptionsList())) && (this.itemVendorList == null && other.getItemVendorList() == null || this.itemVendorList != null && this.itemVendorList.equals(other.getItemVendorList())) && (this.pricingMatrix == null && other.getPricingMatrix() == null || this.pricingMatrix != null && this.pricingMatrix.equals(other.getPricingMatrix())) && (this.billOfMaterialsList == null && other.getBillOfMaterialsList() == null || this.billOfMaterialsList != null && this.billOfMaterialsList.equals(other.getBillOfMaterialsList())) && (this.memberList == null && other.getMemberList() == null || this.memberList != null && this.memberList.equals(other.getMemberList())) && (this.accountingBookDetailList == null && other.getAccountingBookDetailList() == null || this.accountingBookDetailList != null && this.accountingBookDetailList.equals(other.getAccountingBookDetailList())) && (this.locationsList == null && other.getLocationsList() == null || this.locationsList != null && this.locationsList.equals(other.getLocationsList())) && (this.siteCategoryList == null && other.getSiteCategoryList() == null || this.siteCategoryList != null && this.siteCategoryList.equals(other.getSiteCategoryList())) && (this.binNumberList == null && other.getBinNumberList() == null || this.binNumberList != null && this.binNumberList.equals(other.getBinNumberList())) && (this.numbersList == null && other.getNumbersList() == null || this.numbersList != null && this.numbersList.equals(other.getNumbersList())) && (this.translationsList == null && other.getTranslationsList() == null || this.translationsList != null && this.translationsList.equals(other.getTranslationsList())) && (this.presentationItemList == null && other.getPresentationItemList() == null || this.presentationItemList != null && this.presentationItemList.equals(other.getPresentationItemList())) && (this.customFieldList == null && other.getCustomFieldList() == null || this.customFieldList != null && this.customFieldList.equals(other.getCustomFieldList())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getProdQtyVarianceAcct() != null) {
            _hashCode += this.getProdQtyVarianceAcct().hashCode();
         }

         if (this.getProdPriceVarianceAcct() != null) {
            _hashCode += this.getProdPriceVarianceAcct().hashCode();
         }
         ...
         if (this.getWipVarianceAcct() != null) {
            _hashCode += this.getWipVarianceAcct().hashCode();
         }
         ...
         if (this.getScrapAcct() != null) {
            _hashCode += this.getScrapAcct().hashCode();
         }
         ...
         if (this.getWipAcct() != null) {
            _hashCode += this.getWipAcct().hashCode();
         }
         ...
         if (this.getDefaultRevision() != null) {
            _hashCode += this.getDefaultRevision().hashCode();
         }
         ...
         if (this.getIsPhantom() != null) {
            _hashCode += this.getIsPhantom().hashCode();
         }
         ...
         if (this.getUnbuildVarianceAccount() != null) {
            _hashCode += this.getUnbuildVarianceAccount().hashCode();
         }
         ...
         if (this.getBillOfMaterialsList() != null) {
            _hashCode += this.getBillOfMaterialsList().hashCode();
         }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SerializedAssemblyItem"));
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "useComponentYield"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "prodQtyVarianceAcct"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "prodPriceVarianceAcct"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "wipVarianceAcct"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "scrapAcct"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "wipAcct"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "effectiveBomControl"));
      elemField.setXmlType(new QName("urn:types.accounting_2018_1.lists.webservices.netsuite.com", "AssemblyItemEffectiveBomControl"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "defaultRevision"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "isPhantom"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "isSpecialWorkOrderItem"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "buildEntireAssembly"));
      elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "boolean"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "unbuildVarianceAccount"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "billOfMaterialsList"));
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SerializedAssemblyItemBillOfMaterialsList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
