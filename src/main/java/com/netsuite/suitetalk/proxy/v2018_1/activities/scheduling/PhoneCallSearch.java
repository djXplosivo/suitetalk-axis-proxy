...
public class PhoneCallSearch extends SearchRecord implements Serializable {
   private PhoneCallSearchBasic basic;
   ...
   private EntitySearchBasic participantJoin;
   ...
   private static TypeDesc typeDesc = new TypeDesc(PhoneCallSearch.class, true);

   public PhoneCallSearch() {
      super();
   }

   public PhoneCallSearch(PhoneCallSearchBasic basic, SupportCaseSearchBasic caseJoin, CustomerSearchBasic companyCustomerJoin, ContactSearchBasic contactJoin, EmployeeSearchBasic employeeJoin, FileSearchBasic fileJoin, OpportunitySearchBasic opportunityJoin, OriginatingLeadSearchBasic originatingLeadJoin, EntitySearchBasic participantJoin, TransactionSearchBasic transactionJoin, EmployeeSearchBasic userJoin, NoteSearchBasic userNotesJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PhoneCallSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public void setParticipantJoin(EntitySearchBasic participantJoin) {
      this.participantJoin = participantJoin;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PhoneCallSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "PhoneCallSearch"));
