...
public class PaycheckSearchAdvanced extends SearchRecord implements Serializable {
   private PaycheckSearch criteria;
   private PaycheckSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PaycheckSearchAdvanced.class, true);

   public PaycheckSearchAdvanced() {
      super();
   }

   public PaycheckSearchAdvanced(String savedSearchId, String savedSearchScriptId, PaycheckSearch criteria, PaycheckSearchRow columns) {
      super();
   ...
   public void setCriteria(PaycheckSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(PaycheckSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PaycheckSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "PaycheckSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "PaycheckSearch"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "PaycheckSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
