...
public class ItemDemandPlanSearchAdvanced extends SearchRecord implements Serializable {
   private ItemDemandPlanSearch criteria;
   private ItemDemandPlanSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ItemDemandPlanSearchAdvanced.class, true);

   public ItemDemandPlanSearchAdvanced() {
      super();
   }

   public ItemDemandPlanSearchAdvanced(String savedSearchId, String savedSearchScriptId, ItemDemandPlanSearch criteria, ItemDemandPlanSearchRow columns) {
      super();
   ...
   public void setCriteria(ItemDemandPlanSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ItemDemandPlanSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemDemandPlanSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:demandplanning_2018_1.transactions.webservices.netsuite.com", "ItemDemandPlanSearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:demandplanning_2018_1.transactions.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:demandplanning_2018_1.transactions.webservices.netsuite.com", "ItemDemandPlanSearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:demandplanning_2018_1.transactions.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:demandplanning_2018_1.transactions.webservices.netsuite.com", "ItemDemandPlanSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
