...
public class ItemRevisionSearchAdvanced extends SearchRecord implements Serializable {
   private ItemRevisionSearch criteria;
   private ItemRevisionSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ItemRevisionSearchAdvanced.class, true);

   public ItemRevisionSearchAdvanced() {
      super();
   }

   public ItemRevisionSearchAdvanced(String savedSearchId, String savedSearchScriptId, ItemRevisionSearch criteria, ItemRevisionSearchRow columns) {
      super();
   ...
   public void setCriteria(ItemRevisionSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ItemRevisionSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemRevisionSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemRevisionSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemRevisionSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ItemRevisionSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
