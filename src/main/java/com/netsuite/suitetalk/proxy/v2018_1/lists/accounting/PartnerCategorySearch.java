...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.PartnerCategorySearchBasic;
...
public class PartnerCategorySearch extends SearchRecord implements Serializable {
   private PartnerCategorySearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PartnerCategorySearch.class, true);

   public PartnerCategorySearch() {
      super();
   }

   public PartnerCategorySearch(PartnerCategorySearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PartnerCategorySearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PartnerCategorySearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PartnerCategorySearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PartnerCategorySearchBasic"));
