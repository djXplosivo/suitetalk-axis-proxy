...
public class SearchColumnTextNumberField extends SearchColumnField implements Serializable {
   private String searchValue;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SearchColumnTextNumberField.class, true);

   public SearchColumnTextNumberField() {
      super();
   }

   public SearchColumnTextNumberField(String customLabel, String searchValue) {
      super(customLabel);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SearchColumnTextNumberField)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "SearchColumnTextNumberField"));
