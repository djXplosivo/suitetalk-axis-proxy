...
public class ContactRoleSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(ContactRoleSearchBasic.class, true);

   public ContactRoleSearchBasic() {
      super();
   }

   public ContactRoleSearchBasic(SearchStringField description, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField name) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ContactRoleSearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ContactRoleSearchBasic"));
