...
public class CustomerRefundApply implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomerRefundApply.class, true);

   public CustomerRefundApply() {
      super();
   }

   public CustomerRefundApply(Boolean apply, Long doc, Long line, Calendar applyDate, String type, String refNum, Double total, Double due, String currency, Double amount) {
      super();
      this.apply = apply;
      this.doc = doc;
      this.line = line;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerRefundApply)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CustomerRefundApply"));
