...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.WinLossReasonSearchRowBasic;
...
public class WinLossReasonSearchRow extends SearchRow implements Serializable {
   private WinLossReasonSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(WinLossReasonSearchRow.class, true);

   public WinLossReasonSearchRow() {
      super();
   }

   public WinLossReasonSearchRow(WinLossReasonSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(WinLossReasonSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof WinLossReasonSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "WinLossReasonSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "WinLossReasonSearchRowBasic"));
