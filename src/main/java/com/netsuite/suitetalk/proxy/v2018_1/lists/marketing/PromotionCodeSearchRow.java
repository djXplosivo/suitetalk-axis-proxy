...
public class PromotionCodeSearchRow extends SearchRow implements Serializable {
   private PromotionCodeSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PromotionCodeSearchRow.class, true);

   public PromotionCodeSearchRow() {
      super();
   }

   public PromotionCodeSearchRow(PromotionCodeSearchRowBasic basic, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PromotionCodeSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PromotionCodeSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:marketing_2018_1.lists.webservices.netsuite.com", "PromotionCodeSearchRow"));
