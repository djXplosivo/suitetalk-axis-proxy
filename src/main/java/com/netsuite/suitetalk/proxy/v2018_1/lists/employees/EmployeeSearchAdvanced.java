...
public class EmployeeSearchAdvanced extends SearchRecord implements Serializable {
   private EmployeeSearch criteria;
   private EmployeeSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(EmployeeSearchAdvanced.class, true);

   public EmployeeSearchAdvanced() {
      super();
   }

   public EmployeeSearchAdvanced(String savedSearchId, String savedSearchScriptId, EmployeeSearch criteria, EmployeeSearchRow columns) {
      super();
   ...
   public void setCriteria(EmployeeSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(EmployeeSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof EmployeeSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "EmployeeSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "EmployeeSearch"));
      ...
      elemField.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "EmployeeSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
