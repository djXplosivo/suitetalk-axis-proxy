...
public class DepartmentSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(DepartmentSearchRowBasic.class, true);

   public DepartmentSearchRowBasic() {
      super();
   }

   public DepartmentSearchRowBasic(SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name, SearchColumnStringField[] nameNoHierarchy, SearchColumnSelectField[] subsidiary, SearchColumnCustomFieldList customFieldList) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof DepartmentSearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "DepartmentSearchRowBasic"));
