...
public class ItemSupplyPlanOrderType implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:types.demandplanning_2018_1.transactions.webservices.netsuite.com", "ItemSupplyPlanOrderType"));
   }
}
