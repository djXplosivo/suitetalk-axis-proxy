...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.EntityGroupSearchRowBasic;
...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.ManufacturingCostTemplateSearchRowBasic;
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.ManufacturingRoutingSearchRowBasic;
...
public class ManufacturingRoutingSearchRow extends SearchRow implements Serializable {
   private ManufacturingRoutingSearchRowBasic basic;
   private ItemSearchRowBasic itemJoin;
   private LocationSearchRowBasic locationJoin;
   private ManufacturingCostTemplateSearchRowBasic manufacturingCostTemplateJoin;
   private EntityGroupSearchRowBasic manufacturingWorkCenterJoin;
   private EmployeeSearchRowBasic userJoin;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ManufacturingRoutingSearchRow.class, true);

   public ManufacturingRoutingSearchRow() {
      super();
   }

   public ManufacturingRoutingSearchRow(ManufacturingRoutingSearchRowBasic basic, ItemSearchRowBasic itemJoin, LocationSearchRowBasic locationJoin, ManufacturingCostTemplateSearchRowBasic manufacturingCostTemplateJoin, EntityGroupSearchRowBasic manufacturingWorkCenterJoin, EmployeeSearchRowBasic userJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(ManufacturingRoutingSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public void setManufacturingCostTemplateJoin(ManufacturingCostTemplateSearchRowBasic manufacturingCostTemplateJoin) {
      this.manufacturingCostTemplateJoin = manufacturingCostTemplateJoin;
   }
   ...
   public void setManufacturingWorkCenterJoin(EntityGroupSearchRowBasic manufacturingWorkCenterJoin) {
      this.manufacturingWorkCenterJoin = manufacturingWorkCenterJoin;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ManufacturingRoutingSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:supplychain_2018_1.lists.webservices.netsuite.com", "ManufacturingRoutingSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:supplychain_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ManufacturingRoutingSearchRowBasic"));
      ...
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "ManufacturingCostTemplateSearchRowBasic"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      ...
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "EntityGroupSearchRowBasic"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
