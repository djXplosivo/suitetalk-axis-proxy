...
public class TransactionBodyCustomFieldFilter implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(TransactionBodyCustomFieldFilter.class, true);

   public TransactionBodyCustomFieldFilter() {
      super();
   }

   public TransactionBodyCustomFieldFilter(RecordRef fldFilter, Boolean fldFilterChecked, CustomizationFilterCompareType fldFilterCompareType, String fldFilterVal, FldFilterSelList fldFilterSelList, Boolean fldFilterNotNull) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TransactionBodyCustomFieldFilter)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "TransactionBodyCustomFieldFilter"));
