...
public class ContactCategorySearchAdvanced extends SearchRecord implements Serializable {
   private ContactCategorySearch criteria;
   private ContactCategorySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ContactCategorySearchAdvanced.class, true);

   public ContactCategorySearchAdvanced() {
      super();
   }

   public ContactCategorySearchAdvanced(String savedSearchId, String savedSearchScriptId, ContactCategorySearch criteria, ContactCategorySearchRow columns) {
      super();
   ...
   public void setCriteria(ContactCategorySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ContactCategorySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ContactCategorySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ContactCategorySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ContactCategorySearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "ContactCategorySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
