...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.GlobalAccountMappingSearchRowBasic;
...
public class GlobalAccountMappingSearchRow extends SearchRow implements Serializable {
   private GlobalAccountMappingSearchRowBasic basic;
   ...
   public void setBasic(GlobalAccountMappingSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GlobalAccountMappingSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GlobalAccountMappingSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "GlobalAccountMappingSearchRowBasic"));
