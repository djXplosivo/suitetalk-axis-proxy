...
public class ItemSupplyPlanSearchAdvanced extends SearchRecord implements Serializable {
   private ItemSupplyPlanSearch criteria;
   private ItemSupplyPlanSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ItemSupplyPlanSearchAdvanced.class, true);

   public ItemSupplyPlanSearchAdvanced() {
      super();
   }

   public ItemSupplyPlanSearchAdvanced(String savedSearchId, String savedSearchScriptId, ItemSupplyPlanSearch criteria, ItemSupplyPlanSearchRow columns) {
      super();
   ...
   public void setCriteria(ItemSupplyPlanSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ItemSupplyPlanSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ItemSupplyPlanSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:demandplanning_2018_1.transactions.webservices.netsuite.com", "ItemSupplyPlanSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:demandplanning_2018_1.transactions.webservices.netsuite.com", "ItemSupplyPlanSearch"));
      ...
      elemField.setXmlType(new QName("urn:demandplanning_2018_1.transactions.webservices.netsuite.com", "ItemSupplyPlanSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
