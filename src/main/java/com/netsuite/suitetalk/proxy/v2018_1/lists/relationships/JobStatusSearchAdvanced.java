...
public class JobStatusSearchAdvanced extends SearchRecord implements Serializable {
   private JobStatusSearch criteria;
   private JobStatusSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(JobStatusSearchAdvanced.class, true);

   public JobStatusSearchAdvanced() {
      super();
   }

   public JobStatusSearchAdvanced(String savedSearchId, String savedSearchScriptId, JobStatusSearch criteria, JobStatusSearchRow columns) {
      super();
   ...
   public void setCriteria(JobStatusSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(JobStatusSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof JobStatusSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobStatusSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobStatusSearch"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobStatusSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
