...
public class InventoryNumberSearchAdvanced extends SearchRecord implements Serializable {
   private InventoryNumberSearch criteria;
   private InventoryNumberSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(InventoryNumberSearchAdvanced.class, true);

   public InventoryNumberSearchAdvanced() {
      super();
   }

   public InventoryNumberSearchAdvanced(String savedSearchId, String savedSearchScriptId, InventoryNumberSearch criteria, InventoryNumberSearchRow columns) {
      super();
   ...
   public void setCriteria(InventoryNumberSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(InventoryNumberSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InventoryNumberSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "InventoryNumberSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "InventoryNumberSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "InventoryNumberSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
