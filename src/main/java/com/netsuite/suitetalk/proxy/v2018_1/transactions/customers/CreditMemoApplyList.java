...
public class CreditMemoApplyList implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CreditMemoApplyList.class, true);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CreditMemoApplyList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CreditMemoApplyList"));
      ...
      elemField.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CreditMemoApply"));
