...
public class CustomerAddressbook implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomerAddressbook.class, true);

   public CustomerAddressbook() {
      super();
   }

   public CustomerAddressbook(Boolean defaultShipping, Boolean defaultBilling, Boolean isResidential, String label, Address addressbookAddress, String internalId) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerAddressbook)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerAddressbook"));
