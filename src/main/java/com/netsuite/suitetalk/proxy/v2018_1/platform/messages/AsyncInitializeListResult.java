...
public class AsyncInitializeListResult extends AsyncResult implements Serializable {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:messages_2018_1.platform.webservices.netsuite.com", "AsyncInitializeListResult"));
