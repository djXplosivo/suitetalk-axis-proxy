...
public class FileSearchAdvanced extends SearchRecord implements Serializable {
   private FileSearch criteria;
   private FileSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(FileSearchAdvanced.class, true);

   public FileSearchAdvanced() {
      super();
   }

   public FileSearchAdvanced(String savedSearchId, String savedSearchScriptId, FileSearch criteria, FileSearchRow columns) {
      super();
   ...
   public void setCriteria(FileSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(FileSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof FileSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "FileSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "FileSearch"));
      ...
      elemField.setXmlType(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "FileSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
