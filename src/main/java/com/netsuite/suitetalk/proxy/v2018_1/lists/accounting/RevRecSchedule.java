...
public class RevRecSchedule extends Record implements Serializable {
   private String name;
   ...
   public void setRecurrenceList(RevRecScheduleRecurrenceList recurrenceList) {
      this.recurrenceList = recurrenceList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof RevRecSchedule)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecSchedule"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecScheduleRecurrenceList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
