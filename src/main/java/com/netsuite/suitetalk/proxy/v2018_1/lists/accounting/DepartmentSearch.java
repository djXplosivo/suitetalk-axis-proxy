...
public class DepartmentSearch extends SearchRecord implements Serializable {
   private DepartmentSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private CustomSearchJoin[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(DepartmentSearch.class, true);

   public DepartmentSearch() {
      super();
   }

   public DepartmentSearch(DepartmentSearchBasic basic, EmployeeSearchBasic userJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(DepartmentSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof DepartmentSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "DepartmentSearch"));
