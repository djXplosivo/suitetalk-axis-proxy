...
public class PaycheckJournalEmployeeTax implements Serializable {
   private Long id;
   ...
   private static TypeDesc typeDesc = new TypeDesc(PaycheckJournalEmployeeTax.class, true);

   public PaycheckJournalEmployeeTax() {
      super();
   }

   public PaycheckJournalEmployeeTax(Long id, RecordRef payrollItem, Double amount, RecordRef department, RecordRef _class, RecordRef location, CustomFieldList customFieldList) {
      super();
      this.id = id;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PaycheckJournalEmployeeTax)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "PaycheckJournalEmployeeTax"));
