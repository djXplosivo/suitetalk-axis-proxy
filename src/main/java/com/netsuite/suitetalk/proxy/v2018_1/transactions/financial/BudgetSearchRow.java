...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.BudgetSearchRowBasic;
...
public class BudgetSearchRow extends SearchRow implements Serializable {
   private BudgetSearchRowBasic basic;
   private CustomSearchRowBasic[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(BudgetSearchRow.class, true);

   public BudgetSearchRow() {
      super();
   }

   public BudgetSearchRow(BudgetSearchRowBasic basic, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(BudgetSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof BudgetSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "BudgetSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "BudgetSearchRowBasic"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("customSearchJoin");
      elemField.setXmlName(new QName("urn:financial_2018_1.transactions.webservices.netsuite.com", "customSearchJoin"));
