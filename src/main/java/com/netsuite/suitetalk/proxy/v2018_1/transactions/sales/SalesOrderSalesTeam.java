...
public class SalesOrderSalesTeam implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(SalesOrderSalesTeam.class, true);

   public SalesOrderSalesTeam() {
      super();
   }

   public SalesOrderSalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesOrderSalesTeam)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "SalesOrderSalesTeam"));
