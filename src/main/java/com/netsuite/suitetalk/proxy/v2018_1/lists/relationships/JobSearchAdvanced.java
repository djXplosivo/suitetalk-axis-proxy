...
public class JobSearchAdvanced extends SearchRecord implements Serializable {
   private JobSearch criteria;
   private JobSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(JobSearchAdvanced.class, true);

   public JobSearchAdvanced() {
      super();
   }

   public JobSearchAdvanced(String savedSearchId, String savedSearchScriptId, JobSearch criteria, JobSearchRow columns) {
      super();
   ...
   public void setCriteria(JobSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(JobSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof JobSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobSearch"));
      ...
      elemField.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "JobSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
