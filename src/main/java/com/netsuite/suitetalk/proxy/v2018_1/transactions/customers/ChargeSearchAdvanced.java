...
public class ChargeSearchAdvanced extends SearchRecord implements Serializable {
   private ChargeSearch criteria;
   private ChargeSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ChargeSearchAdvanced.class, true);

   public ChargeSearchAdvanced() {
      super();
   }

   public ChargeSearchAdvanced(String savedSearchId, String savedSearchScriptId, ChargeSearch criteria, ChargeSearchRow columns) {
      super();
   ...
   public void setCriteria(ChargeSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ChargeSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ChargeSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "ChargeSearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "ChargeSearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "ChargeSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
