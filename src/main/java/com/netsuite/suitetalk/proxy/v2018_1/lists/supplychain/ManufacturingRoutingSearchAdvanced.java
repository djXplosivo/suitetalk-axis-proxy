...
public class ManufacturingRoutingSearchAdvanced extends SearchRecord implements Serializable {
   private ManufacturingRoutingSearch criteria;
   private ManufacturingRoutingSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ManufacturingRoutingSearchAdvanced.class, true);

   public ManufacturingRoutingSearchAdvanced() {
      super();
   }

   public ManufacturingRoutingSearchAdvanced(String savedSearchId, String savedSearchScriptId, ManufacturingRoutingSearch criteria, ManufacturingRoutingSearchRow columns) {
      super();
   ...
   public void setCriteria(ManufacturingRoutingSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(ManufacturingRoutingSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ManufacturingRoutingSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:supplychain_2018_1.lists.webservices.netsuite.com", "ManufacturingRoutingSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:supplychain_2018_1.lists.webservices.netsuite.com", "ManufacturingRoutingSearch"));
      ...
      elemField.setXmlType(new QName("urn:supplychain_2018_1.lists.webservices.netsuite.com", "ManufacturingRoutingSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
