...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.CustomRecordSearchBasic;
...
public class CustomRecordSearch extends SearchRecord implements Serializable {
   private CustomRecordSearchBasic basic;
   private FileSearchBasic fileJoin;
   private MessageSearchBasic messagesJoin;
   private EmployeeSearchBasic ownerJoin;
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomRecordSearch.class, true);

   public CustomRecordSearch() {
      super();
   }

   public CustomRecordSearch(CustomRecordSearchBasic basic, FileSearchBasic fileJoin, MessageSearchBasic messagesJoin, EmployeeSearchBasic ownerJoin, EmployeeSearchBasic userJoin, NoteSearchBasic userNotesJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(CustomRecordSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public void setOwnerJoin(EmployeeSearchBasic ownerJoin) {
      this.ownerJoin = ownerJoin;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomRecordSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "CustomRecordSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomRecordSearchBasic"));
