...
public class TaxTypeSearchRow extends SearchRow implements Serializable {
   private TaxTypeSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TaxTypeSearchRow.class, true);

   public TaxTypeSearchRow() {
      super();
   }

   public TaxTypeSearchRow(TaxTypeSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(TaxTypeSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TaxTypeSearchRow)) {
         return false;
      } else {
         TaxTypeSearchRow other = (TaxTypeSearchRow)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxTypeSearchRow"));
