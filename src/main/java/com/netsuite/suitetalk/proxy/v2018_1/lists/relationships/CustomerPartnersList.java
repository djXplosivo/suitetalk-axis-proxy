...
public class CustomerPartnersList implements Serializable {
   private Partners[] partners;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerPartnersList.class, true);

   public CustomerPartnersList() {
      super();
   }

   public CustomerPartnersList(Partners[] partners, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerPartnersList)) {
         return false;
      } else {
         CustomerPartnersList other = (CustomerPartnersList)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerPartnersList"));
      ...
      elemField.setXmlName(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "partners"));
