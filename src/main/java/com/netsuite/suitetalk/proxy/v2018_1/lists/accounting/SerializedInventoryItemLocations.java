...
public class SerializedInventoryItemLocations implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(SerializedInventoryItemLocations.class, true);

   public SerializedInventoryItemLocations() {
      super();
   }

   public SerializedInventoryItemLocations(String location, Double quantityOnHand, Double onHandValueMli, String serialNumbers, Double averageCostMli, Double lastPurchasePriceMli, Double reorderPoint, Boolean locationAllowStorePickup, Double locationStorePickupBufferStock, Double locationQtyAvailForStorePickup, Double preferredStockLevel, Long leadTime, Double defaultReturnCost, Boolean isWip, Double safetyStockLevel, Double cost, RecordRef inventoryCostTemplate, Double buildTime, Calendar lastInvtCountDate, Calendar nextInvtCountDate, Long invtCountInterval, ItemInvtClassification invtClassification, Double costingLotSize, Double quantityOnOrder, Double quantityCommitted, Double quantityAvailable, Double quantityBackOrdered, RecordRef locationId, RecordRef supplyReplenishmentMethod, RecordRef alternateDemandSourceItem, Double fixedLotSize, PeriodicLotSizeType periodicLotSizeType, Long periodicLotSizeDays, RecordRef supplyType, RecordRef supplyLotSizingMethod, RecordRef demandSource, Long backwardConsumptionDays, Long forwardConsumptionDays, Long demandTimeFence, Long supplyTimeFence, Long rescheduleInDays, Long rescheduleOutDays) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SerializedInventoryItemLocations)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "SerializedInventoryItemLocations"));
