...
public class AsyncAddListResult extends AsyncResult implements Serializable {
   private WriteResponseList writeResponseList;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(AsyncAddListResult.class, true);

   public AsyncAddListResult() {
      super();
   }

   public AsyncAddListResult(WriteResponseList writeResponseList) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AsyncAddListResult)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:messages_2018_1.platform.webservices.netsuite.com", "AsyncAddListResult"));
