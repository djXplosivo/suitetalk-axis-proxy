...
public class SalesOrderShipGroupList implements Serializable {
   private TransactionShipGroup[] shipGroup;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SalesOrderShipGroupList.class, true);

   public SalesOrderShipGroupList() {
      super();
   }

   public SalesOrderShipGroupList(TransactionShipGroup[] shipGroup, boolean replaceAll) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SalesOrderShipGroupList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "SalesOrderShipGroupList"));
