...
public class RevRecTemplateSearchAdvanced extends SearchRecord implements Serializable {
   private RevRecTemplateSearch criteria;
   private RevRecTemplateSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(RevRecTemplateSearchAdvanced.class, true);

   public RevRecTemplateSearchAdvanced() {
      super();
   }

   public RevRecTemplateSearchAdvanced(String savedSearchId, String savedSearchScriptId, RevRecTemplateSearch criteria, RevRecTemplateSearchRow columns) {
      super();
   ...
   public void setCriteria(RevRecTemplateSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(RevRecTemplateSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof RevRecTemplateSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecTemplateSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecTemplateSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecTemplateSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
