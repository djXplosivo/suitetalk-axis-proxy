...
public class HcmJobSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private SearchStringField jobId;
   private SearchStringField title;
   private SearchCustomFieldList customFieldList;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(HcmJobSearchBasic.class, true);

   public HcmJobSearchBasic() {
      super();
   }

   public HcmJobSearchBasic(SearchStringField description, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField jobId, SearchStringField title, SearchCustomFieldList customFieldList) {
      super();
   ...
   public void setJobId(SearchStringField jobId) {
      this.jobId = jobId;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof HcmJobSearchBasic)) {
         return false;
      } else {
         HcmJobSearchBasic other = (HcmJobSearchBasic)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
            ...
            boolean _equals = super.equals(obj) && (this.description == null && other.getDescription() == null || this.description != null && this.description.equals(other.getDescription())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId())) && (this.externalIdString == null && other.getExternalIdString() == null || this.externalIdString != null && this.externalIdString.equals(other.getExternalIdString())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.internalIdNumber == null && other.getInternalIdNumber() == null || this.internalIdNumber != null && this.internalIdNumber.equals(other.getInternalIdNumber())) && (this.isInactive == null && other.getIsInactive() == null || this.isInactive != null && this.isInactive.equals(other.getIsInactive())) && (this.jobId == null && other.getJobId() == null || this.jobId != null && this.jobId.equals(other.getJobId())) && (this.title == null && other.getTitle() == null || this.title != null && this.title.equals(other.getTitle())) && (this.customFieldList == null && other.getCustomFieldList() == null || this.customFieldList != null && this.customFieldList.equals(other.getCustomFieldList()));
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "HcmJobSearchBasic"));
