...
public class SearchColumnLongField extends SearchColumnField implements Serializable {
   private Long searchValue;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SearchColumnLongField.class, true);

   public SearchColumnLongField() {
      super();
   }

   public SearchColumnLongField(String customLabel, Long searchValue) {
      super(customLabel);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SearchColumnLongField)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "SearchColumnLongField"));
