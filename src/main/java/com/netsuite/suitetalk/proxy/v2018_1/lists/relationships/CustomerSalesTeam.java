...
public class CustomerSalesTeam implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomerSalesTeam.class, true);

   public CustomerSalesTeam() {
      super();
   }

   public CustomerSalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerSalesTeam)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "CustomerSalesTeam"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("employee");
      elemField.setXmlName(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "employee"));
      ...
      elemField.setXmlName(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "salesRole"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "isPrimary"));
      ...
      elemField.setXmlName(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "contribution"));
