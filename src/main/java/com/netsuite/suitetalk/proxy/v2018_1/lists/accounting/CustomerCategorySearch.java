...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.CustomerCategorySearchBasic;
...
public class CustomerCategorySearch extends SearchRecord implements Serializable {
   private CustomerCategorySearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerCategorySearch.class, true);

   public CustomerCategorySearch() {
      super();
   }

   public CustomerCategorySearch(CustomerCategorySearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(CustomerCategorySearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerCategorySearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CustomerCategorySearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomerCategorySearchBasic"));
