...
public class EstimateSalesTeam implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(EstimateSalesTeam.class, true);

   public EstimateSalesTeam() {
      super();
   }

   public EstimateSalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof EstimateSalesTeam)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "EstimateSalesTeam"));
