...
public class VendorCategorySearchAdvanced extends SearchRecord implements Serializable {
   private VendorCategorySearch criteria;
   private VendorCategorySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(VendorCategorySearchAdvanced.class, true);

   public VendorCategorySearchAdvanced() {
      super();
   }

   public VendorCategorySearchAdvanced(String savedSearchId, String savedSearchScriptId, VendorCategorySearch criteria, VendorCategorySearchRow columns) {
      super();
   ...
   public void setCriteria(VendorCategorySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(VendorCategorySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof VendorCategorySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "VendorCategorySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "VendorCategorySearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "VendorCategorySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
