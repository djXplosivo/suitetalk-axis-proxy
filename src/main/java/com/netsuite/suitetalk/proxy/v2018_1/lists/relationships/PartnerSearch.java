...
public class PartnerSearch extends SearchRecord implements Serializable {
   private PartnerSearchBasic basic;
   ...
   private static TypeDesc typeDesc = new TypeDesc(PartnerSearch.class, true);

   public PartnerSearch() {
      super();
   }

   public PartnerSearch(PartnerSearchBasic basic, CampaignSearchBasic campaignResponseJoin, ContactSearchBasic contactJoin, ContactSearchBasic contactPrimaryJoin, CustomerSearchBasic customerJoin, FileSearchBasic fileJoin, MessageSearchBasic messagesJoin, MessageSearchBasic messagesFromJoin, MessageSearchBasic messagesToJoin, OpportunitySearchBasic opportunityJoin, TransactionSearchBasic transactionJoin, EmployeeSearchBasic userJoin, NoteSearchBasic userNotesJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PartnerSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PartnerSearch)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:relationships_2018_1.lists.webservices.netsuite.com", "PartnerSearch"));
