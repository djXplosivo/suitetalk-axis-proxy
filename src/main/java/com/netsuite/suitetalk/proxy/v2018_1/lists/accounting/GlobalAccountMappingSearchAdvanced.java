...
public class GlobalAccountMappingSearchAdvanced extends SearchRecord implements Serializable {
   private GlobalAccountMappingSearch criteria;
   private GlobalAccountMappingSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GlobalAccountMappingSearchAdvanced.class, true);

   public GlobalAccountMappingSearchAdvanced() {
      super();
   }

   public GlobalAccountMappingSearchAdvanced(String savedSearchId, String savedSearchScriptId, GlobalAccountMappingSearch criteria, GlobalAccountMappingSearchRow columns) {
      super();
   ...
   public void setCriteria(GlobalAccountMappingSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(GlobalAccountMappingSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GlobalAccountMappingSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GlobalAccountMappingSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GlobalAccountMappingSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "GlobalAccountMappingSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
