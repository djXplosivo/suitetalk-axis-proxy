...
public class FolderSearchAdvanced extends SearchRecord implements Serializable {
   private FolderSearch criteria;
   private FolderSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(FolderSearchAdvanced.class, true);

   public FolderSearchAdvanced() {
      super();
   }

   public FolderSearchAdvanced(String savedSearchId, String savedSearchScriptId, FolderSearch criteria, FolderSearchRow columns) {
      super();
   ...
   public void setCriteria(FolderSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(FolderSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof FolderSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "FolderSearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "FolderSearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "FolderSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
