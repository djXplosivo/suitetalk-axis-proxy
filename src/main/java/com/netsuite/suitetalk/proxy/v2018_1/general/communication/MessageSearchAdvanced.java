...
public class MessageSearchAdvanced extends SearchRecord implements Serializable {
   private MessageSearch criteria;
   private MessageSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(MessageSearchAdvanced.class, true);

   public MessageSearchAdvanced() {
      super();
   }

   public MessageSearchAdvanced(String savedSearchId, String savedSearchScriptId, MessageSearch criteria, MessageSearchRow columns) {
      super();
   ...
   public void setCriteria(MessageSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(MessageSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof MessageSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:communication_2018_1.general.webservices.netsuite.com", "MessageSearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:communication_2018_1.general.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:communication_2018_1.general.webservices.netsuite.com", "MessageSearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:communication_2018_1.general.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:communication_2018_1.general.webservices.netsuite.com", "MessageSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
