...
public class LocationSearch extends SearchRecord implements Serializable {
   private LocationSearchBasic basic;
   ...
   private static TypeDesc typeDesc = new TypeDesc(LocationSearch.class, true);

   public LocationSearch() {
      super();
   }

   public LocationSearch(LocationSearchBasic basic, AddressSearchBasic addressJoin, AddressSearchBasic returnAddressJoin, EmployeeSearchBasic userJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(LocationSearchBasic basic) {
      this.basic = basic;
   }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "LocationSearch"));
