...
public class JobTypeSearchBasic extends SearchRecordBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(JobTypeSearchBasic.class, true);

   public JobTypeSearchBasic() {
      super();
   }

   public JobTypeSearchBasic(SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isInactive, SearchStringField name, SearchMultiSelectField parent) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof JobTypeSearchBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "JobTypeSearchBasic"));
