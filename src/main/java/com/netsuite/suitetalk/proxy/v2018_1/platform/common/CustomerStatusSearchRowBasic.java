...
public class CustomerStatusSearchRowBasic extends SearchRowBasic implements Serializable {
   private SearchColumnStringField[] description;
   private SearchColumnSelectField[] externalId;
   private SearchColumnBooleanField[] includeInLeadReports;
   private SearchColumnSelectField[] internalId;
   private SearchColumnBooleanField[] isInactive;
   private SearchColumnStringField[] name;
   private SearchColumnStringField[] probability;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomerStatusSearchRowBasic.class, true);

   public CustomerStatusSearchRowBasic() {
      super();
   }

   public CustomerStatusSearchRowBasic(SearchColumnStringField[] description, SearchColumnSelectField[] externalId, SearchColumnBooleanField[] includeInLeadReports, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name, SearchColumnStringField[] probability) {
      super();
   ...
   public SearchColumnBooleanField[] getIncludeInLeadReports() {
      return this.includeInLeadReports;
   }

   public void setIncludeInLeadReports(SearchColumnBooleanField[] includeInLeadReports) {
      this.includeInLeadReports = includeInLeadReports;
   }

   public SearchColumnBooleanField getIncludeInLeadReports(int i) {
      return this.includeInLeadReports[i];
   }

   public void setIncludeInLeadReports(int i, SearchColumnBooleanField _value) {
   ...
   public SearchColumnStringField[] getProbability() {
      return this.probability;
   }

   public void setProbability(SearchColumnStringField[] probability) {
      this.probability = probability;
   }

   public SearchColumnStringField getProbability(int i) {
      return this.probability[i];
   }

   public void setProbability(int i, SearchColumnStringField _value) {
      this.probability[i] = _value;
   }

   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerStatusSearchRowBasic)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.description == null && other.getDescription() == null || this.description != null && Arrays.equals(this.description, other.getDescription())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && Arrays.equals(this.externalId, other.getExternalId())) && (this.includeInLeadReports == null && other.getIncludeInLeadReports() == null || this.includeInLeadReports != null && Arrays.equals(this.includeInLeadReports, other.getIncludeInLeadReports())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && Arrays.equals(this.internalId, other.getInternalId())) && (this.isInactive == null && other.getIsInactive() == null || this.isInactive != null && Arrays.equals(this.isInactive, other.getIsInactive())) && (this.name == null && other.getName() == null || this.name != null && Arrays.equals(this.name, other.getName())) && (this.probability == null && other.getProbability() == null || this.probability != null && Arrays.equals(this.probability, other.getProbability()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getIncludeInLeadReports() != null) {
            for(i = 0; i < Array.getLength(this.getIncludeInLeadReports()); ++i) {
               obj = Array.get(this.getIncludeInLeadReports(), i);
               if (obj != null && !obj.getClass().isArray()) {
                  _hashCode += obj.hashCode();
               }
            }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CustomerStatusSearchRowBasic"));
      ...
      elemField.setXmlName(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "includeInLeadReports"));
