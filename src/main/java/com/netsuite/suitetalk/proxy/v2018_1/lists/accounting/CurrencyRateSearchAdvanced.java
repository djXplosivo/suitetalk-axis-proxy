...
public class CurrencyRateSearchAdvanced extends SearchRecord implements Serializable {
   private CurrencyRateSearch criteria;
   private CurrencyRateSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CurrencyRateSearchAdvanced.class, true);

   public CurrencyRateSearchAdvanced() {
      super();
   }

   public CurrencyRateSearchAdvanced(String savedSearchId, String savedSearchScriptId, CurrencyRateSearch criteria, CurrencyRateSearchRow columns) {
      super();
   ...
   public void setCriteria(CurrencyRateSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(CurrencyRateSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CurrencyRateSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CurrencyRateSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CurrencyRateSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "CurrencyRateSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
