...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.FolderSearchRowBasic;
...
public class FolderSearchRow extends SearchRow implements Serializable {
   private FolderSearchRowBasic basic;
   private FileSearchRowBasic fileJoin;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(FolderSearchRow.class, true);

   public FolderSearchRow() {
      super();
   }

   public FolderSearchRow(FolderSearchRowBasic basic, FileSearchRowBasic fileJoin, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(FolderSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof FolderSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "FolderSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:filecabinet_2018_1.documents.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "FolderSearchRowBasic"));
