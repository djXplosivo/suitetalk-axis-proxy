...
public class CalendarEventSearchAdvanced extends SearchRecord implements Serializable {
   private CalendarEventSearch criteria;
   private CalendarEventSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CalendarEventSearchAdvanced.class, true);

   public CalendarEventSearchAdvanced() {
      super();
   }

   public CalendarEventSearchAdvanced(String savedSearchId, String savedSearchScriptId, CalendarEventSearch criteria, CalendarEventSearchRow columns) {
      super();
   ...
   public void setCriteria(CalendarEventSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(CalendarEventSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CalendarEventSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "CalendarEventSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "CalendarEventSearch"));
      ...
      elemField.setXmlType(new QName("urn:scheduling_2018_1.activities.webservices.netsuite.com", "CalendarEventSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
