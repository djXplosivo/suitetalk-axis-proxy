...
public class HcmJobSearch extends SearchRecord implements Serializable {
   private HcmJobSearchBasic basic;
   private EmployeeSearchBasic employeeJoin;
   private CustomSearchJoin[] customSearchJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(HcmJobSearch.class, true);

   public HcmJobSearch() {
      super();
   }

   public HcmJobSearch(HcmJobSearchBasic basic, EmployeeSearchBasic employeeJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(HcmJobSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof HcmJobSearch)) {
         return false;
      } else {
         HcmJobSearch other = (HcmJobSearch)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.lists.webservices.netsuite.com", "HcmJobSearch"));
