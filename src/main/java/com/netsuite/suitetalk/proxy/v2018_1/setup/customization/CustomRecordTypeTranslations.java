...
public class CustomRecordTypeTranslations implements Serializable {
   private Language locale;
   private String localeDescription;
   private String name;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CustomRecordTypeTranslations.class, true);

   public CustomRecordTypeTranslations() {
      super();
   }

   public CustomRecordTypeTranslations(Language locale, String localeDescription, String name) {
      super();
      this.locale = locale;
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomRecordTypeTranslations)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customization_2018_1.setup.webservices.netsuite.com", "CustomRecordTypeTranslations"));
