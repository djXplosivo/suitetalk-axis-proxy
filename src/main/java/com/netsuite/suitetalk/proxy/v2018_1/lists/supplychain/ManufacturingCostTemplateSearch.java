...
public class ManufacturingCostTemplateSearch extends SearchRecord implements Serializable {
   private ManufacturingCostTemplateSearchBasic basic;
   ...
   private static TypeDesc typeDesc = new TypeDesc(ManufacturingCostTemplateSearch.class, true);

   public ManufacturingCostTemplateSearch() {
      super();
   }

   public ManufacturingCostTemplateSearch(ManufacturingCostTemplateSearchBasic basic, ItemSearchBasic itemJoin, EmployeeSearchBasic userJoin, CustomSearchJoin[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(ManufacturingCostTemplateSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ManufacturingCostTemplateSearch)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.basic == null && other.getBasic() == null || this.basic != null && this.basic.equals(other.getBasic())) && (this.itemJoin == null && other.getItemJoin() == null || this.itemJoin != null && this.itemJoin.equals(other.getItemJoin())) && (this.userJoin == null && other.getUserJoin() == null || this.userJoin != null && this.userJoin.equals(other.getUserJoin())) && (this.customSearchJoin == null && other.getCustomSearchJoin() == null || this.customSearchJoin != null && Arrays.equals(this.customSearchJoin, other.getCustomSearchJoin()));
   ...
   static {
      typeDesc.setXmlType(new QName("urn:supplychain_2018_1.lists.webservices.netsuite.com", "ManufacturingCostTemplateSearch"));
