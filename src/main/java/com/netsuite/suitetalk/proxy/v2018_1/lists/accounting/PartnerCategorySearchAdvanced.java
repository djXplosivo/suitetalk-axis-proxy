...
public class PartnerCategorySearchAdvanced extends SearchRecord implements Serializable {
   private PartnerCategorySearch criteria;
   private PartnerCategorySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PartnerCategorySearchAdvanced.class, true);

   public PartnerCategorySearchAdvanced() {
      super();
   }

   public PartnerCategorySearchAdvanced(String savedSearchId, String savedSearchScriptId, PartnerCategorySearch criteria, PartnerCategorySearchRow columns) {
      super();
   ...
   public void setCriteria(PartnerCategorySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(PartnerCategorySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PartnerCategorySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PartnerCategorySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PartnerCategorySearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PartnerCategorySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
