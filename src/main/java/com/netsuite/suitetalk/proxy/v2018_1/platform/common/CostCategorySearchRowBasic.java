...
public class CostCategorySearchRowBasic extends SearchRowBasic implements Serializable {
   private SearchColumnSelectField[] account;
   private SearchColumnSelectField[] externalId;
   private SearchColumnSelectField[] internalId;
   private SearchColumnBooleanField[] isInactive;
   private SearchColumnEnumSelectField[] itemCostType;
   private SearchColumnStringField[] name;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(CostCategorySearchRowBasic.class, true);

   public CostCategorySearchRowBasic() {
      super();
   }

   public CostCategorySearchRowBasic(SearchColumnSelectField[] account, SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnEnumSelectField[] itemCostType, SearchColumnStringField[] name) {
      super();
   ...
   public SearchColumnEnumSelectField[] getItemCostType() {
      return this.itemCostType;
   }

   public void setItemCostType(SearchColumnEnumSelectField[] itemCostType) {
      this.itemCostType = itemCostType;
   }

   public SearchColumnEnumSelectField getItemCostType(int i) {
      return this.itemCostType[i];
   }

   public void setItemCostType(int i, SearchColumnEnumSelectField _value) {
      this.itemCostType[i] = _value;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CostCategorySearchRowBasic)) {
         return false;
      } else {
         CostCategorySearchRowBasic other = (CostCategorySearchRowBasic)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
            ...
            boolean _equals = super.equals(obj) && (this.account == null && other.getAccount() == null || this.account != null && Arrays.equals(this.account, other.getAccount())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && Arrays.equals(this.externalId, other.getExternalId())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && Arrays.equals(this.internalId, other.getInternalId())) && (this.isInactive == null && other.getIsInactive() == null || this.isInactive != null && Arrays.equals(this.isInactive, other.getIsInactive())) && (this.itemCostType == null && other.getItemCostType() == null || this.itemCostType != null && Arrays.equals(this.itemCostType, other.getItemCostType())) && (this.name == null && other.getName() == null || this.name != null && Arrays.equals(this.name, other.getName()));
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getItemCostType() != null) {
            for(i = 0; i < Array.getLength(this.getItemCostType()); ++i) {
               obj = Array.get(this.getItemCostType(), i);
               if (obj != null && !obj.getClass().isArray()) {
                  _hashCode += obj.hashCode();
               }
            }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "CostCategorySearchRowBasic"));
      ...
      elemField.setXmlName(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "itemCostType"));
