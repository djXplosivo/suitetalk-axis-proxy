...
public class SolutionSearchRow extends SearchRow implements Serializable {
   private SolutionSearchRowBasic basic;
   private SupportCaseSearchRowBasic caseJoin;
   private SolutionSearchRowBasic relatedSolutionJoin;
   private TopicSearchRowBasic topicJoin;
   ...
   private static TypeDesc typeDesc = new TypeDesc(SolutionSearchRow.class, true);

   public SolutionSearchRow() {
      super();
   }

   public SolutionSearchRow(SolutionSearchRowBasic basic, SupportCaseSearchRowBasic caseJoin, SolutionSearchRowBasic relatedSolutionJoin, TopicSearchRowBasic topicJoin, EmployeeSearchRowBasic userJoin, NoteSearchRowBasic userNotesJoin, CustomSearchRowBasic[] customSearchJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(SolutionSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public void setRelatedSolutionJoin(SolutionSearchRowBasic relatedSolutionJoin) {
      this.relatedSolutionJoin = relatedSolutionJoin;
   }
   ...
   public void setTopicJoin(TopicSearchRowBasic topicJoin) {
      this.topicJoin = topicJoin;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SolutionSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "SolutionSearchRow"));
