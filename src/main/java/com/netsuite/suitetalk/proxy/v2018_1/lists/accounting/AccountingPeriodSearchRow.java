...
public class AccountingPeriodSearchRow extends SearchRow implements Serializable {
   private AccountingPeriodSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private NoteSearchRowBasic userNotesJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(AccountingPeriodSearchRow.class, true);

   public AccountingPeriodSearchRow() {
      super();
   }

   public AccountingPeriodSearchRow(AccountingPeriodSearchRowBasic basic, EmployeeSearchRowBasic userJoin, NoteSearchRowBasic userNotesJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(AccountingPeriodSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AccountingPeriodSearchRow)) {
         return false;
      } else {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.basic == null && other.getBasic() == null || this.basic != null && this.basic.equals(other.getBasic())) && (this.userJoin == null && other.getUserJoin() == null || this.userJoin != null && this.userJoin.equals(other.getUserJoin())) && (this.userNotesJoin == null && other.getUserNotesJoin() == null || this.userNotesJoin != null && this.userNotesJoin.equals(other.getUserNotesJoin()));
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AccountingPeriodSearchRow"));
