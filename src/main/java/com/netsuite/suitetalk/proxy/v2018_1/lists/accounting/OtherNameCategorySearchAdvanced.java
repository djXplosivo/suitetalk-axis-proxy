...
public class OtherNameCategorySearchAdvanced extends SearchRecord implements Serializable {
   private OtherNameCategorySearch criteria;
   private OtherNameCategorySearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(OtherNameCategorySearchAdvanced.class, true);

   public OtherNameCategorySearchAdvanced() {
      super();
   }

   public OtherNameCategorySearchAdvanced(String savedSearchId, String savedSearchScriptId, OtherNameCategorySearch criteria, OtherNameCategorySearchRow columns) {
      super();
   ...
   public void setCriteria(OtherNameCategorySearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(OtherNameCategorySearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof OtherNameCategorySearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "OtherNameCategorySearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "OtherNameCategorySearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "OtherNameCategorySearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
