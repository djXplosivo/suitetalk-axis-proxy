...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.TaxGroupSearchBasic;
...
public class TaxGroupSearch extends SearchRecord implements Serializable {
   private TaxGroupSearchBasic basic;
   private EmployeeSearchBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(TaxGroupSearch.class, true);

   public TaxGroupSearch() {
      super();
   }

   public TaxGroupSearch(TaxGroupSearchBasic basic, EmployeeSearchBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(TaxGroupSearchBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TaxGroupSearch)) {
         return false;
      } else {
         TaxGroupSearch other = (TaxGroupSearch)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "TaxGroupSearch"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "TaxGroupSearchBasic"));
