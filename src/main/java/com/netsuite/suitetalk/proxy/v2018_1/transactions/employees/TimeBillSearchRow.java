...
public class TimeBillSearchRow extends SearchRow implements Serializable {
   private TimeBillSearchRowBasic basic;
   ...
   public void setBasic(TimeBillSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof TimeBillSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:employees_2018_1.transactions.webservices.netsuite.com", "TimeBillSearchRow"));
