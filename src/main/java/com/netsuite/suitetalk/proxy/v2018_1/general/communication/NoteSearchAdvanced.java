...
public class NoteSearchAdvanced extends SearchRecord implements Serializable {
   private NoteSearch criteria;
   private NoteSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(NoteSearchAdvanced.class, true);

   public NoteSearchAdvanced() {
      super();
   }

   public NoteSearchAdvanced(String savedSearchId, String savedSearchScriptId, NoteSearch criteria, NoteSearchRow columns) {
      super();
   ...
   public void setCriteria(NoteSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(NoteSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof NoteSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:communication_2018_1.general.webservices.netsuite.com", "NoteSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:communication_2018_1.general.webservices.netsuite.com", "NoteSearch"));
      ...
      elemField.setXmlType(new QName("urn:communication_2018_1.general.webservices.netsuite.com", "NoteSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
