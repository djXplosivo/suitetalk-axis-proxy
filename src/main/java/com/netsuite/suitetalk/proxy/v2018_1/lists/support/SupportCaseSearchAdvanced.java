...
public class SupportCaseSearchAdvanced extends SearchRecord implements Serializable {
   private SupportCaseSearch criteria;
   private SupportCaseSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SupportCaseSearchAdvanced.class, true);

   public SupportCaseSearchAdvanced() {
      super();
   }

   public SupportCaseSearchAdvanced(String savedSearchId, String savedSearchScriptId, SupportCaseSearch criteria, SupportCaseSearchRow columns) {
      super();
   ...
   public void setCriteria(SupportCaseSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(SupportCaseSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SupportCaseSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "SupportCaseSearchAdvanced"));
      ...
      elemField.setXmlName(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "criteria"));
      elemField.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "SupportCaseSearch"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
      elemField.setFieldName("columns");
      elemField.setXmlName(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "columns"));
      elemField.setXmlType(new QName("urn:support_2018_1.lists.webservices.netsuite.com", "SupportCaseSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
