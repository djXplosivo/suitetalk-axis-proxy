...
public class JobTypeSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(JobTypeSearchRowBasic.class, true);

   public JobTypeSearchRowBasic() {
      super();
   }

   public JobTypeSearchRowBasic(SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] name, SearchColumnSelectField[] parent) {
      super();
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof JobTypeSearchRowBasic)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "JobTypeSearchRowBasic"));
