...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.OtherNameCategorySearchRowBasic;
...
public class OtherNameCategorySearchRow extends SearchRow implements Serializable {
   private OtherNameCategorySearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(OtherNameCategorySearchRow.class, true);

   public OtherNameCategorySearchRow() {
      super();
   }

   public OtherNameCategorySearchRow(OtherNameCategorySearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(OtherNameCategorySearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof OtherNameCategorySearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "OtherNameCategorySearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "OtherNameCategorySearchRowBasic"));
