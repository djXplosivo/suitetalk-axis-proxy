...
public class CustomerPaymentApplyList implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(CustomerPaymentApplyList.class, true);
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof CustomerPaymentApplyList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CustomerPaymentApplyList"));
      ...
      elemField.setXmlType(new QName("urn:customers_2018_1.transactions.webservices.netsuite.com", "CustomerPaymentApply"));
