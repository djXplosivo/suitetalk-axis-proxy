...
public class RevRecScheduleSearchAdvanced extends SearchRecord implements Serializable {
   private RevRecScheduleSearch criteria;
   private RevRecScheduleSearchRow columns;
   private String savedSearchId;
   private String savedSearchScriptId;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(RevRecScheduleSearchAdvanced.class, true);

   public RevRecScheduleSearchAdvanced() {
      super();
   }

   public RevRecScheduleSearchAdvanced(String savedSearchId, String savedSearchScriptId, RevRecScheduleSearch criteria, RevRecScheduleSearchRow columns) {
      super();
   ...
   public void setCriteria(RevRecScheduleSearch criteria) {
      this.criteria = criteria;
   }
   ...
   public void setColumns(RevRecScheduleSearchRow columns) {
      this.columns = columns;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof RevRecScheduleSearchAdvanced)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecScheduleSearchAdvanced"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecScheduleSearch"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "RevRecScheduleSearchRow"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
   }
