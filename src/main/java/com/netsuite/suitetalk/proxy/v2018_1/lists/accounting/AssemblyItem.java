...
public class AssemblyItem extends Record implements Serializable {
   ...
   private AssemblyItemBillOfMaterialsList billOfMaterialsList;
   ...
   private static TypeDesc typeDesc = new TypeDesc(AssemblyItem.class, true);

   public AssemblyItem() {
      super();
   }

   public AssemblyItem(NullField nullFieldList, String internalId, String externalId, Calendar createdDate, Calendar lastModifiedDate, RecordRef customForm, String itemId, String upcCode, String displayName, String vendorName, RecordRef parent, Boolean printItems, RecordRef vendor, Boolean isOnline, Boolean isGcoCompliant, Boolean offerSupport, Boolean isInactive, Boolean availableToPartners, RecordRefList subsidiaryList, RecordRef department, Boolean includeChildren, RecordRef _class, RecordRef location, String description, RecordRef cogsAccount, RecordRef incomeAccount, RecordRef intercoIncomeAccount, RecordRef assetAccount, Boolean matchBillToReceipt, RecordRef billQtyVarianceAcct, RecordRef billPriceVarianceAcct, RecordRef billExchRateVarianceAcct, RecordRef gainLossAccount, RecordRef salesTaxCode, Boolean useComponentYield, RecordRef wipVarianceAcct, RecordRef purchaseTaxCode, RecordRef scrapAcct, RecordRef taxSchedule, RecordRef wipAcct, Double shippingCost, Double handlingCost, Double weight, ItemWeightUnit weightUnit, Boolean isTaxable, ItemCostingMethod costingMethod, Double rate, String costingMethodDisplay, RecordRef unitsType, RecordRef stockUnit, RecordRef purchaseUnit, RecordRef saleUnit, Boolean trackLandedCost, String matrixItemNameTemplate, RecordRef billingSchedule, RecordRef deferredRevenueAccount, RecordRef revRecSchedule, String stockDescription, Boolean producer, String manufacturer, String mpn, Boolean multManufactureAddr, String manufactureraddr1, String manufacturerCity, String manufacturerState, String manufacturerZip, Country countryOfManufacture, AssemblyItemEffectiveBomControl effectiveBomControl, String defaultRevision, Boolean roundUpAsComponent, Double purchaseOrderQuantity, Double purchaseOrderAmount, Double purchaseOrderQuantityDiff, Double receiptQuantity, Double receiptAmount, Double receiptQuantityDiff, Boolean isDropShipItem, Boolean isPhantom, RecordRef defaultItemShipMethod, ShippingCarrier itemCarrier, RecordRefList itemShipMethodList, String manufacturerTaxId, String scheduleBNumber, Long scheduleBQuantity, RecordRef scheduleBCode, String manufacturerTariff, ItemPreferenceCriterion preferenceCriterion, RecordRef issueProduct, Long minimumQuantity, Calendar lastInvtCountDate, Calendar nextInvtCountDate, Long invtCountInterval, ItemInvtClassification invtClassification, Boolean enforceMinQtyInternally, RecordRef softDescriptor, Boolean isSpecialWorkOrderItem, RecordRef costCategory, Boolean pricesIncludeTax, RecordRef prodQtyVarianceAcct, RecordRef prodPriceVarianceAcct, RecordRef purchasePriceVarianceAcct, RecordRef quantityPricingSchedule, Boolean buildEntireAssembly, Double quantityOnHand, Boolean useMarginalRates, ItemCostEstimateType costEstimateType, Boolean isHazmatItem, String hazmatId, String hazmatShippingName, String hazmatHazardClass, HazmatPackingGroup hazmatPackingGroup, String hazmatItemUnits, Double hazmatItemUnitsQty, Double costEstimate, Double transferPrice, ItemOverallQuantityPricingType overallQuantityPricingType, RecordRef pricingGroup, RecordRef intercoCogsAccount, Double vsoePrice, VsoeSopGroup vsoeSopGroup, VsoeDeferral vsoeDeferral, VsoePermitDiscount vsoePermitDiscount, Boolean vsoeDelivered, RecordRef itemRevenueCategory, RecordRef unbuildVarianceAccount, Boolean deferRevRec, RecordRef revenueRecognitionRule, RecordRef revRecForecastRule, RecordRef revenueAllocationGroup, RecordRef createRevenuePlansOn, Boolean directRevenuePosting, RecordRef dropshipExpenseAccount, RecordRef preferredLocation, Boolean isStorePickupAllowed, Double totalValue, Boolean useBins, Double averageCost, Long leadTime, Boolean autoLeadTime, Long buildTime, Double lastPurchasePrice, String purchaseDescription, Double safetyStockLevel, Long safetyStockLevelDays, Boolean seasonalDemand, Long reorderMultiple, Double cost, Double reorderPoint, Double demandModifier, RecordRef distributionNetwork, RecordRef distributionCategory, Double preferredStockLevel, Boolean autoReorderPoint, Boolean autoPreferredStockLevel, Double preferredStockLevelDays, Double quantityCommitted, Boolean shipIndividually, Double quantityAvailable, RecordRef shipPackage, Double quantityBackOrdered, String storeDisplayName, Double defaultReturnCost, RecordRef supplyReplenishmentMethod, RecordRef alternateDemandSourceItem, Double fixedLotSize, RecordRef supplyType, Long demandTimeFence, Long supplyTimeFence, Long rescheduleInDays, Long rescheduleOutDays, RecordRef supplyLotSizingMethod, RecordRef demandSource, Double quantityOnOrder, RecordRef storeDisplayThumbnail, RecordRef storeDisplayImage, String storeDescription, String storeDetailedDescription, RecordRef storeItemTemplate, String pageTitle, String urlComponent, String metaTagHtml, Boolean excludeFromSitemap, SitemapPriority sitemapPriority, String searchKeywords, Boolean isDonationItem, Boolean showDefaultDonationAmount, Double maxDonationAmount, Boolean dontShowPrice, String noPriceMessage, String outOfStockMessage, String shoppingDotComCategory, ItemOutOfStockBehavior outOfStockBehavior, Long shopzillaCategoryId, String nexTagCategory, ProductFeedList productFeedList, String relatedItemsDescription, Boolean onSpecial, String specialsDescription, String featuredDescription, ItemOptionsList itemOptionsList, RecordRefList itemNumberOptionsList, ItemVendorList itemVendorList, PricingMatrix pricingMatrix, ItemMemberList memberList, ItemAccountingBookDetailList accountingBookDetailList, AssemblyItemBillOfMaterialsList billOfMaterialsList, InventoryItemLocationsList locationsList, SiteCategoryList siteCategoryList, InventoryItemBinNumberList binNumberList, TranslationList translationsList, PresentationItemList presentationItemList, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   public void setBillOfMaterialsList(AssemblyItemBillOfMaterialsList billOfMaterialsList) {
      this.billOfMaterialsList = billOfMaterialsList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof AssemblyItem)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AssemblyItem"));
      ...
      elemField.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "AssemblyItemBillOfMaterialsList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
