...
public class InvoiceSalesTeamList implements Serializable {
   private InvoiceSalesTeam[] salesTeam;
   private boolean replaceAll;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(InvoiceSalesTeamList.class, true);

   public InvoiceSalesTeamList() {
      super();
   }

   public InvoiceSalesTeamList(InvoiceSalesTeam[] salesTeam, boolean replaceAll) {
      super();
      this.salesTeam = salesTeam;
      this.replaceAll = replaceAll;
   }

   public InvoiceSalesTeam[] getSalesTeam() {
      return this.salesTeam;
   }

   public void setSalesTeam(InvoiceSalesTeam[] salesTeam) {
      this.salesTeam = salesTeam;
   }

   public InvoiceSalesTeam getSalesTeam(int i) {
      return this.salesTeam[i];
   }

   public void setSalesTeam(int i, InvoiceSalesTeam _value) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof InvoiceSalesTeamList)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "InvoiceSalesTeamList"));
      ...
      elemField.setXmlType(new QName("urn:sales_2018_1.transactions.webservices.netsuite.com", "InvoiceSalesTeam"));
