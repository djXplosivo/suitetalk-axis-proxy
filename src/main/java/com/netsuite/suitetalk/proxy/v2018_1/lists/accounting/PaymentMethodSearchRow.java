...
import com.netsuite.suitetalk.proxy.v2018_1.platform.common.PaymentMethodSearchRowBasic;
...
public class PaymentMethodSearchRow extends SearchRow implements Serializable {
   private PaymentMethodSearchRowBasic basic;
   private EmployeeSearchRowBasic userJoin;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(PaymentMethodSearchRow.class, true);

   public PaymentMethodSearchRow() {
      super();
   }

   public PaymentMethodSearchRow(PaymentMethodSearchRowBasic basic, EmployeeSearchRowBasic userJoin) {
      super();
      this.basic = basic;
   ...
   public void setBasic(PaymentMethodSearchRowBasic basic) {
      this.basic = basic;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PaymentMethodSearchRow)) {
         return false;
      } else {
   ...
   static {
      typeDesc.setXmlType(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "PaymentMethodSearchRow"));
      ElementDesc elemField = new ElementDesc();
      elemField.setFieldName("basic");
      elemField.setXmlName(new QName("urn:accounting_2018_1.lists.webservices.netsuite.com", "basic"));
      elemField.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PaymentMethodSearchRowBasic"));
