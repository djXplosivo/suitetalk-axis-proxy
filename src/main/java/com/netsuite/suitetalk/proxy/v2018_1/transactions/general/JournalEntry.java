...
public class JournalEntry extends Record implements Serializable {
   ...
   private JournalEntryLineList lineList;
   ...
   private static TypeDesc typeDesc = new TypeDesc(JournalEntry.class, true);

   public JournalEntry() {
      super();
   }

   public JournalEntry(NullField nullFieldList, String internalId, String externalId, RecordRef postingPeriod, Calendar tranDate, RecordRef currency, Double exchangeRate, String tranId, Calendar reversalDate, Boolean reversalDefer, RecordRef parentExpenseAlloc, Boolean isBookSpecific, RecordRef accountingBook, String reversalEntry, RecordRef createdFrom, RecordRef department, RecordRef _class, RecordRef location, RecordRef subsidiary, RecordRef nexus, RecordRef subsidiaryTaxRegNum, String memo, RecordRef toSubsidiary, Boolean approved, Calendar createdDate, Calendar lastModifiedDate, RecordRef customForm, JournalEntryLineList lineList, AccountingBookDetailList accountingBookDetailList, CustomFieldList customFieldList) {
      super(nullFieldList);
   ...
   public void setLineList(JournalEntryLineList lineList) {
      this.lineList = lineList;
   }
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof JournalEntry)) {
         ...
         if (obj == null) {
            ...
            boolean _equals = super.equals(obj) && (this.postingPeriod == null && other.getPostingPeriod() == null || this.postingPeriod != null && this.postingPeriod.equals(other.getPostingPeriod())) && (this.tranDate == null && other.getTranDate() == null || this.tranDate != null && this.tranDate.equals(other.getTranDate())) && (this.currency == null && other.getCurrency() == null || this.currency != null && this.currency.equals(other.getCurrency())) && (this.exchangeRate == null && other.getExchangeRate() == null || this.exchangeRate != null && this.exchangeRate.equals(other.getExchangeRate())) && (this.tranId == null && other.getTranId() == null || this.tranId != null && this.tranId.equals(other.getTranId())) && (this.reversalDate == null && other.getReversalDate() == null || this.reversalDate != null && this.reversalDate.equals(other.getReversalDate())) && (this.reversalDefer == null && other.getReversalDefer() == null || this.reversalDefer != null && this.reversalDefer.equals(other.getReversalDefer())) && (this.parentExpenseAlloc == null && other.getParentExpenseAlloc() == null || this.parentExpenseAlloc != null && this.parentExpenseAlloc.equals(other.getParentExpenseAlloc())) && (this.isBookSpecific == null && other.getIsBookSpecific() == null || this.isBookSpecific != null && this.isBookSpecific.equals(other.getIsBookSpecific())) && (this.accountingBook == null && other.getAccountingBook() == null || this.accountingBook != null && this.accountingBook.equals(other.getAccountingBook())) && (this.reversalEntry == null && other.getReversalEntry() == null || this.reversalEntry != null && this.reversalEntry.equals(other.getReversalEntry())) && (this.createdFrom == null && other.getCreatedFrom() == null || this.createdFrom != null && this.createdFrom.equals(other.getCreatedFrom())) && (this.department == null && other.getDepartment() == null || this.department != null && this.department.equals(other.getDepartment())) && (this._class == null && other.get_class() == null || this._class != null && this._class.equals(other.get_class())) && (this.location == null && other.getLocation() == null || this.location != null && this.location.equals(other.getLocation())) && (this.subsidiary == null && other.getSubsidiary() == null || this.subsidiary != null && this.subsidiary.equals(other.getSubsidiary())) && (this.nexus == null && other.getNexus() == null || this.nexus != null && this.nexus.equals(other.getNexus())) && (this.subsidiaryTaxRegNum == null && other.getSubsidiaryTaxRegNum() == null || this.subsidiaryTaxRegNum != null && this.subsidiaryTaxRegNum.equals(other.getSubsidiaryTaxRegNum())) && (this.memo == null && other.getMemo() == null || this.memo != null && this.memo.equals(other.getMemo())) && (this.toSubsidiary == null && other.getToSubsidiary() == null || this.toSubsidiary != null && this.toSubsidiary.equals(other.getToSubsidiary())) && (this.approved == null && other.getApproved() == null || this.approved != null && this.approved.equals(other.getApproved())) && (this.createdDate == null && other.getCreatedDate() == null || this.createdDate != null && this.createdDate.equals(other.getCreatedDate())) && (this.lastModifiedDate == null && other.getLastModifiedDate() == null || this.lastModifiedDate != null && this.lastModifiedDate.equals(other.getLastModifiedDate())) && (this.customForm == null && other.getCustomForm() == null || this.customForm != null && this.customForm.equals(other.getCustomForm())) && (this.lineList == null && other.getLineList() == null || this.lineList != null && this.lineList.equals(other.getLineList())) && (this.accountingBookDetailList == null && other.getAccountingBookDetailList() == null || this.accountingBookDetailList != null && this.accountingBookDetailList.equals(other.getAccountingBookDetailList())) && (this.customFieldList == null && other.getCustomFieldList() == null || this.customFieldList != null && this.customFieldList.equals(other.getCustomFieldList())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId()));
   ...
   static {
      typeDesc.setXmlType(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "JournalEntry"));
      ...
      elemField.setXmlName(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "nexus"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlName(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "subsidiaryTaxRegNum"));
      elemField.setXmlType(new QName("urn:core_2018_1.platform.webservices.netsuite.com", "RecordRef"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      ...
      elemField.setXmlType(new QName("urn:general_2018_1.transactions.webservices.netsuite.com", "JournalEntryLineList"));
      elemField.setMinOccurs(0);
      elemField.setNillable(false);
      typeDesc.addFieldDesc(elemField);
      elemField = new ElementDesc();
