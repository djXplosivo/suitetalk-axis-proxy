...
public class PartnerSearchRowBasic extends SearchRowBasic implements Serializable {
   ...
   private SearchColumnBooleanField[] assignTasks;
   ...
   private SearchColumnStringField[] partnerCode;
   ...
   private static TypeDesc typeDesc = new TypeDesc(PartnerSearchRowBasic.class, true);

   public PartnerSearchRowBasic() {
      super();
   }

   public PartnerSearchRowBasic(SearchColumnStringField[] address, SearchColumnStringField[] address1, SearchColumnStringField[] address2, SearchColumnStringField[] address3, SearchColumnStringField[] addressee, SearchColumnStringField[] addressInternalId, SearchColumnStringField[] addressLabel, SearchColumnStringField[] addressPhone, SearchColumnStringField[] altEmail, SearchColumnStringField[] altName, SearchColumnStringField[] altPhone, SearchColumnBooleanField[] assignTasks, SearchColumnStringField[] attention, SearchColumnStringField[] billAddress, SearchColumnStringField[] billAddress1, SearchColumnStringField[] billAddress2, SearchColumnStringField[] billAddress3, SearchColumnStringField[] billAddressee, SearchColumnStringField[] billAttention, SearchColumnStringField[] billCity, SearchColumnEnumSelectField[] billCountry, SearchColumnStringField[] billCountryCode, SearchColumnStringField[] billPhone, SearchColumnStringField[] billState, SearchColumnStringField[] billZipCode, SearchColumnStringField[] category, SearchColumnStringField[] city, SearchColumnSelectField[] _class, SearchColumnStringField[] comments, SearchColumnStringField[] companyName, SearchColumnEnumSelectField[] country, SearchColumnStringField[] countryCode, SearchColumnDateField[] dateCreated, SearchColumnSelectField[] department, SearchColumnBooleanField[] eligibleForCommission, SearchColumnStringField[] email, SearchColumnEnumSelectField[] emailPreference, SearchColumnStringField[] entityId, SearchColumnLongField[] entityNumber, SearchColumnSelectField[] externalId, SearchColumnStringField[] fax, SearchColumnStringField[] firstName, SearchColumnBooleanField[] giveAccess, SearchColumnEnumSelectField[] globalSubscriptionStatus, SearchColumnBooleanField[] hasDuplicates, SearchColumnStringField[] homePhone, SearchColumnSelectField[] image, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isDefaultBilling, SearchColumnBooleanField[] isDefaultShipping, SearchColumnBooleanField[] isInactive, SearchColumnBooleanField[] isPerson, SearchColumnEnumSelectField[] language, SearchColumnDateField[] lastModifiedDate, SearchColumnStringField[] lastName, SearchColumnEnumSelectField[] level, SearchColumnSelectField[] location, SearchColumnStringField[] middleName, SearchColumnStringField[] mobilePhone, SearchColumnSelectField[] parent, SearchColumnStringField[] partnerCode, SearchColumnEnumSelectField[] permission, SearchColumnStringField[] phone, SearchColumnStringField[] phoneticName, SearchColumnStringField[] promoCode, SearchColumnStringField[] salutation, SearchColumnStringField[] shipAddress, SearchColumnStringField[] shipAddress1, SearchColumnStringField[] shipAddress2, SearchColumnStringField[] shipAddress3, SearchColumnStringField[] shipAddressee, SearchColumnStringField[] shipAttention, SearchColumnStringField[] shipCity, SearchColumnEnumSelectField[] shipCountry, SearchColumnStringField[] shipCountryCode, SearchColumnStringField[] shipPhone, SearchColumnStringField[] shipState, SearchColumnStringField[] shipZip, SearchColumnStringField[] state, SearchColumnSelectField[] subscription, SearchColumnDateField[] subscriptionDate, SearchColumnBooleanField[] subscriptionStatus, SearchColumnSelectField[] subsidiary, SearchColumnStringField[] title, SearchColumnStringField[] url, SearchColumnStringField[] zipCode, SearchColumnCustomFieldList customFieldList) {
      super();
   ...
   public SearchColumnBooleanField[] getAssignTasks() {
      return this.assignTasks;
   }

   public void setAssignTasks(SearchColumnBooleanField[] assignTasks) {
      this.assignTasks = assignTasks;
   }

   public SearchColumnBooleanField getAssignTasks(int i) {
      return this.assignTasks[i];
   }

   public void setAssignTasks(int i, SearchColumnBooleanField _value) {
   ...
   public SearchColumnStringField[] getPartnerCode() {
      return this.partnerCode;
   }

   public void setPartnerCode(SearchColumnStringField[] partnerCode) {
      this.partnerCode = partnerCode;
   }

   public SearchColumnStringField getPartnerCode(int i) {
      return this.partnerCode[i];
   }

   public void setPartnerCode(int i, SearchColumnStringField _value) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof PartnerSearchRowBasic)) {
         return false;
      } else {
   ...
   public synchronized int hashCode() {
      if (this.__hashCodeCalc) {
         ...
         if (this.getAssignTasks() != null) {
            for(i = 0; i < Array.getLength(this.getAssignTasks()); ++i) {
               obj = Array.get(this.getAssignTasks(), i);
               if (obj != null && !obj.getClass().isArray()) {
                  _hashCode += obj.hashCode();
               }
            }
         ...
         if (this.getPartnerCode() != null) {
            for(i = 0; i < Array.getLength(this.getPartnerCode()); ++i) {
               obj = Array.get(this.getPartnerCode(), i);
               if (obj != null && !obj.getClass().isArray()) {
                  _hashCode += obj.hashCode();
               }
            }
   ...
   static {
      typeDesc.setXmlType(new QName("urn:common_2018_1.platform.webservices.netsuite.com", "PartnerSearchRowBasic"));
